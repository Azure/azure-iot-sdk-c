...
static void test_Impl_DT_PropertyUpdate(const DIGITALTWIN_CLIENT_PROPERTY_UPDATE* dtClientPropertyUpdate, void* userInterfaceContext)
{
    if (dtTestPropertyUpdateTest != DT_TEST_PROPERTY_UPDATE_TEST_FAILURE_TEST)
    {
        ...
        ASSERT_ARE_EQUAL(size_t, strlen(expectedDesiredPropertyData), dtClientPropertyUpdate->propertyDesiredLen,
                         "Expected desired property length <%zu> does not match actual <%zd>", strlen(expectedDesiredPropertyData), dtClientPropertyUpdate->propertyDesiredLen);
        ...
        if (dtTestPropertyUpdateTest == DT_TEST_PROPERTY_UPDATE_TEST_REPORTED_EXPECTED)
        {
            ...
            ASSERT_ARE_EQUAL(int, strlen(expectedReportedPropertyData), dtClientPropertyUpdate->propertyReportedLen,
                             "Expected propertyReportedLen <%zd> does not match actual <%zd>", strlen(expectedReportedPropertyData), dtClientPropertyUpdate->propertyReportedLen);
...
static void set_expected_calls_for_DT_InterfaceClient_CreateTelemetryMessage(bool includeInterfaceId, bool telemetryName)
{
...
TEST_FUNCTION(DT_InterfaceClient_CreateTelemetryMessage_no_interfaceId_ok)
{
    ...
    set_expected_calls_for_DT_InterfaceClient_CreateTelemetryMessage(false, true);
...
TEST_FUNCTION(DT_InterfaceClient_CreateTelemetryMessage_with_interfaceId_ok)
{
    //arrange
    IOTHUB_MESSAGE_HANDLE messageHandle = NULL;
    set_expected_calls_for_DT_InterfaceClient_CreateTelemetryMessage(true, true);
...
TEST_FUNCTION(DT_InterfaceClient_CreateTelemetryMessage_NULL_telemetry_name_ok)
{
    //arrange
    IOTHUB_MESSAGE_HANDLE messageHandle = NULL;
    set_expected_calls_for_DT_InterfaceClient_CreateTelemetryMessage(true, false);
...
static void set_expected_calls_for_DigitalTwin_InterfaceClient_SendTelemetryAsync()
{
    ...
    set_expected_calls_for_DT_InterfaceClient_CreateTelemetryMessage(false, false);
    STRICT_EXPECTED_CALL(gballoc_calloc(IGNORED_NUM_ARG, IGNORED_NUM_ARG));
