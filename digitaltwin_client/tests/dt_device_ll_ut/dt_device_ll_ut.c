...
BEGIN_TEST_SUITE(dt_device_ll_ut)
...
TEST_SUITE_INITIALIZE(suite_init)
{
    ...
    REGISTER_GLOBAL_MOCK_RETURN(IoTHubDeviceClient_LL_SetOption, IOTHUB_CLIENT_OK);
    REGISTER_GLOBAL_MOCK_FAIL_RETURN(IoTHubDeviceClient_LL_SetOption, IOTHUB_CLIENT_ERROR);
}
...
static void set_expected_calls_for_DT_DeviceClient_LL_CreateFromDeviceHandle()
{
    STRICT_EXPECTED_CALL(IoTHubDeviceClient_LL_SetOption(IGNORED_PTR_ARG, IGNORED_PTR_ARG, IGNORED_PTR_ARG));
    STRICT_EXPECTED_CALL(IoTHubDeviceClient_LL_SetOption(IGNORED_PTR_ARG, IGNORED_PTR_ARG, IGNORED_PTR_ARG));
...
///////////////////////////////////////////////////////////////////////////////
TEST_FUNCTION(DigitalTwin_DeviceClient_LL_LL_CreateFromDeviceHandle_ok)
{
    // arrange
    ...
    //act
    result = DigitalTwin_DeviceClient_LL_CreateFromDeviceHandle(testIotHubDeviceLLHandle, &h, testDTDeviceCapabilityModel);
    ...
    //cleanup
    DigitalTwin_DeviceClient_LL_Destroy(h);
}

TEST_FUNCTION(DigitalTwin_DeviceClient_LL_CreateFromDeviceHandle_NULL_iothub_handle_fails)
{
    // arrange
    DIGITALTWIN_DEVICE_CLIENT_LL_HANDLE h = NULL;
    DIGITALTWIN_CLIENT_RESULT result;
    ...
    //act
    result = DigitalTwin_DeviceClient_LL_CreateFromDeviceHandle(NULL, &h, testDTDeviceCapabilityModel);
...
TEST_FUNCTION(DigitalTwin_DeviceClient_LL_CreateFromDeviceHandle_NULL_dt_handle_fails)
{
    // arrange
    DIGITALTWIN_CLIENT_RESULT result;

    //act
    result = DigitalTwin_DeviceClient_LL_CreateFromDeviceHandle(testIotHubDeviceLLHandle, NULL, testDTDeviceCapabilityModel);
...
TEST_FUNCTION(DigitalTwin_DeviceClient_LL_CreateFromDeviceHandle_fail)
{
    // arrange
    DIGITALTWIN_CLIENT_RESULT result;
    ...
    {
        char message[256];
        sprintf(message, "DigitalTwin_DeviceClient_LL_CreateFromDeviceHandle failure in test %lu", (unsigned long)i);
...
static DIGITALTWIN_DEVICE_CLIENT_LL_HANDLE allocate_DIGITALTWIN_DEVICE_CLIENT_LL_HANDLE_for_test()
{
    DIGITALTWIN_CLIENT_RESULT result;
    DIGITALTWIN_DEVICE_CLIENT_LL_HANDLE h = NULL;
...
///////////////////////////////////////////////////////////////////////////////
static void set_expected_calls_for_DT_DeviceClient_LL_Destroy()
{
    STRICT_EXPECTED_CALL(DT_ClientCoreDestroy(IGNORED_PTR_ARG));
}

TEST_FUNCTION(DigitalTwin_DeviceClient_LL_Destroy_ok)
{
    //arrange
    DIGITALTWIN_DEVICE_CLIENT_LL_HANDLE h = allocate_DIGITALTWIN_DEVICE_CLIENT_LL_HANDLE_for_test();
    set_expected_calls_for_DT_DeviceClient_LL_Destroy();
...
TEST_FUNCTION(DigitalTwin_DeviceClient_LL_RegisterInterfacesAsync_fail)
{
    // arrange
    int negativeTestsInitResult = umock_c_negative_tests_init();
    ASSERT_ARE_EQUAL(int, 0, negativeTestsInitResult);
...
END_TEST_SUITE(dt_device_ll_ut)
