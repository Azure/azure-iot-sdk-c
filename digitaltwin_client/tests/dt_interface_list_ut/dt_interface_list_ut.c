...
#define DT_TEST_INTERFACE_REGISTER_START  "{\"modelInformation\":{\"capabilityModelId\":\"" DT_TEST_CAPABILITY_MODEL_ID "\",\"interfaces\":{" DT_TEST_INTERFACE_MODEL_DISCOVERY_TUPLE ","
