...
TEST_FUNCTION(DigitalTwin_DeviceClient_CreateFromDeviceHandle_ok)
{
    ...
    //act
    result = DigitalTwin_DeviceClient_CreateFromDeviceHandle(testIotHubDeviceHandle, testDTModelId, &h);
...
TEST_FUNCTION(DigitalTwin_DeviceClient_CreateFromDeviceHandle_NULL_iothub_handle_fails)
{
    ...
    //act
    result = DigitalTwin_DeviceClient_CreateFromDeviceHandle(NULL, testDTModelId, &h);
...
TEST_FUNCTION(DigitalTwin_DeviceClient_CreateFromDeviceHandle_NULL_dt_handle_fails)
{
    ...
    //act
    result = DigitalTwin_DeviceClient_CreateFromDeviceHandle(testIotHubDeviceHandle, testDTModelId, NULL);
...
TEST_FUNCTION(DigitalTwin_DeviceClient_RegisterInterfaces_fail)
{
    ...
    for (size_t i = 0; i < count; i++)
    {
        ...
        //assert
        ASSERT_ARE_NOT_EQUAL(int, DIGITALTWIN_CLIENT_OK, result, "DigitalTwin_DeviceClient_RegisterInterfaces failure in test %lu", (unsigned long)i);
    }
