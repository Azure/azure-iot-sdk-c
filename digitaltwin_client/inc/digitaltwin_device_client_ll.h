...
*/
MOCKABLE_FUNCTION(, DIGITALTWIN_CLIENT_RESULT, DigitalTwin_DeviceClient_LL_CreateFromDeviceHandle, IOTHUB_DEVICE_CLIENT_LL_HANDLE, deviceHandle, const char*, modelID, DIGITALTWIN_DEVICE_CLIENT_LL_HANDLE*, dtDeviceLLClientHandle);
