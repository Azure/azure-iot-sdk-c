...
MOCKABLE_FUNCTION(, int, DT_InterfaceClient_CheckNameValid2, const char*, componentName);
MOCKABLE_FUNCTION(, int, DT_InterfaceClient_CheckDTMIValid, const char*, interfaceName);
