...
MOCKABLE_FUNCTION(, DIGITALTWIN_CLIENT_RESULT, DT_InterfaceClient_CreateTelemetryMessage, const char*, interfaceId, const char*, componentName, const char*, telemetryName, const char*, messageData, IOTHUB_MESSAGE_HANDLE*, telemetryMessageHandle);
