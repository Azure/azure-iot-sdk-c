...
typedef enum IOTHUB_REGISTRYMANAGER_RESULT_VALUES_TAG
{
    IOTHUB_REGISTRYMANAGER_OK = 0,
    IOTHUB_REGISTRYMANAGER_INVALID_ARG = 1,
    IOTHUB_REGISTRYMANAGER_ERROR = 2,
    IOTHUB_REGISTRYMANAGER_JSON_ERROR = 3,
    IOTHUB_REGISTRYMANAGER_HTTPAPI_ERROR = 4,
    IOTHUB_REGISTRYMANAGER_HTTP_STATUS_ERROR = 5,
    IOTHUB_REGISTRYMANAGER_DEVICE_EXIST = 6,
    IOTHUB_REGISTRYMANAGER_DEVICE_NOT_EXIST = 7,
    IOTHUB_REGISTRYMANAGER_CALLBACK_NOT_SET = 8,
    IOTHUB_REGISTRYMANAGER_INVALID_VERSION = 9
} IOTHUB_REGISTRYMANAGER_RESULT_VALUES;

typedef enum IOTHUB_REGISTRYMANAGER_AUTH_METHOD_VALUES_TAG
{
    IOTHUB_REGISTRYMANAGER_AUTH_SPK = 0,
    IOTHUB_REGISTRYMANAGER_AUTH_X509_THUMBPRINT = 1,
    IOTHUB_REGISTRYMANAGER_AUTH_X509_CERTIFICATE_AUTHORITY = 2,
    IOTHUB_REGISTRYMANAGER_AUTH_NONE = 3,
    IOTHUB_REGISTRYMANAGER_AUTH_UNKNOWN = 4
