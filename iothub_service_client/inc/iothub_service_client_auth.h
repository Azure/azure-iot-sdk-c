...
typedef enum IOTHUB_DEVICE_STATUS_VALUES_TAG
{
    IOTHUB_DEVICE_STATUS_ENABLED = 0,
    IOTHUB_DEVICE_STATUS_DISABLED = 1
} IOTHUB_DEVICE_STATUS_VALUES;

typedef enum IOTHUB_DEVICE_CONNECTION_STATE_VALUES_TAG
{
    IOTHUB_DEVICE_CONNECTION_STATE_CONNECTED = 0,
    IOTHUB_DEVICE_CONNECTION_STATE_DISCONNECTED = 1
