...
const char * IOTHUB_DEVICE_CONFIGURATION_RESULTStringStorage[8] = 
{
...
static const size_t IOTHUB_DEVICE_CONFIGURATION_RESULTStringStorageLen = sizeof(IOTHUB_DEVICE_CONFIGURATION_RESULTStringStorage) / sizeof(IOTHUB_DEVICE_CONFIGURATION_RESULTStringStorage[0]);

const char * IOTHUB_DEVICE_CONFIGURATION_RESULTStrings(IOTHUB_DEVICE_CONFIGURATION_RESULT value) 
{
    if ((size_t) value < 0 || (size_t) value >= IOTHUB_DEVICE_CONFIGURATION_RESULTStringStorageLen)
    {
        return "NULL";
    } 
    else 
    {
        return IOTHUB_DEVICE_CONFIGURATION_RESULTStringStorage[value];
    }
}
