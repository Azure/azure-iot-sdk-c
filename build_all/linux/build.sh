      ...
      then
        ...
        save_next_arg=0
          ...
          case "$arg" in
              ...
              "--use-local-openssl") openssl_include_dir="-DOPENSSL_INCLUDE_DIR=/usr/local/ssl/include";;
