...
echo $NEWTIN | sudo -S sed -i 's&azure-iot-sdks&'v-jebobo:$MBED_CRED'&g' .gitmodules
git submodule update --init
cd mbed-iot-devkit-sdk
// update devkit-azure-iot-sdk-c and mbed-az3166-driver with credentials
echo $NEWTIN | sudo -S sed -i 's&mseng@&'v-jebobo:$DEVKIT_CRED@'&g' .gitmodules
echo $NEWTIN | sudo -S sed -i 's&placehold&'v-jebobo:$AZ3166_CRED'&g' .gitmodules
