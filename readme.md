...
| **Retry policies**                                          | N     | :large-blue-diamond:    | P       | Y    | Y       | Retry policy for unsuccessful device-to-cloud messages have three options: no try, exponential backoff with jitter (default) and custom.                                                                                                                                                                                                                                                               |
| No Retry                                                | :large-orange-diamond:     | P    | P       | Y    | Y       |                                                                                                                                                                                                                                                                                                                                                                                                        |
