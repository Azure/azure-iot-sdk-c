...
| Devices multiplexing over single connection                                                                      | :heavy_minus_sign:  | :heavy_minus_sign:  | :heavy_check_mark:       | :heavy_check_mark:       | :heavy_check_mark:       | There are more limitations to multiplexing than captured in this table.  See [this document](./doc/multiplexing_limitations.md) for more 
details.                                                                                                                                                                                                          |
