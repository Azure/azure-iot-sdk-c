...
BEGIN_TEST_SUITE(dps_hsm_tpm_ut)
    ...
    static void setup_dps_hsm_tpm_create_mock()
    {
    ...
    static void setup_dps_hsm_tpm_import_key_mock()
    {
        OBJECT_ATTR tmp = FixedTPM;
        TPM_SE tmp_se = 0;
    ...
    static void setup_dps_hsm_tpm_get_storage_key_mocks()
    {
    ...
    static void setup_dps_hsm_tpm_sign_data_mocks()
    {
    ...
    static void setup_dps_hsm_tpm_get_endorsement_key_mocks()
    {
        STRICT_EXPECTED_CALL(TPM2B_PUBLIC_Marshal(IGNORED_PTR_ARG, IGNORED_PTR_ARG, NULL));
        STRICT_EXPECTED_CALL(BUFFER_create(IGNORED_PTR_ARG, IGNORED_NUM_ARG));
    }

    /* Tests_SRS_SECURE_DEVICE_TPM_07_002: [ On success dps_hsm_tpm_create shall allocate a new instance of the secure device tpm interface. ] */
    ...
    TEST_FUNCTION(dps_hsm_tpm_create_succeed)
    {
        //arrange
        setup_dps_hsm_tpm_create_mock();

        //act
        DPS_SECURE_DEVICE_HANDLE sec_handle = dps_hsm_tpm_create();
        ...
        //cleanup
        dps_hsm_tpm_destroy(sec_handle);
    }

    /* Tests_SRS_SECURE_DEVICE_TPM_07_001: [ If any failure is encountered dps_hsm_tpm_create shall return NULL ] */
    ...
    /* Tests_SRS_SECURE_DEVICE_TPM_07_004: [ dps_hsm_tpm_destroy shall free the SEC_DEVICE_INFO instance. ] */
    /* Tests_SRS_SECURE_DEVICE_TPM_07_006: [ dps_hsm_tpm_destroy shall free all resources allocated in this module. ]*/
    TEST_FUNCTION(dps_hsm_tpm_destroy_succeed)
    {
        //arrange
        DPS_SECURE_DEVICE_HANDLE sec_handle = dps_hsm_tpm_create();
        umock_c_reset_all_calls();
    ...
    /* Tests_SRS_SECURE_DEVICE_TPM_07_005: [ if handle is NULL, dps_hsm_tpm_destroy shall do nothing. ] */
    TEST_FUNCTION(dps_hsm_tpm_destroy_handle_NULL_succeed)
    {
        //arrange
        umock_c_reset_all_calls();

        //act
        dps_hsm_tpm_destroy(NULL);
    ...
    /* Tests_SRS_SECURE_DEVICE_TPM_07_007: [ if handle or key are NULL, or key_len is 0 dps_hsm_tpm_import_key shall return a non-zero value ] */
    TEST_FUNCTION(dps_hsm_tpm_import_key_handle_NULL_fail)
    {
        //arrange

        //act
        int import_res = dps_hsm_tpm_import_key(NULL, TEST_IMPORT_KEY, TEST_KEY_SIZE);
    ...
    /* Tests_SRS_SECURE_DEVICE_TPM_07_007: [ if handle or key are NULL, or key_len is 0 dps_hsm_tpm_import_key shall return a non-zero value ] */
    TEST_FUNCTION(dps_hsm_tpm_import_key_key_NULL_fail)
    {
        //arrange
        DPS_SECURE_DEVICE_HANDLE sec_handle = dps_hsm_tpm_create();
        umock_c_reset_all_calls();
        ...
        //act
        int import_res = dps_hsm_tpm_import_key(sec_handle, NULL, TEST_KEY_SIZE);
    ...
    TEST_FUNCTION(dps_hsm_tpm_import_key_fail)
    {
        //arrange
        DPS_SECURE_DEVICE_HANDLE sec_handle = dps_hsm_tpm_create();
        umock_c_reset_all_calls();
        ...
        setup_dps_hsm_tpm_import_key_mock();
        ...
        for (size_t index = 0; index < count; index++)
        {
            ...
            char tmp_msg[64];
            sprintf(tmp_msg, "dps_hsm_tpm_import_key failure in test %zu/%zu", index, count);

            //act
            int import_res = dps_hsm_tpm_import_key(sec_handle, TEST_IMPORT_KEY, TEST_KEY_SIZE);
    ...
    /* Tests_dps_hsm_tpm_import_key shall establish a tpm session in preparation to inserting the key into the tpm. */
    /* Tests_SRS_SECURE_DEVICE_TPM_07_008: [ On success dps_hsm_tpm_import_key shall return zero ] */
    TEST_FUNCTION(dps_hsm_tpm_import_key_succeed)
    {
        //arrange
        DPS_SECURE_DEVICE_HANDLE sec_handle = dps_hsm_tpm_create();
        umock_c_reset_all_calls();
    ...
    /* Tests_SRS_SECURE_DEVICE_TPM_07_013: [ If handle is NULL dps_hsm_tpm_get_endorsement_key shall return NULL. ] */
    TEST_FUNCTION(dps_hsm_tpm_get_endorsement_key_handle_NULL_succeed)
    {
        //act
        BUFFER_HANDLE ek_value = dps_hsm_tpm_get_endorsement_key(NULL);

        //assert
        ASSERT_IS_NULL(ek_value);
        ASSERT_ARE_EQUAL(char_ptr, umock_c_get_expected_calls(), umock_c_get_actual_calls());

        //cleanup
    }

    /* Tests_SRS_SECURE_DEVICE_TPM_07_027: [ If the ek_public was not initialized dps_hsm_tpm_get_endorsement_key shall return NULL. ] */
    TEST_FUNCTION(dps_hsm_tpm_get_endorsement_key_size_0_fail)
    {
        g_rsa_size = 0;
        ...
        //act
        BUFFER_HANDLE ek_value = dps_hsm_tpm_get_endorsement_key(sec_handle);
    ...
    /* Tests_SRS_SECURE_DEVICE_TPM_07_015: [ If a failure is encountered, dps_hsm_tpm_get_endorsement_key shall return NULL. ] */
    TEST_FUNCTION(dps_hsm_tpm_get_endorsement_key_fail)
    {
        //arrange
        DPS_SECURE_DEVICE_HANDLE sec_handle = dps_hsm_tpm_create();
        umock_c_reset_all_calls();
        ...
        setup_dps_hsm_tpm_get_endorsement_key_mocks();
        ...
        for (size_t index = 0; index < count; index++)
        {
            ...
            char tmp_msg[64];
            sprintf(tmp_msg, "dps_hsm_tpm_get_endorsement_key failure in test %zu/%zu", index, count);

            BUFFER_HANDLE ek_value = dps_hsm_tpm_get_endorsement_key(sec_handle);

            //assert
            ASSERT_IS_NULL_WITH_MSG(ek_value, tmp_msg);
        }
        //cleanup
        dps_hsm_tpm_destroy(sec_handle);
        umock_c_negative_tests_deinit();
    ...
    /* Tests_SRS_SECURE_DEVICE_TPM_07_014: [ dps_hsm_tpm_get_endorsement_key shall allocate and return the Endorsement Key. ] */
    TEST_FUNCTION(dps_hsm_tpm_get_endorsement_key_succeed)
    {
        //arrange
        DPS_SECURE_DEVICE_HANDLE sec_handle = dps_hsm_tpm_create();
        umock_c_reset_all_calls();
        ...
        //assert
        ASSERT_IS_NOT_NULL(ek_value);
        ASSERT_ARE_EQUAL(char_ptr, umock_c_get_expected_calls(), umock_c_get_actual_calls());

        //cleanup
        my_gballoc_free(ek_value);
        dps_hsm_tpm_destroy(sec_handle);
    }

    /* Tests_SRS_SECURE_DEVICE_TPM_07_016: [ If handle is NULL, dps_hsm_tpm_get_storage_key shall return NULL. ] */
    TEST_FUNCTION(dps_hsm_tpm_get_storage_key_handle_NULL_fail)
    {
        //arrange

        //act
        BUFFER_HANDLE srk_value = dps_hsm_tpm_get_storage_key(NULL);

        //assert
        ASSERT_IS_NULL(srk_value);
        ASSERT_ARE_EQUAL(char_ptr, umock_c_get_expected_calls(), umock_c_get_actual_calls());

        //cleanup
    }

    /* Tests_SRS_SECURE_DEVICE_TPM_07_017: [ If the srk_public value was not initialized, dps_hsm_tpm_get_storage_key shall return NULL. ] */
    TEST_FUNCTION(dps_hsm_tpm_get_storage_key_size_0_fail)
    {
        g_rsa_size = 0;
        ...
        //act
        BUFFER_HANDLE srk_value = dps_hsm_tpm_get_storage_key(sec_handle);
    ...
    /* Tests_SRS_SECURE_DEVICE_TPM_07_019: [ If any failure is encountered, dps_hsm_tpm_get_storage_key shall return NULL. ] */
    TEST_FUNCTION(dps_hsm_tpm_get_storage_key_fail)
    {
        //arrange
        DPS_SECURE_DEVICE_HANDLE sec_handle = dps_hsm_tpm_create();
        umock_c_reset_all_calls();
        ...
        setup_dps_hsm_tpm_get_storage_key_mocks();
        ...
        for (size_t index = 0; index < count; index++)
        {
            ...
            char tmp_msg[64];
            sprintf(tmp_msg, "dps_hsm_tpm_get_storage_key failure in test %zu/%zu", index, count);
    ...
    /* Tests_SRS_SECURE_DEVICE_TPM_07_018: [ dps_hsm_tpm_get_storage_key shall allocate and return the Storage Root Key. ] */
    TEST_FUNCTION(dps_hsm_tpm_get_storage_key_succeed)
    {
        //arrange
        DPS_SECURE_DEVICE_HANDLE sec_handle = dps_hsm_tpm_create();
        umock_c_reset_all_calls();
        ...
        //assert
        ASSERT_IS_NOT_NULL(srk_value);
        ASSERT_ARE_EQUAL(char_ptr, umock_c_get_expected_calls(), umock_c_get_actual_calls());

        //cleanup
        my_gballoc_free(srk_value);
        dps_hsm_tpm_destroy(sec_handle);
    }

    /* Tests_SRS_SECURE_DEVICE_TPM_07_020: [ If handle or data is NULL or data_len is 0, dps_hsm_tpm_sign_data shall return NULL. ] */
    TEST_FUNCTION(dps_hsm_tpm_sign_data_handle_fail)
    {
        //arrange

        //act
        BUFFER_HANDLE sign_value = dps_hsm_tpm_sign_data(NULL, TEST_BUFFER, TEST_BUFFER_SIZE);
    ...
    /* Tests_SRS_SECURE_DEVICE_TPM_07_020: [ If handle or data is NULL or data_len is 0, dps_hsm_tpm_sign_data shall return NULL. ] */
    TEST_FUNCTION(dps_hsm_tpm_sign_data_data_NULL_fail)
    {
        //arrange
        DPS_SECURE_DEVICE_HANDLE sec_handle = dps_hsm_tpm_create();
        umock_c_reset_all_calls();
        ...
        //act
        BUFFER_HANDLE sign_value = dps_hsm_tpm_sign_data(sec_handle, NULL, TEST_BUFFER_SIZE);
    ...
    /* Tests_SRS_SECURE_DEVICE_TPM_07_020: [ If handle or data is NULL or data_len is 0, dps_hsm_tpm_sign_data shall return NULL. ] */
    TEST_FUNCTION(dps_hsm_tpm_sign_data_size_0_fail)
    {
        //arrange
        DPS_SECURE_DEVICE_HANDLE sec_handle = dps_hsm_tpm_create();
        umock_c_reset_all_calls();
        ...
        //act
        BUFFER_HANDLE sign_value = dps_hsm_tpm_sign_data(sec_handle, TEST_BUFFER, 0);
    ...
    /* Tests_SRS_SECURE_DEVICE_TPM_07_023: [ If an error is encountered dps_hsm_tpm_sign_data shall return NULL. ] */
    TEST_FUNCTION(dps_hsm_tpm_sign_data_fail)
    {
        //arrange
        DPS_SECURE_DEVICE_HANDLE sec_handle = dps_hsm_tpm_create();
        umock_c_reset_all_calls();
        ...
        setup_dps_hsm_tpm_sign_data_mocks();
        ...
        for (size_t index = 0; index < count; index++)
        {
            ...
            char tmp_msg[64];
            sprintf(tmp_msg, "dps_hsm_tpm_sign_data failure in test %zu/%zu", index, count);

            //act
            BUFFER_HANDLE sign_value = dps_hsm_tpm_sign_data(sec_handle, TEST_BUFFER, TEST_BUFFER_SIZE);
    ...
    /* Tests_SRS_SECURE_DEVICE_TPM_07_021: [ dps_hsm_tpm_sign_data shall call into the tpm to hash the supplied data value. ] */
    /* Tests_SRS_SECURE_DEVICE_TPM_07_022: [ If hashing the data was successful, dps_hsm_tpm_sign_data shall create a BUFFER_HANDLE with the supplied signed data. ] */
    TEST_FUNCTION(dps_hsm_tpm_sign_data_succeed)
    {
        //arrange
        DPS_SECURE_DEVICE_HANDLE sec_handle = dps_hsm_tpm_create();
        umock_c_reset_all_calls();
...
#if 0
    /* Tests_SRS_SECURE_DEVICE_TPM_07_025: [ If handle or data is NULL or data_len is 0, dps_hsm_tpm_decrypt_data shall return NULL. ] */
    TEST_FUNCTION(dps_hsm_tpm_decrypt_data_handle_NULL_fail)
    {
        //arrange

        //act
        BUFFER_HANDLE decrypt_value = dps_hsm_tpm_decrypt_data(NULL, TEST_BUFFER, TEST_BUFFER_SIZE);
    ...
    TEST_FUNCTION(dps_hsm_tpm_decrypt_data_data_NULL_fail)
    {
        //arrange
        DPS_SECURE_DEVICE_HANDLE sec_handle = dps_hsm_tpm_create();
        umock_c_reset_all_calls();
        ...
        //act
        BUFFER_HANDLE decrypt_value = dps_hsm_tpm_decrypt_data(sec_handle, NULL, TEST_BUFFER_SIZE);
    ...
    /* Tests_SRS_SECURE_DEVICE_TPM_07_025: [ If handle or data is NULL or data_len is 0, dps_hsm_tpm_decrypt_data shall return NULL. ] */
    TEST_FUNCTION(dps_hsm_tpm_decrypt_data_data_len_0_fail)
    {
        //arrange
        DPS_SECURE_DEVICE_HANDLE sec_handle = dps_hsm_tpm_create();
        umock_c_reset_all_calls();
        ...
        //act
        BUFFER_HANDLE decrypt_value = dps_hsm_tpm_decrypt_data(sec_handle, TEST_BUFFER, 0);
    ...
    /* Tests_SRS_SECURE_DEVICE_TPM_07_024: [ dps_hsm_tpm_decrypt_data shall call into the tpm to decrypt the supplied data value. ] */
    TEST_FUNCTION(dps_hsm_tpm_decrypt_data_succeed)
    {
        //arrange
        DPS_SECURE_DEVICE_HANDLE sec_handle = dps_hsm_tpm_create();
        umock_c_reset_all_calls();
        ...
        //act
        BUFFER_HANDLE decrypt_value = dps_hsm_tpm_decrypt_data(sec_handle, TEST_BUFFER, TEST_BUFFER_SIZE);
    ...
    /* Tests_SRS_SECURE_DEVICE_TPM_07_026: [ dps_hsm_tpm_interface shall return the SEC_TPM_INTERFACE structure. ] */
    TEST_FUNCTION(dps_hsm_tpm_interface_succeed)
    {
        //arrange
        DPS_SECURE_DEVICE_HANDLE sec_handle = dps_hsm_tpm_create();
        umock_c_reset_all_calls();
        ...
        //act
        const SEC_TPM_INTERFACE* tpm_iface = dps_hsm_tpm_interface();

        //assert
        ASSERT_IS_NOT_NULL(tpm_iface);
        ASSERT_IS_NOT_NULL(tpm_iface->secure_device_create);
        ASSERT_IS_NOT_NULL(tpm_iface->secure_device_destroy);
        ASSERT_IS_NOT_NULL(tpm_iface->secure_device_import_key);
        ASSERT_IS_NOT_NULL(tpm_iface->secure_device_get_ek);
        ASSERT_IS_NOT_NULL(tpm_iface->secure_device_get_srk);
        ASSERT_IS_NOT_NULL(tpm_iface->secure_device_sign_data);
        ASSERT_ARE_EQUAL(char_ptr, umock_c_get_expected_calls(), umock_c_get_actual_calls());
