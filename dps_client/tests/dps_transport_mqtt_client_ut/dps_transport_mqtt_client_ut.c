...
static pfdps_transport_create dps_mqtt_transport_create;
static pfdps_transport_destroy dps_mqtt_transport_destroy;
static pfdps_transport_open dps_mqtt_transport_open;
static pfdps_transport_close dps_mqtt_transport_close;
static pfdps_transport_register_device dps_mqtt_transport_register_device;
static pfdps_transport_get_operation_status dps_mqtt_transport_get_op_status;
static pfdps_transport_dowork dps_mqtt_transport_dowork;
static pfdps_transport_set_trace dps_mqtt_transport_set_trace;
static pfdps_transport_set_x509_cert dps_mqtt_transport_x509_cert;
static pfdps_transport_set_trusted_cert dps_mqtt_transport_trusted_cert;
static pfdps_transport_set_proxy dps_mqtt_transport_set_proxy;
...
BEGIN_TEST_SUITE(dps_transport_mqtt_client_ut)
    ...
    TEST_SUITE_INITIALIZE(suite_init)
    {
        ...
        dps_mqtt_transport_create = DPS_MQTT_Protocol()->dps_transport_create;
        dps_mqtt_transport_destroy = DPS_MQTT_Protocol()->dps_transport_destroy;
        dps_mqtt_transport_open = DPS_MQTT_Protocol()->dps_transport_open;
        dps_mqtt_transport_close = DPS_MQTT_Protocol()->dps_transport_close;
        dps_mqtt_transport_register_device = DPS_MQTT_Protocol()->dps_transport_register;
        dps_mqtt_transport_get_op_status = DPS_MQTT_Protocol()->dps_transport_get_op_status;
        dps_mqtt_transport_dowork = DPS_MQTT_Protocol()->dps_transport_dowork;
        dps_mqtt_transport_set_trace = DPS_MQTT_Protocol()->dps_transport_set_trace;
        dps_mqtt_transport_x509_cert = DPS_MQTT_Protocol()->dps_transport_x509_cert;
        dps_mqtt_transport_trusted_cert = DPS_MQTT_Protocol()->dps_transport_trusted_cert;
        dps_mqtt_transport_set_proxy = DPS_MQTT_Protocol()->dps_transport_set_proxy;
    }
    ...
    /* Tests_DPS_TRANSPORT_MQTT_CLIENT_07_001: [ dps_transport_mqtt_create shall call the dps_transport_common_mqtt_create function with mqtt_transport_io transport IO estabishment. ] */
    TEST_FUNCTION(dps_transport_mqtt_create_succeed)
    {
        //arrange
        ...
        //act
        DPS_TRANSPORT_HANDLE handle = dps_mqtt_transport_create(TEST_URI_VALUE, DPS_HSM_TYPE_TPM, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE);
    ...
    /* Tests_DPS_TRANSPORT_MQTT_CLIENT_07_014: [ On success mqtt_transport_io shall return an allocated DPS_TRANSPORT_IO_INFO structure. ] */
    TEST_FUNCTION(mqtt_transport_io_succeed)
    {
        XIO_HANDLE dps_io_info;
        (void)dps_mqtt_transport_create(TEST_URI_VALUE, DPS_HSM_TYPE_TPM, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE);
        umock_c_reset_all_calls();
    ...
    /* Tests_DPS_TRANSPORT_MQTT_CLIENT_07_017: [ If sasl_mechanism is NULL mqtt_transport_io shall assign the transfer_handle to the result and return the value. ] */
    TEST_FUNCTION(mqtt_transport_ws_io_x509_succeed)
    {
        XIO_HANDLE dps_io_info;
        (void)dps_mqtt_transport_create(TEST_URI_VALUE, DPS_HSM_TYPE_X509, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE);
        umock_c_reset_all_calls();
    ...
    /* Tests_DPS_TRANSPORT_MQTT_CLIENT_07_013: [ If any failure is encountered mqtt_transport_io shall return NULL ] */
    ...
    /* Tests_DPS_TRANSPORT_MQTT_CLIENT_07_012: [ If proxy_info is not NULL, mqtt_transport_io shall construct a HTTP_PROXY_IO_CONFIG object and assign it to TLSIO_CONFIG underlying_io_parameters ] */
    ...
    /* Tests_DPS_TRANSPORT_MQTT_CLIENT_07_002: [ dps_transport_mqtt_destroy shall invoke the dps_transport_common_mqtt_destroy method ] */
    TEST_FUNCTION(dps_transport_mqtt_destroy_succeed)
    {
        //arrange
        STRICT_EXPECTED_CALL(dps_transport_common_mqtt_destroy(TEST_DPS_HANDLE));

        //act
        dps_mqtt_transport_destroy(TEST_DPS_HANDLE);
    ...
    /* Tests_DPS_TRANSPORT_MQTT_CLIENT_07_003: [ dps_transport_mqtt_open shall invoke the dps_transport_common_mqtt_open method ] */
    TEST_FUNCTION(dps_transport_mqtt_open_succeed)
    {
        //arrange
        ...
        //act
        int result = dps_mqtt_transport_open(TEST_DPS_HANDLE, TEST_BUFFER_VALUE, TEST_BUFFER_VALUE, on_transport_register_data_cb, NULL, on_transport_status_cb, NULL);
    ...
    /* Tests_DPS_TRANSPORT_MQTT_CLIENT_07_004: [ dps_transport_mqtt_close shall invoke the dps_transport_common_mqtt_close method ] */
    TEST_FUNCTION(dps_transport_mqtt_close_succeed)
    {
        //arrange
        STRICT_EXPECTED_CALL(dps_transport_common_mqtt_close(TEST_DPS_HANDLE));

        //act
        int result = dps_mqtt_transport_close(TEST_DPS_HANDLE);
    ...
    /* Tests_DPS_TRANSPORT_MQTT_CLIENT_07_005: [ dps_transport_mqtt_register_device shall invoke the dps_transport_common_mqtt_register_device method ] */
    TEST_FUNCTION(dps_transport_mqtt_register_device_succeed)
    {
        //arrange
        ...
        //act
        int result = dps_mqtt_transport_register_device(TEST_DPS_HANDLE, on_transport_challenge_callback, NULL, on_transport_json_parse, NULL);
    ...
    /* Tests_DPS_TRANSPORT_MQTT_CLIENT_07_006: [ dps_transport_mqtt_get_operation_status shall invoke the dps_transport_common_mqtt_get_operation_status method ] */
    TEST_FUNCTION(dps_transport_mqtt_get_operation_status_succeed)
    {
        //arrange
        STRICT_EXPECTED_CALL(dps_transport_common_mqtt_get_operation_status(TEST_DPS_HANDLE));

        //act
        int result = dps_mqtt_transport_get_op_status(TEST_DPS_HANDLE);
    ...
    /* Tests_DPS_TRANSPORT_MQTT_CLIENT_07_007: [ dps_transport_mqtt_dowork shall invoke the dps_transport_common_mqtt_dowork method ] */
    TEST_FUNCTION(dps_transport_mqtt_dowork_succeed)
    {
        //arrange
        STRICT_EXPECTED_CALL(dps_transport_common_mqtt_dowork(TEST_DPS_HANDLE));

        //act
        dps_mqtt_transport_dowork(TEST_DPS_HANDLE);
    ...
    /* Tests_DPS_TRANSPORT_MQTT_CLIENT_07_008: [ dps_transport_mqtt_set_trace shall invoke the dps_transport_common_mqtt_set_trace method ] */
    TEST_FUNCTION(dps_transport_mqtt_set_trace_succeed)
    {
        //arrange
        STRICT_EXPECTED_CALL(dps_transport_common_mqtt_set_trace(TEST_DPS_HANDLE, true));

        //act
        int result = dps_mqtt_transport_set_trace(TEST_DPS_HANDLE, true);
    ...
    /* Tests_DPS_TRANSPORT_MQTT_CLIENT_07_009: [ dps_transport_mqtt_x509_cert shall invoke the dps_trans_common_mqtt_x509_cert method ]*/
    TEST_FUNCTION(dps_transport_mqtt_x509_cert_succeed)
    {
        //arrange
        STRICT_EXPECTED_CALL(dps_transport_common_mqtt_x509_cert(TEST_DPS_HANDLE, TEST_X509_CERT_VALUE, TEST_PRIVATE_KEY_VALUE));

        //act
        int result = dps_mqtt_transport_x509_cert(TEST_DPS_HANDLE, TEST_X509_CERT_VALUE, TEST_PRIVATE_KEY_VALUE);
    ...
    /* Tests_DPS_TRANSPORT_MQTT_CLIENT_07_010: [ dps_transport_mqtt_set_trusted_cert shall invoke the dps_transport_common_mqtt_set_trusted_cert method ] */
    TEST_FUNCTION(dps_transport_mqtt_set_trusted_cert_succeed)
    {
        //arrange
        STRICT_EXPECTED_CALL(dps_transport_common_mqtt_set_trusted_cert(TEST_DPS_HANDLE, TEST_CERT_VALUE));

        //act
        int result = dps_mqtt_transport_trusted_cert(TEST_DPS_HANDLE, TEST_CERT_VALUE);
    ...
    /* Tests_DPS_TRANSPORT_MQTT_CLIENT_07_011: [ dps_transport_mqtt_set_proxy shall invoke the dps_transport_common_mqtt_set_proxy method ] */
    TEST_FUNCTION(dps_transport_mqtt_set_proxy_succeed)
    {
        //arrange
        ...
        //act
        int result = dps_mqtt_transport_set_proxy(TEST_DPS_HANDLE, &proxy_options);
    ...
    END_TEST_SUITE(dps_transport_mqtt_client_ut)
