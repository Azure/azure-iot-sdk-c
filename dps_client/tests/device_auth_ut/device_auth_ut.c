...
MOCKABLE_FUNCTION(, SECURITY_DEVICE_HANDLE, secure_device_create);
MOCKABLE_FUNCTION(, void, secure_device_destroy, SECURITY_DEVICE_HANDLE, handle);
MOCKABLE_FUNCTION(, BUFFER_HANDLE, secure_device_sign_data, SECURITY_DEVICE_HANDLE, handle, const unsigned char*, data, size_t, data_len);
MOCKABLE_FUNCTION(, const char*, secure_device_get_certificate, SECURITY_DEVICE_HANDLE, handle);
MOCKABLE_FUNCTION(, const char*, secure_device_get_alias_key, SECURITY_DEVICE_HANDLE, handle);
...
static const SAS_SECURITY_INTERFACE test_tpm_interface =
{
...
static const SAS_SECURITY_INTERFACE test_tpm_interface_fail =
{
    secure_device_create,
    secure_device_destroy,
    NULL
...
static const X509_SECURITY_INTERFACE test_riot_interface =
{
    secure_device_create,
    secure_device_destroy,
...
static const X509_SECURITY_INTERFACE test_riot_interface_fail =
{
    secure_device_create,
    secure_device_destroy,
    secure_device_get_certificate,
...
static SECURITY_DEVICE_HANDLE my_secure_device_create(void)
{
    return (SECURITY_DEVICE_HANDLE)my_gballoc_malloc(1);
}

static const char* my_secure_device_get_alias_key(SECURITY_DEVICE_HANDLE handle)
{
    (void)handle;
...
static const char* my_secure_device_get_certificate(SECURITY_DEVICE_HANDLE handle)
{
    (void)handle;
    size_t len = strlen(TEST_STRING_VALUE);
    char* result = (char*)my_gballoc_malloc(len+1);
...
static char* my_secure_device_get_signer_cert(SECURITY_DEVICE_HANDLE handle)
{
    (void)handle;
    size_t len = strlen(TEST_STRING_VALUE);
    char* result = (char*)my_gballoc_malloc(len+1);
...
static BUFFER_HANDLE my_secure_device_sign_data(SECURITY_DEVICE_HANDLE handle, const unsigned char* data, size_t data_len)
{
    (void)handle;
    (void)data;
    (void)data_len;
...
BEGIN_TEST_SUITE(iothub_device_auth_ut)
    ...
    TEST_SUITE_INITIALIZE(suite_init)
    {
        ...
        REGISTER_GLOBAL_MOCK_HOOK(secure_device_get_alias_key, my_secure_device_get_alias_key);
        ...
        REGISTER_GLOBAL_MOCK_HOOK(secure_device_get_certificate, my_secure_device_get_certificate);
        ...
        REGISTER_GLOBAL_MOCK_RETURN(iothub_security_interface, &test_tpm_interface);
    ...
    static void setup_iothub_device_auth_generate_credentials_riot_mocks(void)
    {
        STRICT_EXPECTED_CALL(gballoc_malloc(IGNORED_NUM_ARG));
        STRICT_EXPECTED_CALL(secure_device_get_certificate(IGNORED_NUM_ARG));
        STRICT_EXPECTED_CALL(secure_device_get_alias_key(IGNORED_NUM_ARG));
    }
    ...
    TEST_FUNCTION(iothub_device_auth_create_tpm_succeed)
    {
        ...
        STRICT_EXPECTED_CALL(iothub_security_interface()).SetReturn(&test_tpm_interface);
    ...
    TEST_FUNCTION(iothub_device_auth_create_tpm_Interface_NULL_fail)
    {
        ...
        STRICT_EXPECTED_CALL(gballoc_malloc(IGNORED_NUM_ARG));
        STRICT_EXPECTED_CALL(iothub_security_type()).SetReturn(IOTHUB_SECURITY_TYPE_SAS);
        STRICT_EXPECTED_CALL(iothub_security_interface()).SetReturn(&test_tpm_interface_fail);
        STRICT_EXPECTED_CALL(gballoc_free(IGNORED_PTR_ARG));
    ...
    TEST_FUNCTION(iothub_device_auth_create_riot_succeed)
    {
        //arrange
        STRICT_EXPECTED_CALL(gballoc_malloc(IGNORED_NUM_ARG));
        STRICT_EXPECTED_CALL(iothub_security_type()).SetReturn(IOTHUB_SECURITY_TYPE_X509);
        STRICT_EXPECTED_CALL(iothub_security_interface()).SetReturn(&test_riot_interface);
        STRICT_EXPECTED_CALL(secure_device_create());
    ...
    /* Tests_IOTHUB_DEV_AUTH_07_002: [ iothub_device_auth_create shall allocate the IOTHUB_SECURITY_INFO and shall fail if the allocation fails. ]*/
    TEST_FUNCTION(iothub_device_auth_create_riot_Interface_NULL_fail)
    {
        //arrange
        STRICT_EXPECTED_CALL(gballoc_malloc(IGNORED_NUM_ARG));
        STRICT_EXPECTED_CALL(iothub_security_type()).SetReturn(IOTHUB_SECURITY_TYPE_X509);
        STRICT_EXPECTED_CALL(iothub_security_interface()).SetReturn(&test_riot_interface_fail);
        STRICT_EXPECTED_CALL(gballoc_free(IGNORED_PTR_ARG));
    ...
    TEST_FUNCTION(iothub_device_auth_get_auth_type_handle_NULL_fail)
    {
        ...
        //act
        DEVICE_AUTH_TYPE dev_auth_type = iothub_device_auth_get_auth_type(NULL);
    ...
    TEST_FUNCTION(iothub_device_auth_get_auth_type_succeed)
    {
        ...
        //act
        DEVICE_AUTH_TYPE dev_auth_type = iothub_device_auth_get_auth_type(xda_handle);
    ...
    TEST_FUNCTION(iothub_device_auth_generate_credentials_riot_succeed)
    {
        //arrange
        STRICT_EXPECTED_CALL(gballoc_malloc(IGNORED_NUM_ARG));
        STRICT_EXPECTED_CALL(iothub_security_type()).SetReturn(IOTHUB_SECURITY_TYPE_X509);
        ...
        setup_iothub_device_auth_generate_credentials_riot_mocks();
    ...
    TEST_FUNCTION(iothub_device_auth_generate_credentials_riot_fail)
    {
        STRICT_EXPECTED_CALL(gballoc_malloc(IGNORED_NUM_ARG));
        STRICT_EXPECTED_CALL(iothub_security_type()).SetReturn(IOTHUB_SECURITY_TYPE_X509);
        STRICT_EXPECTED_CALL(iothub_security_interface()).SetReturn(&test_riot_interface);
    ...
    END_TEST_SUITE(iothub_device_auth_ut)
