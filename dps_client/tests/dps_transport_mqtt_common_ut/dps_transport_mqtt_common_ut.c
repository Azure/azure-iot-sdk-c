...
BEGIN_TEST_SUITE(dps_transport_mqtt_common_ut)
    ...
    static void setup_dps_transport_common_mqtt_create_mocks(void)
    {
    ...
    /* Tests_DPS_TRANSPORT_MQTT_COMMON_07_001: [ If uri, scope_id, registration_id, dps_api_version, or transport_io is NULL, dps_transport_common_mqtt_create shall return NULL. ] */
    TEST_FUNCTION(dps_transport_common_mqtt_create_uri_NULL_fail)
    {
        //arrange

        //act
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_mqtt_create(NULL, DPS_HSM_TYPE_X509, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_mqtt_transport_io);
    ...
    /* Tests_DPS_TRANSPORT_MQTT_COMMON_07_001: [ If uri, scope_id, registration_id, dps_api_version, or transport_io is NULL, dps_transport_common_mqtt_create shall return NULL. ] */
    TEST_FUNCTION(dps_transport_common_mqtt_create_scope_id_NULL_fail)
    {
        //arrange

        //act
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_mqtt_create(TEST_URI_VALUE, DPS_HSM_TYPE_X509, NULL, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_mqtt_transport_io);
    ...
    /* Tests_DPS_TRANSPORT_MQTT_COMMON_07_001: [ If uri, scope_id, registration_id, dps_api_version, or transport_io is NULL, dps_transport_common_mqtt_create shall return NULL. ] */
    TEST_FUNCTION(dps_transport_common_mqtt_create_registration_id_NULL_fail)
    {
        //arrange

        //act
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_mqtt_create(TEST_URI_VALUE, DPS_HSM_TYPE_X509, TEST_SCOPE_ID_VALUE, NULL, TEST_DPS_API_VALUE, on_mqtt_transport_io);
    ...
    /* Tests_DPS_TRANSPORT_MQTT_COMMON_07_001: [ If uri, scope_id, registration_id, dps_api_version, or transport_io is NULL, dps_transport_common_mqtt_create shall return NULL. ] */
    TEST_FUNCTION(dps_transport_common_mqtt_create_api_version_NULL_fail)
    {
        //arrange

        //act
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_mqtt_create(TEST_URI_VALUE, DPS_HSM_TYPE_X509, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, NULL, on_mqtt_transport_io);
    ...
    /* Tests_DPS_TRANSPORT_MQTT_COMMON_07_001: [ If uri, scope_id, registration_id, dps_api_version, or transport_io is NULL, dps_transport_common_mqtt_create shall return NULL. ] */
    TEST_FUNCTION(dps_transport_common_mqtt_create_transport_io_NULL_fail)
    {
        //arrange

        //act
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_mqtt_create(TEST_URI_VALUE, DPS_HSM_TYPE_X509, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, NULL);
    ...
    /* Tests_DPS_TRANSPORT_MQTT_COMMON_07_002: [ If any error is encountered, dps_transport_common_mqtt_create shall return NULL. ] */
    TEST_FUNCTION(dps_transport_common_mqtt_create_fail)
    {
        int negativeTestsInitResult = umock_c_negative_tests_init();
        ASSERT_ARE_EQUAL(int, 0, negativeTestsInitResult);

        //arrange
        setup_dps_transport_common_mqtt_create_mocks();
        ...
        for (size_t index = 0; index < count; index++)
        {
            ...
            char tmp_msg[64];
            sprintf(tmp_msg, "dps_transport_common_mqtt_create failure in test %zu/%zu", index, count);

            //act
            DPS_TRANSPORT_HANDLE handle = dps_transport_common_mqtt_create(TEST_URI_VALUE, DPS_HSM_TYPE_X509, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_mqtt_transport_io);
    ...
    TEST_FUNCTION(dps_transport_common_mqtt_create_tpm_fail)
    {
        //arrange

        //act
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_mqtt_create(TEST_URI_VALUE, DPS_HSM_TYPE_TPM, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_mqtt_transport_io);
    ...
    TEST_FUNCTION(dps_transport_common_mqtt_create_succeed)
    {
        //arrange
        setup_dps_transport_common_mqtt_create_mocks();
    ...
    TEST_FUNCTION(dps_transport_common_mqtt_destroy_handle_NULL_fail)
    {
        //arrange

        //act
        dps_transport_common_mqtt_destroy(NULL);
    ...
    TEST_FUNCTION(dps_transport_common_mqtt_destroy_succeed)
    {
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_mqtt_create(TEST_URI_VALUE, DPS_HSM_TYPE_X509, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_mqtt_transport_io);
        umock_c_reset_all_calls();
    ...
    TEST_FUNCTION(dps_transport_common_mqtt_open_handle_NULL_fail)
    {
        //arrange

        //act
        int result = dps_transport_common_mqtt_open(NULL, TEST_BUFFER_VALUE, TEST_BUFFER_VALUE, on_transport_register_data_cb, NULL, on_transport_status_cb, NULL);
    ...
    /* Tests_DPS_TRANSPORT_MQTT_COMMON_07_007: [ If handle, data_callback, or status_cb is NULL, dps_transport_common_mqtt_open shall return a non-zero value. ] */
    TEST_FUNCTION(dps_transport_common_mqtt_open_data_callback_NULL_fail)
    {
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_mqtt_create(TEST_URI_VALUE, DPS_HSM_TYPE_X509, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_mqtt_transport_io);
        umock_c_reset_all_calls();
        ...
        //act
        int result = dps_transport_common_mqtt_open(handle, TEST_BUFFER_VALUE, TEST_BUFFER_VALUE, NULL, NULL, on_transport_status_cb, NULL);
    ...
    /* Tests_DPS_TRANSPORT_MQTT_COMMON_07_007: [ If handle, data_callback, or status_cb is NULL, dps_transport_common_mqtt_open shall return a non-zero value. ] */
    TEST_FUNCTION(dps_transport_common_mqtt_open_status_callback_NULL_fail)
    {
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_mqtt_create(TEST_URI_VALUE, DPS_HSM_TYPE_X509, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_mqtt_transport_io);
        umock_c_reset_all_calls();
        ...
        //act
        int result = dps_transport_common_mqtt_open(handle, TEST_BUFFER_VALUE, TEST_BUFFER_VALUE, on_transport_register_data_cb, NULL, NULL, NULL);
    ...
    /* Tests_DPS_TRANSPORT_MQTT_COMMON_07_008: [ If hsm_type is DPS_HSM_TYPE_TPM and ek or srk is NULL, dps_transport_common_mqtt_open shall return a non-zero value. ] */
    TEST_FUNCTION(dps_transport_common_mqtt_open_ek_NULL_fail)
    {
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_mqtt_create(TEST_URI_VALUE, DPS_HSM_TYPE_TPM, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_mqtt_transport_io);
        umock_c_reset_all_calls();
        ...
        //act
        int result = dps_transport_common_mqtt_open(handle, NULL, TEST_BUFFER_VALUE, on_transport_register_data_cb, NULL, on_transport_status_cb, NULL);
    ...
    /* Tests_DPS_TRANSPORT_MQTT_COMMON_07_008: [ If hsm_type is DPS_HSM_TYPE_TPM and ek or srk is NULL, dps_transport_common_mqtt_open shall return a non-zero value. ] */
    TEST_FUNCTION(dps_transport_common_mqtt_open_srk_NULL_fail)
    {
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_mqtt_create(TEST_URI_VALUE, DPS_HSM_TYPE_TPM, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_mqtt_transport_io);
        umock_c_reset_all_calls();
        ...
        //act
        int result = dps_transport_common_mqtt_open(handle, TEST_BUFFER_VALUE, NULL, on_transport_register_data_cb, NULL, on_transport_status_cb, NULL);
    ...
    TEST_FUNCTION(dps_transport_common_mqtt_open_succeed)
    {
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_mqtt_create(TEST_URI_VALUE, DPS_HSM_TYPE_X509, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_mqtt_transport_io);
        umock_c_reset_all_calls();
        ...
        //act
        int result = dps_transport_common_mqtt_open(handle, TEST_BUFFER_VALUE, TEST_BUFFER_VALUE, on_transport_register_data_cb, NULL, on_transport_status_cb, NULL);
        ...
        //cleanup
        dps_transport_common_mqtt_close(handle);
        dps_transport_common_mqtt_destroy(handle);
    }
    ...
    TEST_FUNCTION(dps_transport_common_mqtt_open_fail)
    {
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_mqtt_create(TEST_URI_VALUE, DPS_HSM_TYPE_X509, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_mqtt_transport_io);
        umock_c_reset_all_calls();
        ...
        for (size_t index = 0; index < count; index++)
        {
            ...
            char tmp_msg[64];
            sprintf(tmp_msg, "dps_transport_common_mqtt_open failure in test %zu/%zu", index, count);
    ...
    /* Tests_DPS_TRANSPORT_MQTT_COMMON_07_009: [ dps_transport_common_mqtt_open shall clone the ek and srk values.] */
    TEST_FUNCTION(dps_transport_common_mqtt_open_x509_succeed)
    {
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_mqtt_create(TEST_URI_VALUE, DPS_HSM_TYPE_X509, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_mqtt_transport_io);
        umock_c_reset_all_calls();
        ...
        //act
        int result = dps_transport_common_mqtt_open(handle, NULL, NULL, on_transport_register_data_cb, NULL, on_transport_status_cb, NULL);
    ...
    TEST_FUNCTION(dps_transport_amqp_close_handle_NULL)
    {
        ...
        //act
        int result = dps_transport_common_mqtt_close(NULL);
    ...
    TEST_FUNCTION(dps_transport_amqp_close_succeed)
    {
        ...
        //act
        int result = dps_transport_common_mqtt_close(handle);
    ...
    TEST_FUNCTION(dps_transport_common_mqtt_register_device_handle_NULL_succeed)
    {
        //arrange

        //act
        int result = dps_transport_common_mqtt_register_device(NULL, on_transport_challenge_callback, NULL, on_transport_json_parse, NULL);
    ...
    TEST_FUNCTION(dps_transport_common_mqtt_register_device_challenge_NULL_succeed)
    {
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_mqtt_create(TEST_URI_VALUE, DPS_HSM_TYPE_TPM, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_mqtt_transport_io);
        umock_c_reset_all_calls();
        ...
        //act
        int result = dps_transport_common_mqtt_register_device(handle, NULL, NULL, on_transport_json_parse, NULL);
    ...
    /* Tests_DPS_TRANSPORT_MQTT_COMMON_07_015: [ If hsm_type is of type DPS_HSM_TYPE_TPM and reg_challenge_cb is NULL, dps_transport_common_mqtt_register_device shall return a non-zero value. ] */
    TEST_FUNCTION(dps_transport_common_mqtt_register_device_x509_challenge_NULL_succeed)
    {
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_mqtt_create(TEST_URI_VALUE, DPS_HSM_TYPE_X509, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_mqtt_transport_io);
        umock_c_reset_all_calls();
    ...
    TEST_FUNCTION(dps_transport_common_mqtt_register_device_succeed)
    {
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_mqtt_create(TEST_URI_VALUE, DPS_HSM_TYPE_X509, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_mqtt_transport_io);
        umock_c_reset_all_calls();
        ...
        //act
        int result = dps_transport_common_mqtt_register_device(handle, on_transport_challenge_callback, NULL, on_transport_json_parse, NULL);
    ...
    TEST_FUNCTION(dps_transport_common_mqtt_register_device_twice_fail)
    {
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_mqtt_create(TEST_URI_VALUE, DPS_HSM_TYPE_X509, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_mqtt_transport_io);
        (void)dps_transport_common_mqtt_register_device(handle, on_transport_challenge_callback, NULL, on_transport_json_parse, NULL);
        umock_c_reset_all_calls();
    ...
    TEST_FUNCTION(dps_transport_common_mqtt_get_operation_status_handle_NULL_fail)
    {
        //arrange

        //act
        int result = dps_transport_common_mqtt_get_operation_status(NULL);
    ...
    TEST_FUNCTION(dps_transport_common_mqtt_get_operation_status_operation_id_zero_fail)
    {
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_mqtt_create(TEST_URI_VALUE, DPS_HSM_TYPE_X509, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_mqtt_transport_io);
        umock_c_reset_all_calls();
        ...
        //act
        int result = dps_transport_common_mqtt_get_operation_status(handle);
    ...
    TEST_FUNCTION(dps_transport_common_mqtt_get_operation_status_success)
    {
        int result;
        ...
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_mqtt_create(TEST_URI_VALUE, DPS_HSM_TYPE_X509, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_mqtt_transport_io);
        (void)dps_transport_common_mqtt_x509_cert(handle, TEST_X509_CERT_VALUE, TEST_PRIVATE_KEY_VALUE);
        (void)dps_transport_common_mqtt_open(handle, TEST_BUFFER_VALUE, TEST_BUFFER_VALUE, on_transport_register_data_cb, NULL, on_transport_status_cb, NULL);
        (void)dps_transport_common_mqtt_register_device(handle, on_transport_challenge_callback, NULL, on_transport_json_parse, NULL);
        ...
        //act
        result = dps_transport_common_mqtt_get_operation_status(handle);
    ...
    TEST_FUNCTION(dps_transport_common_mqtt_dowork_handle_NULL_fail)
    {
        //arrange

        //act
        dps_transport_common_mqtt_dowork(NULL);
    ...
    TEST_FUNCTION(dps_transport_common_mqtt_dowork_x509_connected_fail)
    {
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_mqtt_create(TEST_URI_VALUE, DPS_HSM_TYPE_X509, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_mqtt_transport_io);
        (void)dps_transport_common_mqtt_x509_cert(handle, TEST_X509_CERT_VALUE, TEST_PRIVATE_KEY_VALUE);
        umock_c_reset_all_calls();
    ...
    TEST_FUNCTION(dps_transport_common_mqtt_dowork_x509_connected_succeed)
    {
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_mqtt_create(TEST_URI_VALUE, DPS_HSM_TYPE_X509, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_mqtt_transport_io);
        (void)dps_transport_common_mqtt_x509_cert(handle, TEST_X509_CERT_VALUE, TEST_PRIVATE_KEY_VALUE);
        (void)dps_transport_common_mqtt_open(handle, TEST_BUFFER_VALUE, TEST_BUFFER_VALUE, on_transport_register_data_cb, NULL, on_transport_status_cb, NULL);
    ...
    TEST_FUNCTION(dps_transport_common_mqtt_dowork_idle_succeed)
    {
        CONNECT_ACK connack = { true, CONNECTION_ACCEPTED };
        QOS_VALUE QosValue[] = { DELIVER_AT_LEAST_ONCE };
        SUBSCRIBE_ACK suback;
    ...
    /* Tests_DPS_TRANSPORT_MQTT_COMMON_07_050: [ When the mqtt_state is MQTT_STATE_CONNECTED, dps_transport_common_mqtt_dowork shall subscribe to the topic $dps/registrations/res/# ] */
    TEST_FUNCTION(dps_transport_common_mqtt_dowork_subscribe_succeed)
    {
        CONNECT_ACK connack = { true, CONNECTION_ACCEPTED };
    ...
    TEST_FUNCTION(dps_transport_common_mqtt_dowork_subscribe_fail)
    {
        CONNECT_ACK connack = { true, CONNECTION_ACCEPTED };
        ...
        STRICT_EXPECTED_CALL(mqtt_client_dowork(IGNORED_PTR_ARG));
        STRICT_EXPECTED_CALL(on_transport_register_data_cb(DPS_TRANSPORT_RESULT_ERROR, NULL, NULL, NULL, IGNORED_PTR_ARG));
    ...
    TEST_FUNCTION(dps_transport_common_mqtt_dowork_register_recv_succeed)
    {
        CONNECT_ACK connack = { true, CONNECTION_ACCEPTED };
        QOS_VALUE QosValue[] = { DELIVER_AT_LEAST_ONCE };
        SUBSCRIBE_ACK suback;
    ...
    /* Tests_DPS_TRANSPORT_MQTT_COMMON_07_054: [ Upon successful sending of a TRANSPORT_CLIENT_STATE_REG_SEND message, dps_transport_common_mqtt_dowork shall set the transport_state to TRANSPORT_CLIENT_STATE_REG_SENT ] */
    TEST_FUNCTION(dps_transport_common_mqtt_dowork_register_recv_assigned_succeed)
    {
        DPS_TRANSPORT_HANDLE handle;
        CONNECT_ACK connack = { true, CONNECTION_ACCEPTED };
        QOS_VALUE QosValue[] = { DELIVER_AT_LEAST_ONCE };
        SUBSCRIBE_ACK suback;
        suback.packetId = 1234;
        ...
        handle = dps_transport_common_mqtt_create(TEST_URI_VALUE, DPS_HSM_TYPE_X509, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_mqtt_transport_io);
        (void)dps_transport_common_mqtt_x509_cert(handle, TEST_X509_CERT_VALUE, TEST_PRIVATE_KEY_VALUE);
        (void)dps_transport_common_mqtt_open(handle, TEST_BUFFER_VALUE, TEST_BUFFER_VALUE, on_transport_register_data_cb, NULL, on_transport_status_cb, NULL);
        (void)dps_transport_common_mqtt_register_device(handle, on_transport_challenge_callback, NULL, on_transport_json_parse, NULL);
        dps_transport_common_mqtt_dowork(handle);
    ...
    /* Tests_DPS_TRANSPORT_MQTT_COMMON_07_055: [ When then transport_state is set to TRANSPORT_CLIENT_STATE_STATUS_SEND, dps_transport_common_mqtt_dowork shall send a AMQP_OPERATION_STATUS message ] */
    /* Tests_DPS_TRANSPORT_MQTT_COMMON_07_056: [ Upon successful sending of a AMQP_OPERATION_STATUS message, dps_transport_common_mqtt_dowork shall set the transport_state to TRANSPORT_CLIENT_STATE_STATUS_SENT ] */
    TEST_FUNCTION(dps_transport_common_mqtt_dowork_send_status_succeed)
    {
        DPS_TRANSPORT_HANDLE handle;
        CONNECT_ACK connack = { true, CONNECTION_ACCEPTED };
        QOS_VALUE QosValue[] = { DELIVER_AT_LEAST_ONCE };
        ...
        g_target_transport_status = DPS_TRANSPORT_STATUS_ASSIGNING;
        dps_transport_common_mqtt_dowork(handle);
        (void)dps_transport_common_mqtt_get_operation_status(handle);
        umock_c_reset_all_calls();
    ...
    TEST_FUNCTION(dps_transport_common_mqtt_set_trace_handle_NULL_fail)
    {
        //arrange

        //act
        int result = dps_transport_common_mqtt_set_trace(NULL, true);
    ...
    /* Tests_DPS_TRANSPORT_MQTT_COMMON_07_025: [ On success dps_transport_common_mqtt_set_trace shall return a zero value. ] */
    TEST_FUNCTION(dps_transport_common_mqtt_set_trace_succeed)
    {
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_mqtt_create(TEST_URI_VALUE, DPS_HSM_TYPE_X509, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_mqtt_transport_io);
        umock_c_reset_all_calls();
        ...
        //act
        int result = dps_transport_common_mqtt_set_trace(handle, true);
    ...
    TEST_FUNCTION(dps_transport_common_mqtt_x509_cert_handle_NULL_fail)
    {
        //arrange

        //act
        int result = dps_transport_common_mqtt_x509_cert(NULL, TEST_X509_CERT_VALUE, TEST_PRIVATE_KEY_VALUE);
    ...
    TEST_FUNCTION(dps_transport_common_mqtt_x509_cert_succeed)
    {
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_mqtt_create(TEST_URI_VALUE, DPS_HSM_TYPE_X509, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_mqtt_transport_io);
        umock_c_reset_all_calls();
        ...
        //act
        int result = dps_transport_common_mqtt_x509_cert(handle, TEST_X509_CERT_VALUE, TEST_PRIVATE_KEY_VALUE);
    ...
    TEST_FUNCTION(dps_transport_common_mqtt_x509_cert_fail)
    {
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_mqtt_create(TEST_URI_VALUE, DPS_HSM_TYPE_X509, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_mqtt_transport_io);
        umock_c_reset_all_calls();
        ...
        for (size_t index = 0; index < count; index++)
        {
            ...
            char tmp_msg[64];
            sprintf(tmp_msg, "dps_transport_common_mqtt_dowork failure in test %zu/%zu", index, count);
    ...
    TEST_FUNCTION(dps_transport_common_mqtt_set_trusted_cert_handle_NULL)
    {
        //arrange

        //act
        int result = dps_transport_common_mqtt_set_trusted_cert(NULL, TEST_CERT_VALUE);
    ...
    /* Tests_DPS_TRANSPORT_MQTT_COMMON_07_030: [ If handle or certificate is NULL, dps_transport_common_mqtt_set_trusted_cert shall return a non-zero value. ] */
    TEST_FUNCTION(dps_transport_common_mqtt_set_trusted_cert_cert_NULL_fail)
    {
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_mqtt_create(TEST_URI_VALUE, DPS_HSM_TYPE_X509, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_mqtt_transport_io);
        umock_c_reset_all_calls();
        ...
        //act
        int result = dps_transport_common_mqtt_set_trusted_cert(handle, NULL);
    ...
    TEST_FUNCTION(dps_transport_common_mqtt_set_trusted_cert_succeed)
    {
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_mqtt_create(TEST_URI_VALUE, DPS_HSM_TYPE_X509, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_mqtt_transport_io);
        umock_c_reset_all_calls();
        ...
        //act
        int result = dps_transport_common_mqtt_set_trusted_cert(handle, TEST_CERT_VALUE);
    ...
    TEST_FUNCTION(dps_transport_common_mqtt_set_trusted_cert_fail)
    {
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_mqtt_create(TEST_URI_VALUE, DPS_HSM_TYPE_X509, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_mqtt_transport_io);
        umock_c_reset_all_calls();
    ...
    TEST_FUNCTION(dps_transport_common_mqtt_set_proxy_handle_NULL_fail)
    {
        //arrange
        ...
        //act
        int result = dps_transport_common_mqtt_set_proxy(NULL, &proxy_options);
    ...
    /* Tests_DPS_TRANSPORT_MQTT_COMMON_07_034: [ If handle or proxy_options is NULL, dps_transport_common_mqtt_set_proxy shall return a non-zero value. ]*/
    TEST_FUNCTION(dps_transport_common_mqtt_set_proxy_proxy_NULL_fail)
    {
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_mqtt_create(TEST_URI_VALUE, DPS_HSM_TYPE_X509, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_mqtt_transport_io);
        umock_c_reset_all_calls();
        ...
        //act
        int result = dps_transport_common_mqtt_set_proxy(handle, NULL);
    ...
    TEST_FUNCTION(dps_transport_common_mqtt_set_proxy_no_username_fail)
    {
        HTTP_PROXY_OPTIONS proxy_options = { 0 };
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_mqtt_create(TEST_URI_VALUE, DPS_HSM_TYPE_X509, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_mqtt_transport_io);
        umock_c_reset_all_calls();
        ...
        //act
        int result = dps_transport_common_mqtt_set_proxy(handle, &proxy_options);
    ...
    TEST_FUNCTION(dps_transport_common_mqtt_set_proxy_2_succeed)
    {
        HTTP_PROXY_OPTIONS proxy_options = { 0 };
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_mqtt_create(TEST_URI_VALUE, DPS_HSM_TYPE_X509, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_mqtt_transport_io);
        umock_c_reset_all_calls();
    ...
    TEST_FUNCTION(dps_transport_common_mqtt_set_proxy_hostname_NULL_fail)
    {
        HTTP_PROXY_OPTIONS proxy_options = { 0 };
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_mqtt_create(TEST_URI_VALUE, DPS_HSM_TYPE_X509, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_mqtt_transport_io);
        umock_c_reset_all_calls();
    ...
    TEST_FUNCTION(dps_transport_common_mqtt_set_proxy_fail)
    {
        HTTP_PROXY_OPTIONS proxy_options = { 0 };
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_mqtt_create(TEST_URI_VALUE, DPS_HSM_TYPE_X509, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_mqtt_transport_io);
        umock_c_reset_all_calls();
        ...
        for (size_t index = 0; index < count; index++)
        {
            ...
            char tmp_msg[64];
            sprintf(tmp_msg, "dps_transport_common_mqtt_set_proxy failure in test %zu/%zu", index, count);
    ...
    /* Tests_DPS_TRANSPORT_MQTT_COMMON_07_038: [ dps_transport_common_mqtt_set_proxy shall copy the host_addess, username, or password variables ] */
    /* Tests_DPS_TRANSPORT_MQTT_COMMON_07_040: [ On success dps_transport_common_mqtt_set_proxy shall return a zero value. ] */
    TEST_FUNCTION(dps_transport_common_mqtt_set_proxy_succeed)
    {
        HTTP_PROXY_OPTIONS proxy_options = { 0 };
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_mqtt_create(TEST_URI_VALUE, DPS_HSM_TYPE_X509, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_mqtt_transport_io);
        umock_c_reset_all_calls();
    ...
    TEST_FUNCTION(dps_transport_common_mqtt_set_proxy_twice_succeed)
    {
        HTTP_PROXY_OPTIONS proxy_options = { 0 };
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_mqtt_create(TEST_URI_VALUE, DPS_HSM_TYPE_X509, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_mqtt_transport_io);
        ...
        proxy_options.username = TEST_USERNAME_VALUE;
        proxy_options.password = TEST_PASSWORD_VALUE;
        (void)dps_transport_common_mqtt_set_proxy(handle, &proxy_options);
        umock_c_reset_all_calls();
    ...
    END_TEST_SUITE(dps_transport_mqtt_common_ut)
