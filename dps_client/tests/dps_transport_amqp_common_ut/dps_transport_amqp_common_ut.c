...
MOCKABLE_FUNCTION(, DPS_TRANSPORT_IO_INFO*, on_transport_io, const char*, fqdn, SASL_MECHANISM_HANDLE*, sasl_mechanism, const HTTP_PROXY_OPTIONS*, proxy_info);
...
static DPS_TRANSPORT_STATUS g_target_transport_status;
...
static DPS_JSON_INFO* my_on_transport_json_parse(const char* json_document, void* user_ctx)
{
    (void)json_document;
    (void)user_ctx;
    DPS_JSON_INFO* result = (DPS_JSON_INFO*)my_gballoc_malloc(sizeof(DPS_JSON_INFO));
    if (g_target_transport_status == DPS_TRANSPORT_STATUS_ASSIGNED)
    {
        result->dps_status = DPS_TRANSPORT_STATUS_ASSIGNED;
    ...
    else if (g_target_transport_status == DPS_TRANSPORT_STATUS_ASSIGNING)
    {
        result->dps_status = DPS_TRANSPORT_STATUS_ASSIGNING;
    ...
    {
        result->dps_status = DPS_TRANSPORT_STATUS_UNASSIGNED;
        result->authorization_key = (BUFFER_HANDLE)my_gballoc_malloc(1);
...
static DPS_TRANSPORT_IO_INFO* my_on_transport_io(const char* fqdn, SASL_MECHANISM_HANDLE* sasl_mechanism, const HTTP_PROXY_OPTIONS* proxy_info)
{
    ...
    result = (DPS_TRANSPORT_IO_INFO*)my_gballoc_malloc(sizeof(DPS_TRANSPORT_IO_INFO) );
...
BEGIN_TEST_SUITE(dps_transport_amqp_common_ut)
    ...
    TEST_SUITE_INITIALIZE(suite_init)
    {
        ...
        REGISTER_GLOBAL_MOCK_RETURN(dps_sasltpm_get_interface, TEST_INTERFACE_DESC);
        REGISTER_GLOBAL_MOCK_FAIL_RETURN(dps_sasltpm_get_interface, NULL);
    ...
    {
        STRICT_EXPECTED_CALL(dps_sasltpm_get_interface());
        if (!use_x509)
        {
    ...
    static void setup_dps_transport_common_amqp_create_mocks(void)
    {
        STRICT_EXPECTED_CALL(gballoc_malloc(IGNORED_NUM_ARG));
    ...
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_001: [ If uri, scope_id, registration_id, dps_api_version, or transport_io is NULL, dps_transport_common_amqp_create shall return NULL. ] */
    TEST_FUNCTION(dps_transport_common_amqp_create_uri_NULL_fail)
    {
        //arrange

        //act
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_amqp_create(NULL, DPS_HSM_TYPE_TPM, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_transport_io);
    ...
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_001: [ If uri, scope_id, registration_id, dps_api_version, or transport_io is NULL, dps_transport_common_amqp_create shall return NULL. ] */
    TEST_FUNCTION(dps_transport_common_amqp_create_scope_id_NULL_fail)
    {
        //arrange

        //act
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_amqp_create(TEST_URI_VALUE, DPS_HSM_TYPE_TPM, NULL, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_transport_io);
    ...
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_001: [ If uri, scope_id, registration_id, dps_api_version, or transport_io is NULL, dps_transport_common_amqp_create shall return NULL. ] */
    TEST_FUNCTION(dps_transport_common_amqp_create_registration_id_NULL_fail)
    {
        //arrange

        //act
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_amqp_create(TEST_URI_VALUE, DPS_HSM_TYPE_TPM, TEST_SCOPE_ID_VALUE, NULL, TEST_DPS_API_VALUE, on_transport_io);
    ...
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_001: [ If uri, scope_id, registration_id, dps_api_version, or transport_io is NULL, dps_transport_common_amqp_create shall return NULL. ] */
    TEST_FUNCTION(dps_transport_common_amqp_create_api_version_NULL_fail)
    {
        //arrange

        //act
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_amqp_create(TEST_URI_VALUE, DPS_HSM_TYPE_TPM, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, NULL, on_transport_io);
    ...
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_001: [ If uri, scope_id, registration_id, dps_api_version, or transport_io is NULL, dps_transport_common_amqp_create shall return NULL. ] */
    TEST_FUNCTION(dps_transport_common_amqp_create_transport_io_NULL_fail)
    {
        //arrange

        //act
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_amqp_create(TEST_URI_VALUE, DPS_HSM_TYPE_TPM, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, NULL);
    ...
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_003: [ dps_transport_common_amqp_create shall allocate a DPS_TRANSPORT_AMQP_INFO structure ] */
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_004: [ On success dps_transport_common_amqp_create shall allocate a new instance of DPS_TRANSPORT_HANDLE. ] */
    TEST_FUNCTION(dps_transport_common_amqp_create_fail)
    {
        int negativeTestsInitResult = umock_c_negative_tests_init();
        ASSERT_ARE_EQUAL(int, 0, negativeTestsInitResult);

        //arrange
        setup_dps_transport_common_amqp_create_mocks();
        ...
        for (size_t index = 0; index < count; index++)
        {
            ...
            char tmp_msg[64];
            sprintf(tmp_msg, "dps_transport_common_amqp_create failure in test %zu/%zu", index, count);

            //act
            DPS_TRANSPORT_HANDLE handle = dps_transport_common_amqp_create(TEST_URI_VALUE, DPS_HSM_TYPE_TPM, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_transport_io);
    ...
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_002: [ If any error is encountered, dps_transport_common_amqp_create shall return NULL. ] */
    TEST_FUNCTION(dps_transport_common_amqp_create_success)
    {
        //arrange
        setup_dps_transport_common_amqp_create_mocks();
    ...
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_005: [ If handle is NULL, dps_transport_common_amqp_destroy shall do nothing. ] */
    TEST_FUNCTION(dps_transport_common_amqp_destroy_handle_NULL_fail)
    {
        //arrange

        //act
        dps_transport_common_amqp_destroy(NULL);
    ...
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_006: [ dps_transport_common_amqp_destroy shall free all resources used in this module. ] */
    TEST_FUNCTION(dps_transport_common_amqp_destroy_succeed)
    {
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_amqp_create(TEST_URI_VALUE, DPS_HSM_TYPE_TPM, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_transport_io);
        umock_c_reset_all_calls();
    ...
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_007: [ If handle, data_callback, or status_cb is NULL, dps_transport_common_amqp_open shall return a non-zero value. ] */
    TEST_FUNCTION(dps_transport_common_amqp_open_handle_NULL_fail)
    {
        //arrange

        //act
        int result = dps_transport_common_amqp_open(NULL, TEST_BUFFER_VALUE, TEST_BUFFER_VALUE, on_transport_register_data_cb, NULL, on_transport_status_cb, NULL);
    ...
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_007: [ If handle, data_callback, or status_cb is NULL, dps_transport_common_amqp_open shall return a non-zero value. ] */
    TEST_FUNCTION(dps_transport_common_amqp_open_data_callback_NULL_fail)
    {
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_amqp_create(TEST_URI_VALUE, DPS_HSM_TYPE_TPM, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_transport_io);
        umock_c_reset_all_calls();
        ...
        //act
        int result = dps_transport_common_amqp_open(handle, TEST_BUFFER_VALUE, TEST_BUFFER_VALUE, NULL, NULL, on_transport_status_cb, NULL);
    ...
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_007: [ If handle, data_callback, or status_cb is NULL, dps_transport_common_amqp_open shall return a non-zero value. ] */
    TEST_FUNCTION(dps_transport_common_amqp_open_status_callback_NULL_fail)
    {
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_amqp_create(TEST_URI_VALUE, DPS_HSM_TYPE_TPM, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_transport_io);
        umock_c_reset_all_calls();
        ...
        //act
        int result = dps_transport_common_amqp_open(handle, TEST_BUFFER_VALUE, TEST_BUFFER_VALUE, on_transport_register_data_cb, NULL, NULL, NULL);
    ...
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_008: [ If hsm_type is DPS_HSM_TYPE_TPM and ek or srk is NULL, dps_transport_common_amqp_open shall return a non-zero value. ] */
    TEST_FUNCTION(dps_transport_common_amqp_open_ek_NULL_fail)
    {
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_amqp_create(TEST_URI_VALUE, DPS_HSM_TYPE_TPM, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_transport_io);
        umock_c_reset_all_calls();
        ...
        //act
        int result = dps_transport_common_amqp_open(handle, NULL, TEST_BUFFER_VALUE, on_transport_register_data_cb, NULL, on_transport_status_cb, NULL);
    ...
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_008: [ If hsm_type is DPS_HSM_TYPE_TPM and ek or srk is NULL, dps_transport_common_amqp_open shall return a non-zero value. ] */
    TEST_FUNCTION(dps_transport_common_amqp_open_srk_NULL_fail)
    {
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_amqp_create(TEST_URI_VALUE, DPS_HSM_TYPE_TPM, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_transport_io);
        umock_c_reset_all_calls();
        ...
        //act
        int result = dps_transport_common_amqp_open(handle, TEST_BUFFER_VALUE, NULL, on_transport_register_data_cb, NULL, on_transport_status_cb, NULL);
    ...
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_010: [ When complete dps_transport_common_amqp_open shall send a status callback of DPS_TRANSPORT_STATUS_CONNECTED.] */
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_009: [ dps_transport_common_amqp_open shall clone the ek and srk values.] */
    TEST_FUNCTION(dps_transport_common_amqp_open_succeed)
    {
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_amqp_create(TEST_URI_VALUE, DPS_HSM_TYPE_TPM, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_transport_io);
        umock_c_reset_all_calls();
        ...
        STRICT_EXPECTED_CALL(BUFFER_clone(IGNORED_PTR_ARG));
        STRICT_EXPECTED_CALL(on_transport_status_cb(DPS_TRANSPORT_STATUS_CONNECTED, IGNORED_PTR_ARG));

        //act
        int result = dps_transport_common_amqp_open(handle, TEST_BUFFER_VALUE, TEST_BUFFER_VALUE, on_transport_register_data_cb, NULL, on_transport_status_cb, NULL);
        ...
        //cleanup
        dps_transport_common_amqp_close(handle);
        dps_transport_common_amqp_destroy(handle);
    }

    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_041: [ If a failure is encountered, dps_transport_common_amqp_open shall return a non-zero value. ] */
    TEST_FUNCTION(dps_transport_common_amqp_open_fail)
    {
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_amqp_create(TEST_URI_VALUE, DPS_HSM_TYPE_TPM, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_transport_io);
        umock_c_reset_all_calls();
        ...
        for (size_t index = 0; index < count; index++)
        {
            ...
            char tmp_msg[64];
            sprintf(tmp_msg, "dps_transport_common_amqp_open failure in test %zu/%zu", index, count);
    ...
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_010: [ When complete dps_transport_common_amqp_open shall send a status callback of DPS_TRANSPORT_STATUS_CONNECTED.] */
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_009: [ dps_transport_common_amqp_open shall clone the ek and srk values.] */
    TEST_FUNCTION(dps_transport_common_amqp_open_x509_succeed)
    {
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_amqp_create(TEST_URI_VALUE, DPS_HSM_TYPE_X509, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_transport_io);
        umock_c_reset_all_calls();
        ...
        //act
        int result = dps_transport_common_amqp_open(handle, NULL, NULL, on_transport_register_data_cb, NULL, on_transport_status_cb, NULL);
    ...
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_011: [ If handle is NULL, dps_transport_common_amqp_close shall return a non-zero value. ] */
    TEST_FUNCTION(dps_transport_amqp_close_handle_NULL)
    {
        //arrange

        //act
        int result = dps_transport_common_amqp_close(NULL);
    ...
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_012: [ dps_transport_common_amqp_close shall close all links and connection associated with amqp communication. ] */
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_013: [ On success dps_transport_common_amqp_close shall return a zero value. ] */
    TEST_FUNCTION(dps_transport_amqp_close_succeed)
    {
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_amqp_create(TEST_URI_VALUE, DPS_HSM_TYPE_X509, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_transport_io);
        umock_c_reset_all_calls();
        ...
        //act
        int result = dps_transport_common_amqp_close(handle);
    ...
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_014: [ If handle is NULL, dps_transport_common_amqp_register_device shall return a non-zero value. ] */
    TEST_FUNCTION(dps_transport_common_amqp_register_device_handle_NULL_succeed)
    {
        //arrange

        //act
        int result = dps_transport_common_amqp_register_device(NULL, on_transport_challenge_callback, NULL, on_transport_json_parse, NULL);
    ...
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_015: [ If hsm_type is of type DPS_HSM_TYPE_TPM and reg_challenge_cb is NULL, dps_transport_common_amqp_register_device shall return a non-zero value. ] */
    TEST_FUNCTION(dps_transport_common_amqp_register_device_challenge_NULL_succeed)
    {
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_amqp_create(TEST_URI_VALUE, DPS_HSM_TYPE_TPM, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_transport_io);
        umock_c_reset_all_calls();
        ...
        //act
        int result = dps_transport_common_amqp_register_device(handle, NULL, NULL, on_transport_json_parse, NULL);
    ...
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_015: [ If hsm_type is of type DPS_HSM_TYPE_TPM and reg_challenge_cb is NULL, dps_transport_common_amqp_register_device shall return a non-zero value. ] */
    TEST_FUNCTION(dps_transport_common_amqp_register_device_x509_challenge_NULL_succeed)
    {
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_amqp_create(TEST_URI_VALUE, DPS_HSM_TYPE_X509, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_transport_io);
        umock_c_reset_all_calls();
    ...
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_017: [ On success dps_transport_common_amqp_register_device shall return a zero value. ] */
    TEST_FUNCTION(dps_transport_common_amqp_register_device_succeed)
    {
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_amqp_create(TEST_URI_VALUE, DPS_HSM_TYPE_X509, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_transport_io);
        umock_c_reset_all_calls();
        ...
        //act
        int result = dps_transport_common_amqp_register_device(handle, on_transport_challenge_callback, NULL, on_transport_json_parse, NULL);
    ...
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_061: [ If the transport_state is TRANSPORT_CLIENT_STATE_REG_SEND or the the operation_id is NULL, dps_transport_common_amqp_register_device shall return a non-zero value. ] */
    TEST_FUNCTION(dps_transport_common_amqp_register_device_twice_fail)
    {
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_amqp_create(TEST_URI_VALUE, DPS_HSM_TYPE_X509, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_transport_io);
        (void)dps_transport_common_amqp_register_device(handle, on_transport_challenge_callback, NULL, on_transport_json_parse, NULL);
        umock_c_reset_all_calls();
    ...
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_018: [ If handle is NULL, dps_transport_common_amqp_get_operation_status shall return a non-zero value. ] */
    TEST_FUNCTION(dps_transport_common_amqp_get_operation_status_handle_NULL_succeed)
    {
        //arrange

        //act
        int result = dps_transport_common_amqp_get_operation_status(NULL);
    ...
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_019: [ If the operation_id is NULL, dps_transport_common_amqp_get_operation_status shall return a non-zero value. ] */
    TEST_FUNCTION(dps_transport_common_amqp_get_operation_status_operation_id_zero_fail)
    {
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_amqp_create(TEST_URI_VALUE, DPS_HSM_TYPE_X509, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_transport_io);
        umock_c_reset_all_calls();
        ...
        //act
        int result = dps_transport_common_amqp_get_operation_status(handle);
    ...
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_021: [ dps_transport_common_amqp_get_operation_status shall set the transport_state to TRANSPORT_CLIENT_STATE_STATUS_SEND. ] */
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_022: [ On success dps_transport_common_amqp_get_operation_status shall return a zero value. ] */
    TEST_FUNCTION(dps_transport_common_amqp_get_operation_status_success)
    {
        int result;
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_amqp_create(TEST_URI_VALUE, DPS_HSM_TYPE_TPM, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_transport_io);
        (void)dps_transport_common_amqp_open(handle, TEST_BUFFER_VALUE, TEST_BUFFER_VALUE, on_transport_register_data_cb, NULL, on_transport_status_cb, NULL);
        (void)dps_transport_common_amqp_register_device(handle, on_transport_challenge_callback, NULL, on_transport_json_parse, NULL);
        ...
        g_target_transport_status = DPS_TRANSPORT_STATUS_ASSIGNING;
        dps_transport_common_amqp_dowork(handle);
        umock_c_reset_all_calls();
        ...
        //act
        result = dps_transport_common_amqp_get_operation_status(handle);
    ...
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_042: [ If user_ctx is NULL, on_sasl_tpm_challenge_cb shall return NULL. ] */
    TEST_FUNCTION(dps_transport_common_amqp_challenge_cb_user_ctx_NULL_fail)
    {
        char* result;
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_amqp_create(TEST_URI_VALUE, DPS_HSM_TYPE_TPM, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_transport_io);
        (void)dps_transport_common_amqp_open(handle, TEST_BUFFER_VALUE, TEST_BUFFER_VALUE, on_transport_register_data_cb, NULL, on_transport_status_cb, NULL);
    ...
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_043: [ If the challenge_cb function is NULL, on_sasl_tpm_challenge_cb shall return NULL. ] */
    TEST_FUNCTION(dps_transport_common_amqp_challenge_cb_NULL_fail)
    {
        char* result;
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_amqp_create(TEST_URI_VALUE, DPS_HSM_TYPE_TPM, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_transport_io);
        (void)dps_transport_common_amqp_open(handle, TEST_BUFFER_VALUE, TEST_BUFFER_VALUE, on_transport_register_data_cb, NULL, on_transport_status_cb, NULL);
    ...
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_045: [ on_sasl_tpm_challenge_cb shall call the challenge_cb returning the resulting value. ] */
    TEST_FUNCTION(dps_transport_common_amqp_challenge_cb_succeed)
    {
        char* result;
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_amqp_create(TEST_URI_VALUE, DPS_HSM_TYPE_TPM, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_transport_io);
        (void)dps_transport_common_amqp_open(handle, TEST_BUFFER_VALUE, TEST_BUFFER_VALUE, on_transport_register_data_cb, NULL, on_transport_status_cb, NULL);
    ...
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_044: [ If any failure is encountered on_sasl_tpm_challenge_cb shall return NULL. ] */
    TEST_FUNCTION(dps_transport_common_amqp_challenge_cb_fail)
    {
        char* result;
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_amqp_create(TEST_URI_VALUE, DPS_HSM_TYPE_TPM, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_transport_io);
        (void)dps_transport_common_amqp_open(handle, TEST_BUFFER_VALUE, TEST_BUFFER_VALUE, on_transport_register_data_cb, NULL, on_transport_status_cb, NULL);
    ...
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_046: [ If handle is NULL, dps_transport_common_amqp_dowork shall do nothing. ] */
    TEST_FUNCTION(dps_transport_common_amqp_dowork_handle_NULL_fail)
    {
        //arrange

        //act
        dps_transport_common_amqp_dowork(NULL);
    ...
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_047: [ If the amqp_state is AMQP_STATE_DISCONNECTED dps_transport_common_amqp_dowork shall attempt to connect the amqp connections and links. ] */
    TEST_FUNCTION(dps_transport_common_amqp_dowork_connected_succeed)
    {
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_amqp_create(TEST_URI_VALUE, DPS_HSM_TYPE_TPM, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_transport_io);
        (void)dps_transport_common_amqp_open(handle, TEST_BUFFER_VALUE, TEST_BUFFER_VALUE, on_transport_register_data_cb, NULL, on_transport_status_cb, NULL);
        umock_c_reset_all_calls();
    ...
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_047: [ If the amqp_state is AMQP_STATE_DISCONNECTED dps_transport_common_amqp_dowork shall attempt to connect the amqp connections and links. ] */
    TEST_FUNCTION(dps_transport_common_amqp_dowork_x509_connected_succeed)
    {
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_amqp_create(TEST_URI_VALUE, DPS_HSM_TYPE_X509, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_transport_io);
        (void)dps_transport_common_amqp_x509_cert(handle, TEST_X509_CERT_VALUE, TEST_PRIVATE_KEY_VALUE);
        (void)dps_transport_common_amqp_open(handle, TEST_BUFFER_VALUE, TEST_BUFFER_VALUE, on_transport_register_data_cb, NULL, on_transport_status_cb, NULL);
        umock_c_reset_all_calls();
        g_use_x509 = true;
    ...
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_051: [ Once connected dps_transport_common_amqp_dowork shall call uamqp connection dowork function ] */
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_052: [ Once the uamqp reciever and sender link are connected the amqp_state shall be set to AMQP_STATE_CONNECTED ] */
    TEST_FUNCTION(dps_transport_common_amqp_dowork_idle_succeed)
    {
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_amqp_create(TEST_URI_VALUE, DPS_HSM_TYPE_TPM, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_transport_io);
        (void)dps_transport_common_amqp_open(handle, TEST_BUFFER_VALUE, TEST_BUFFER_VALUE, on_transport_register_data_cb, NULL, on_transport_status_cb, NULL);
        dps_transport_common_amqp_dowork(handle);
    ...
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_050: [ The reciever and sender endpoints addresses shall be constructed in the following manner: amqps://[hostname]/[scope_id]/registrations/[registration_id] ] */
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_053: [ When then transport_state is set to TRANSPORT_CLIENT_STATE_REG_SEND, dps_transport_common_amqp_dowork shall send a AMQP_REGISTER_ME message ] */
    TEST_FUNCTION(dps_transport_common_amqp_dowork_register_succeed)
    {
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_amqp_create(TEST_URI_VALUE, DPS_HSM_TYPE_TPM, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_transport_io);
        (void)dps_transport_common_amqp_open(handle, TEST_BUFFER_VALUE, TEST_BUFFER_VALUE, on_transport_register_data_cb, NULL, on_transport_status_cb, NULL);
        (void)dps_transport_common_amqp_register_device(handle, on_transport_challenge_callback, NULL, on_transport_json_parse, NULL);
    ...
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_050: [ The reciever and sender endpoints addresses shall be constructed in the following manner: amqps://[hostname]/[scope_id]/registrations/[registration_id] ] */
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_053: [ When then transport_state is set to TRANSPORT_CLIENT_STATE_REG_SEND, dps_transport_common_amqp_dowork shall send a AMQP_REGISTER_ME message ] */
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_054: [ Upon successful sending of a TRANSPORT_CLIENT_STATE_REG_SEND message, dps_transport_common_amqp_dowork shall set the transport_state to TRANSPORT_CLIENT_STATE_REG_SENT ] */
    TEST_FUNCTION(dps_transport_common_amqp_dowork_register_recv_succeed)
    {
        AMQP_VALUE result;
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_amqp_create(TEST_URI_VALUE, DPS_HSM_TYPE_TPM, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_transport_io);
        (void)dps_transport_common_amqp_open(handle, TEST_BUFFER_VALUE, TEST_BUFFER_VALUE, on_transport_register_data_cb, NULL, on_transport_status_cb, NULL);
    ...
    TEST_FUNCTION(dps_transport_common_amqp_dowork_register_recv_assigned_succeed)
    {
        AMQP_VALUE result;
        ...
        g_msg_sndr_state_changed(g_msg_sndr_state_changed_ctx, MESSAGE_SENDER_STATE_OPEN, MESSAGE_SENDER_STATE_OPENING);
        g_msg_rcvr_state_changed(g_msg_rcvr_state_changed_ctx, MESSAGE_RECEIVER_STATE_OPEN, MESSAGE_RECEIVER_STATE_OPENING);
        g_target_transport_status = DPS_TRANSPORT_STATUS_ASSIGNED;
        dps_transport_common_amqp_dowork(handle);
        umock_c_reset_all_calls();
    ...
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_055: [ When then transport_state is set to TRANSPORT_CLIENT_STATE_STATUS_SEND, dps_transport_common_amqp_dowork shall send a AMQP_OPERATION_STATUS message ] */
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_056: [ Upon successful sending of a AMQP_OPERATION_STATUS message, dps_transport_common_amqp_dowork shall set the transport_state to TRANSPORT_CLIENT_STATE_STATUS_SENT ] */
    TEST_FUNCTION(dps_transport_common_amqp_dowork_send_status_succeed)
    {
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_amqp_create(TEST_URI_VALUE, DPS_HSM_TYPE_TPM, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_transport_io);
        (void)dps_transport_common_amqp_open(handle, TEST_BUFFER_VALUE, TEST_BUFFER_VALUE, on_transport_register_data_cb, NULL, on_transport_status_cb, NULL);
        (void)dps_transport_common_amqp_register_device(handle, on_transport_challenge_callback, NULL, on_transport_json_parse, NULL);
        ...
        g_target_transport_status = DPS_TRANSPORT_STATUS_ASSIGNING;
        dps_transport_common_amqp_dowork(handle);
        (void)dps_transport_common_amqp_get_operation_status(handle);
        umock_c_reset_all_calls();
    ...
    TEST_FUNCTION(dps_transport_common_amqp_dowork_device_assigned_succeed)
    {
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_amqp_create(TEST_URI_VALUE, DPS_HSM_TYPE_TPM, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_transport_io);
        (void)dps_transport_common_amqp_open(handle, TEST_BUFFER_VALUE, TEST_BUFFER_VALUE, on_transport_register_data_cb, NULL, on_transport_status_cb, NULL);
        (void)dps_transport_common_amqp_register_device(handle, on_transport_challenge_callback, NULL, on_transport_json_parse, NULL);
        ...
        STRICT_EXPECTED_CALL(on_transport_register_data_cb(DPS_TRANSPORT_RESULT_OK, IGNORED_PTR_ARG, IGNORED_PTR_ARG, IGNORED_PTR_ARG, IGNORED_PTR_ARG));
        STRICT_EXPECTED_CALL(BUFFER_delete(IGNORED_PTR_ARG));
        STRICT_EXPECTED_CALL(gballoc_free(IGNORED_PTR_ARG));
        STRICT_EXPECTED_CALL(gballoc_free(IGNORED_PTR_ARG));
        STRICT_EXPECTED_CALL(gballoc_free(IGNORED_PTR_ARG));
    ...
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_049: [ If any error is encountered dps_transport_common_amqp_dowork shall set the amqp_state to AMQP_STATE_ERROR and the transport_state to TRANSPORT_CLIENT_STATE_ERROR. ] */
    TEST_FUNCTION(dps_transport_common_amqp_dowork_register_fail)
    {
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_amqp_create(TEST_URI_VALUE, DPS_HSM_TYPE_TPM, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_transport_io);
        (void)dps_transport_common_amqp_open(handle, TEST_BUFFER_VALUE, TEST_BUFFER_VALUE, on_transport_register_data_cb, NULL, on_transport_status_cb, NULL);
        (void)dps_transport_common_amqp_register_device(handle, on_transport_challenge_callback, NULL, on_transport_json_parse, NULL);
        ...
        for (size_t index = 0; index < count; index++)
        {
            ...
            char tmp_msg[64];
            sprintf(tmp_msg, "dps_transport_common_amqp_dowork failure in test %zu/%zu", index, count);
    ...
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_049: [ If any error is encountered dps_transport_common_amqp_dowork shall set the amqp_state to AMQP_STATE_ERROR and the transport_state to TRANSPORT_CLIENT_STATE_ERROR. ] */
    TEST_FUNCTION(dps_transport_common_amqp_dowork_disconnected_fail)
    {
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_amqp_create(TEST_URI_VALUE, DPS_HSM_TYPE_TPM, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_transport_io);
        umock_c_reset_all_calls();
        ...
        for (size_t index = 0; index < count; index++)
        {
            ...
            //assert
            (void)dps_transport_common_amqp_close(handle);
        }
    ...
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_052: [ Once the uamqp reciever and sender link are connected the amqp_state shall be set to AMQP_STATE_CONNECTED ] */
    TEST_FUNCTION(dps_transport_common_amqp_msg_recv_state_change_open_succeed)
    {
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_amqp_create(TEST_URI_VALUE, DPS_HSM_TYPE_TPM, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_transport_io);
        (void)dps_transport_common_amqp_open(handle, TEST_BUFFER_VALUE, TEST_BUFFER_VALUE, on_transport_register_data_cb, NULL, on_transport_status_cb, NULL);
        dps_transport_common_amqp_dowork(handle);
    ...
    TEST_FUNCTION(dps_transport_common_amqp_msg_recv_state_change_error_succeed)
    {
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_amqp_create(TEST_URI_VALUE, DPS_HSM_TYPE_TPM, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_transport_io);
        (void)dps_transport_common_amqp_open(handle, TEST_BUFFER_VALUE, TEST_BUFFER_VALUE, on_transport_register_data_cb, NULL, on_transport_status_cb, NULL);
        dps_transport_common_amqp_dowork(handle);
        ...
        //arrange
        STRICT_EXPECTED_CALL(connection_dowork(IGNORED_PTR_ARG));
        STRICT_EXPECTED_CALL(on_transport_register_data_cb(DPS_TRANSPORT_RESULT_ERROR, NULL, NULL, NULL, NULL));
    ...
    TEST_FUNCTION(dps_transport_common_amqp_msg_recv_state_change_user_ctx_NULL_fail)
    {
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_amqp_create(TEST_URI_VALUE, DPS_HSM_TYPE_TPM, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_transport_io);
        (void)dps_transport_common_amqp_open(handle, TEST_BUFFER_VALUE, TEST_BUFFER_VALUE, on_transport_register_data_cb, NULL, on_transport_status_cb, NULL);
        dps_transport_common_amqp_dowork(handle);
    ...
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_052: [ Once the uamqp reciever and sender link are connected the amqp_state shall be set to AMQP_STATE_CONNECTED ] */
    TEST_FUNCTION(dps_transport_common_amqp_msg_sender_state_change_open_succeed)
    {
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_amqp_create(TEST_URI_VALUE, DPS_HSM_TYPE_TPM, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_transport_io);
        (void)dps_transport_common_amqp_open(handle, TEST_BUFFER_VALUE, TEST_BUFFER_VALUE, on_transport_register_data_cb, NULL, on_transport_status_cb, NULL);
        dps_transport_common_amqp_dowork(handle);
    ...
    TEST_FUNCTION(dps_transport_common_amqp_msg_sender_state_change_error_succeed)
    {
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_amqp_create(TEST_URI_VALUE, DPS_HSM_TYPE_TPM, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_transport_io);
        (void)dps_transport_common_amqp_open(handle, TEST_BUFFER_VALUE, TEST_BUFFER_VALUE, on_transport_register_data_cb, NULL, on_transport_status_cb, NULL);
        dps_transport_common_amqp_dowork(handle);
    ...
    TEST_FUNCTION(dps_transport_common_amqp_msg_sender_state_change_user_ctx_NULL_succeed)
    {
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_amqp_create(TEST_URI_VALUE, DPS_HSM_TYPE_TPM, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_transport_io);
        (void)dps_transport_common_amqp_open(handle, TEST_BUFFER_VALUE, TEST_BUFFER_VALUE, on_transport_register_data_cb, NULL, on_transport_status_cb, NULL);
        dps_transport_common_amqp_dowork(handle);
    ...
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_023: [ If handle is NULL, dps_transport_common_amqp_set_trace shall return a non-zero value. ] */
    TEST_FUNCTION(dps_transport_common_amqp_set_trace_handle_NULL_fail)
    {
        //arrange

        //act
        int result = dps_transport_common_amqp_set_trace(NULL, true);
    ...
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_024: [ dps_transport_common_amqp_set_trace shall set the log_trace variable to trace_on. ]*/
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_025: [ On success dps_transport_common_amqp_set_trace shall return a zero value. ] */
    TEST_FUNCTION(dps_transport_common_amqp_set_trace_succeed)
    {
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_amqp_create(TEST_URI_VALUE, DPS_HSM_TYPE_TPM, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_transport_io);
        umock_c_reset_all_calls();
        ...
        //act
        int result = dps_transport_common_amqp_set_trace(handle, true);
    ...
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_026: [ If handle or certificate is NULL, dps_transport_common_amqp_x509_cert shall return a non-zero value. ] */
    TEST_FUNCTION(dps_transport_common_amqp_x509_cert_handle_NULL_fail)
    {
        //arrange

        //act
        int result = dps_transport_common_amqp_x509_cert(NULL, TEST_X509_CERT_VALUE, TEST_PRIVATE_KEY_VALUE);
    ...
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_027: [ dps_transport_common_amqp_x509_cert shall copy the certificate and private_key values. ] */
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_029: [ On success dps_transport_common_amqp_x509_cert shall return a zero value. ] */
    TEST_FUNCTION(dps_transport_common_amqp_x509_cert_succeed)
    {
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_amqp_create(TEST_URI_VALUE, DPS_HSM_TYPE_TPM, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_transport_io);
        umock_c_reset_all_calls();
        ...
        //act
        int result = dps_transport_common_amqp_x509_cert(handle, TEST_X509_CERT_VALUE, TEST_PRIVATE_KEY_VALUE);
    ...
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_028: [ On any failure dps_transport_common_amqp_x509_cert, shall return a non-zero value. ] */
    TEST_FUNCTION(dps_transport_common_amqp_x509_cert_fail)
    {
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_amqp_create(TEST_URI_VALUE, DPS_HSM_TYPE_TPM, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_transport_io);
        umock_c_reset_all_calls();
    ...
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_030: [ If handle or certificate is NULL, dps_transport_common_amqp_set_trusted_cert shall return a non-zero value. ] */
    TEST_FUNCTION(dps_transport_common_amqp_set_trusted_cert_handle_NULL)
    {
        //arrange

        //act
        int result = dps_transport_common_amqp_set_trusted_cert(NULL, TEST_CERT_VALUE);
    ...
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_030: [ If handle or certificate is NULL, dps_transport_common_amqp_set_trusted_cert shall return a non-zero value. ] */
    TEST_FUNCTION(dps_transport_common_amqp_set_trusted_cert_cert_NULL_fail)
    {
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_amqp_create(TEST_URI_VALUE, DPS_HSM_TYPE_TPM, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_transport_io);
        umock_c_reset_all_calls();
        ...
        //act
        int result = dps_transport_common_amqp_set_trusted_cert(handle, NULL);
    ...
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_031: [ dps_transport_common_amqp_set_trusted_cert shall copy the certificate value. ] */
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_033: [ On success dps_transport_common_amqp_set_trusted_cert shall return a zero value. ] */
    TEST_FUNCTION(dps_transport_common_amqp_set_trusted_cert_succeed)
    {
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_amqp_create(TEST_URI_VALUE, DPS_HSM_TYPE_TPM, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_transport_io);
        umock_c_reset_all_calls();
        ...
        //act
        int result = dps_transport_common_amqp_set_trusted_cert(handle, TEST_CERT_VALUE);
    ...
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_032: [ On any failure dps_transport_common_amqp_set_trusted_cert, shall return a non-zero value. ] */
    TEST_FUNCTION(dps_transport_common_amqp_set_trusted_cert_fail)
    {
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_amqp_create(TEST_URI_VALUE, DPS_HSM_TYPE_TPM, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_transport_io);
        umock_c_reset_all_calls();
    ...
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_034: [ If handle or proxy_options is NULL, dps_transport_common_amqp_set_proxy shall return a non-zero value. ]*/
    TEST_FUNCTION(dps_transport_common_amqp_set_proxy_handle_NULL_fail)
    {
        //arrange
        ...
        //act
        int result = dps_transport_common_amqp_set_proxy(NULL, &proxy_options);
    ...
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_034: [ If handle or proxy_options is NULL, dps_transport_common_amqp_set_proxy shall return a non-zero value. ]*/
    TEST_FUNCTION(dps_transport_common_amqp_set_proxy_proxy_NULL_fail)
    {
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_amqp_create(TEST_URI_VALUE, DPS_HSM_TYPE_TPM, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_transport_io);
        umock_c_reset_all_calls();
        ...
        //act
        int result = dps_transport_common_amqp_set_proxy(handle, NULL);
    ...
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_036: [ If HTTP_PROXY_OPTIONS password is not NULL and password is NULL, dps_transport_common_amqp_set_proxy shall return a non-zero value. ] */
    TEST_FUNCTION(dps_transport_common_amqp_set_proxy_no_username_fail)
    {
        HTTP_PROXY_OPTIONS proxy_options = { 0 };
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_amqp_create(TEST_URI_VALUE, DPS_HSM_TYPE_TPM, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_transport_io);
        umock_c_reset_all_calls();
        ...
        //act
        int result = dps_transport_common_amqp_set_proxy(handle, &proxy_options);
    ...
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_038: [ dps_transport_common_amqp_set_proxy shall copy the host_addess, username, or password variables ] */
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_040: [ On success dps_transport_common_amqp_set_proxy shall return a zero value. ] */
    TEST_FUNCTION(dps_transport_common_amqp_set_proxy_2_succeed)
    {
        HTTP_PROXY_OPTIONS proxy_options = { 0 };
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_amqp_create(TEST_URI_VALUE, DPS_HSM_TYPE_TPM, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_transport_io);
        umock_c_reset_all_calls();
    ...
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_035: [ If HTTP_PROXY_OPTIONS host_address is NULL, dps_transport_common_amqp_set_proxy shall return a non-zero value. ] */
    TEST_FUNCTION(dps_transport_common_amqp_set_proxy_hostname_NULL_fail)
    {
        HTTP_PROXY_OPTIONS proxy_options = { 0 };
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_amqp_create(TEST_URI_VALUE, DPS_HSM_TYPE_TPM, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_transport_io);
        umock_c_reset_all_calls();
    ...
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_039: [ On any failure dps_transport_common_amqp_set_proxy, shall return a non-zero value. ] */
    TEST_FUNCTION(dps_transport_common_amqp_set_proxy_fail)
    {
        HTTP_PROXY_OPTIONS proxy_options = { 0 };
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_amqp_create(TEST_URI_VALUE, DPS_HSM_TYPE_TPM, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_transport_io);
        umock_c_reset_all_calls();
        ...
        for (size_t index = 0; index < count; index++)
        {
            ...
            char tmp_msg[64];
            sprintf(tmp_msg, "dps_transport_common_amqp_set_proxy failure in test %zu/%zu", index, count);
    ...
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_038: [ dps_transport_common_amqp_set_proxy shall copy the host_addess, username, or password variables ] */
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_040: [ On success dps_transport_common_amqp_set_proxy shall return a zero value. ] */
    TEST_FUNCTION(dps_transport_common_amqp_set_proxy_succeed)
    {
        HTTP_PROXY_OPTIONS proxy_options = { 0 };
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_amqp_create(TEST_URI_VALUE, DPS_HSM_TYPE_TPM, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_transport_io);
        umock_c_reset_all_calls();
    ...
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_038: [ dps_transport_common_amqp_set_proxy shall copy the host_addess, username, or password variables ] */
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_040: [ On success dps_transport_common_amqp_set_proxy shall return a zero value. ] */
    /* Tests_DPS_TRANSPORT_AMQP_COMMON_07_037: [ If any of the host_addess, username, or password variables are non-NULL, dps_transport_common_amqp_set_proxy shall free the memory. ] */
    TEST_FUNCTION(dps_transport_common_amqp_set_proxy_twice_succeed)
    {
        HTTP_PROXY_OPTIONS proxy_options = { 0 };
        DPS_TRANSPORT_HANDLE handle = dps_transport_common_amqp_create(TEST_URI_VALUE, DPS_HSM_TYPE_TPM, TEST_SCOPE_ID_VALUE, TEST_REGISTRATION_ID_VALUE, TEST_DPS_API_VALUE, on_transport_io);
        ...
        proxy_options.username = TEST_USERNAME_VALUE;
        proxy_options.password = TEST_PASSWORD_VALUE;
        (void)dps_transport_common_amqp_set_proxy(handle, &proxy_options);
        umock_c_reset_all_calls();
    ...
    END_TEST_SUITE(dps_transport_amqp_common_ut)
