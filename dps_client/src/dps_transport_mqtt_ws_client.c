...
#define DPS_MQTT_WS_PORT_NUM               443
#define DPS_MQTT_WS_PROTOCOL_NAME "MQTT"
#define DPS_MQTT_WS_RELATIVE_PATH "/$iothub/websocket"
...
static XIO_HANDLE mqtt_transport_ws_io(const char* fqdn, const HTTP_PROXY_OPTIONS* proxy_info)
{
    ...
    {
        /* Codes_DPS_TRANSPORT_MQTT_WS_CLIENT_07_013: [ If any failure is encountered amqp_transport_ws_io shall return NULL ] */
    ...
    else
    {
        ...
        ws_io_config.port = DPS_MQTT_WS_PORT_NUM;
        ws_io_config.protocol = DPS_MQTT_WS_PROTOCOL_NAME;
        ws_io_config.resource_name = DPS_MQTT_WS_RELATIVE_PATH;
        ...
        tls_io_config.port = DPS_MQTT_WS_PORT_NUM;
        if (proxy_info != NULL)
        {
            ...
            proxy_config.port = DPS_MQTT_WS_PORT_NUM;
    ...
    /* Codes_DPS_TRANSPORT_MQTT_WS_CLIENT_07_014: [ On success mqtt_transport_ws_io shall return an allocated XIO_HANDLE. ] */
    return result;
}
...
{
    /* Codes_DPS_TRANSPORT_MQTT_WS_CLIENT_07_001: [ dps_transport_mqtt_ws_create shall call the dps_trans_common_mqtt_create function with mqtt_transport_ws_io transport IO estabishment. ] */
    return dps_transport_common_mqtt_create(uri, type, scope_id, registration_id, dps_api_version, mqtt_transport_ws_io);
}

void dps_transport_mqtt_ws_destroy(DPS_TRANSPORT_HANDLE handle)
{
    /* Codes_DPS_TRANSPORT_MQTT_WS_CLIENT_07_002: [ dps_transport_mqtt_ws_destroy shall invoke the dps_transport_common_mqtt_destroy method ] */
...
{
    /* Codes_DPS_TRANSPORT_MQTT_WS_CLIENT_07_003: [ dps_transport_mqtt_ws_open shall invoke the dps_transport_common_mqtt_open method ] */
...
{
    /* Codes_DPS_TRANSPORT_MQTT_WS_CLIENT_07_004: [ dps_transport_mqtt_ws_close shall invoke the dps_transport_common_mqtt_close method ] */
    return dps_transport_common_mqtt_close(handle);
}

int dps_transport_mqtt_ws_register_device(DPS_TRANSPORT_HANDLE handle, DPS_TRANSPORT_CHALLENGE_CALLBACK reg_challenge_cb, void* user_ctx, DPS_TRANSPORT_JSON_PARSE json_parse_cb, void* json_ctx)
{
    /* Codes_DPS_TRANSPORT_MQTT_WS_CLIENT_07_005: [ dps_transport_mqtt_ws_register_device shall invoke the dps_transport_common_mqtt_register_device method ] */
...
{
    /* Codes_DPS_TRANSPORT_MQTT_WS_CLIENT_07_006: [ dps_transport_mqtt_ws_get_operation_status shall invoke the dps_transport_common_mqtt_get_operation_status method ] */
...
{
    /* Codes_DPS_TRANSPORT_MQTT_WS_CLIENT_07_007: [ dps_transport_mqtt_ws_dowork shall invoke the dps_transport_common_mqtt_dowork method ] */
    dps_transport_common_mqtt_dowork(handle);
}

int dps_transport_mqtt_ws_set_trace(DPS_TRANSPORT_HANDLE handle, bool trace_on)
{
    /* Codes_DPS_TRANSPORT_MQTT_WS_CLIENT_07_008: [ dps_transport_mqtt_ws_set_trace shall invoke the dps_transport_common_mqtt_set_trace method ] */
...
{
    /* Codes_DPS_TRANSPORT_MQTT_WS_CLIENT_07_009: [ dps_transport_mqtt_ws_x509_cert shall invoke the dps_trans_common_mqtt_x509_cert method ] */
...
{
    /* Codes_DPS_TRANSPORT_MQTT_WS_CLIENT_07_010: [ dps_transport_mqtt_ws_set_trusted_cert shall invoke the dps_transport_common_mqtt_set_trusted_cert method ] */
...
{
    /* Codes_DPS_TRANSPORT_MQTT_WS_CLIENT_07_011: [ dps_transport_mqtt_ws_set_proxy shall invoke the dps_transport_common_mqtt_set_proxy method ] */
