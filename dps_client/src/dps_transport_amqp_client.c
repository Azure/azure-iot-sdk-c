...
static DPS_TRANSPORT_IO_INFO* amqp_transport_io(const char* fqdn, SASL_MECHANISM_HANDLE* sasl_mechanism, const HTTP_PROXY_OPTIONS* proxy_info)
{
    ...
    tls_io_config.port = DPS_AMQP_PORT_NUM;
    if (proxy_info != NULL)
    {
        /* Codes_DPS_TRANSPORT_AMQP_CLIENT_07_012: [ If proxy_info is not NULL, amqp_transport_io shall construct a HTTP_PROXY_IO_CONFIG object and assign it to TLSIO_CONFIG underlying_io_parameters ] */
        proxy_config.hostname = tls_io_config.hostname;
        proxy_config.port = DPS_AMQP_PORT_NUM;
    ...
    {
        /* Codes_DPS_TRANSPORT_AMQP_CLIENT_07_013: [ If any failure is encountered amqp_transport_io shall return NULL ] */
        LogError("platform_get_default_tlsio return NULL IO Interface");
        result = NULL;
    }
    /* Codes_DPS_TRANSPORT_AMQP_CLIENT_07_014: [ On success amqp_transport_io shall return an allocated DPS_TRANSPORT_IO_INFO structure. ] */
    else if ((result = (DPS_TRANSPORT_IO_INFO*)malloc(sizeof(DPS_TRANSPORT_IO_INFO))) == NULL)
    {
        /* Codes_DPS_TRANSPORT_AMQP_CLIENT_07_013: [ If any failure is encountered amqp_transport_io shall return NULL ] */
    ...
    else
    {
        ...
        /* Codes_DPS_TRANSPORT_AMQP_CLIENT_07_015: [ amqp_transport_io shall allocate a DPS_TRANSPORT_IO_INFO transfer_handle by calling xio_create with the tlsio_interface. ] */
        ...
        else
        {
            ...
            if (sasl_mechanism != NULL)
            {
                ...
                {
                    /* Codes_DPS_TRANSPORT_AMQP_CLIENT_07_016: [ amqp_transport_io shall allocate a DPS_TRANSPORT_IO_INFO sasl_handle by calling xio_create with the saslio_interface. ] */
...
{
    /* Codes_DPS_TRANSPORT_AMQP_CLIENT_07_001: [ dps_transport_amqp_create shall call the dps_transport_common_amqp_create function with amqp_transport_io transport IO estabishment. ] */
    return dps_transport_common_amqp_create(uri, type, scope_id, registration_id, dps_api_version, amqp_transport_io);
}

void dps_transport_amqp_destroy(DPS_TRANSPORT_HANDLE handle)
{
    /* Codes_DPS_TRANSPORT_AMQP_CLIENT_07_002: [ dps_transport_amqp_destroy shall invoke the dps_transport_common_amqp_destroy method ] */
...
{
    /* Codes_DPS_TRANSPORT_AMQP_CLIENT_07_003: [ dps_transport_amqp_open shall invoke the dps_transport_common_amqp_open method ] */
...
{
    /* Codes_DPS_TRANSPORT_AMQP_CLIENT_07_004: [ dps_transport_amqp_close shall invoke the dps_transport_common_amqp_close method ] */
    return dps_transport_common_amqp_close(handle);
}

int dps_transport_amqp_register_device(DPS_TRANSPORT_HANDLE handle, DPS_TRANSPORT_CHALLENGE_CALLBACK reg_challenge_cb, void* user_ctx, DPS_TRANSPORT_JSON_PARSE json_parse_cb, void* json_ctx)
{
    /* Codes_DPS_TRANSPORT_AMQP_CLIENT_07_005: [ dps_transport_amqp_register_device shall invoke the dps_transport_common_amqp_register_device method ] */
...
{
    /* Codes_DPS_TRANSPORT_AMQP_CLIENT_07_006: [ dps_transport_amqp_get_operation_status shall invoke the dps_transport_common_amqp_get_operation_status method ] */
    return dps_transport_common_amqp_get_operation_status(handle);
}

void dps_transport_amqp_dowork(DPS_TRANSPORT_HANDLE handle)
{
    /* Codes_DPS_TRANSPORT_AMQP_CLIENT_07_007: [ dps_transport_amqp_dowork shall invoke the dps_transport_common_amqp_dowork method ] */
    dps_transport_common_amqp_dowork(handle);
}

int dps_transport_amqp_set_trace(DPS_TRANSPORT_HANDLE handle, bool trace_on)
{
    /* Codes_DPS_TRANSPORT_AMQP_CLIENT_07_008: [ dps_transport_amqp_set_trace shall invoke the dps_transport_common_amqp_set_trace method ] */
...
{
    /* Codes_DPS_TRANSPORT_AMQP_CLIENT_07_009: [ dps_transport_amqp_x509_cert shall invoke the dps_transport_common_amqp_x509_cert method ] */
...
{
    /* Codes_DPS_TRANSPORT_AMQP_CLIENT_07_010: [ dps_transport_amqp_set_trusted_cert shall invoke the dps_transport_common_amqp_set_trusted_cert method ] */
...
{
    /* Codes_DPS_TRANSPORT_AMQP_CLIENT_07_011: [ dps_transport_amqp_set_proxy shall invoke the dps_transport_common_amqp_set_proxy method ] */
