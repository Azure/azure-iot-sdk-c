...
then
   ...
   cd $build_root/build_all/arduino
   printf 'y\ny\n' | ./setup.sh
else
...
# -----------------------------------------------------------------------------
# -- Modify serializer/samples/simplesample_http/simplesample_http.c
# -----------------------------------------------------------------------------
echo ---------- Modifying serializer/samples/simplesample_http/simplesample_http.c file ----------
cd $build_root
sed -i 's/\[device connection string\]/'$IOTHUB_DEVICE_CONN_STR'/g' serializer/samples/simplesample_http/simplesample_http.c
