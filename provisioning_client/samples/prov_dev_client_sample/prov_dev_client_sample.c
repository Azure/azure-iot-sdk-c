...
static void prov_registation_status(PROV_DEVICE_REG_STATUS reg_status, void* user_context)
{
...
int main()
{
    ...
    else
    {
        ...
        else
        {
            ...
            if (Prov_Device_LL_Register_Device(handle, register_device_callback, &user_ctx, prov_registation_status, &user_ctx) != PROV_DEVICE_RESULT_OK)
            {
