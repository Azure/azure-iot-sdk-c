...
static pfprov_transport_set_option prov_amqp_transport_set_option;
...
BEGIN_TEST_SUITE(prov_transport_amqp_client_ut)
    ...
    TEST_SUITE_INITIALIZE(suite_init)
    {
        ...
        prov_amqp_transport_set_option = Prov_Device_AMQP_Protocol()->prov_transport_set_option;
    }
    ...
    TEST_FUNCTION(prov_transport_amqp_open_succeed)
    {
        ...
        //act
        int result = prov_amqp_transport_open(TEST_DPS_HANDLE, TEST_REGISTRATION_ID_VALUE, TEST_BUFFER_VALUE, TEST_BUFFER_VALUE, on_transport_register_data_cb, NULL, on_transport_status_cb, NULL, on_transport_challenge_callback, NULL);
    ...
    TEST_FUNCTION(prov_transport_amqp_set_option_succeed)
    {
        ...
        //act
        int result = prov_amqp_transport_set_option(TEST_DPS_HANDLE, TEST_XIO_OPTION_NAME, TEST_OPTION_VALUE);
