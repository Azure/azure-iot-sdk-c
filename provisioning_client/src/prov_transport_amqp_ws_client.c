...
static const char* prov_transport_amqp_ws_get_trusted_cert(PROV_DEVICE_TRANSPORT_HANDLE handle)
{
    ...
    return prov_transport_common_amqp_get_trusted_cert(handle);
}
...
static PROV_DEVICE_TRANSPORT_PROVIDER prov_amqp_ws_func =
{
    ...
    prov_transport_amqp_ws_get_trusted_cert
};
