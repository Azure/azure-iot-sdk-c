...
static int prov_transport_amqp_ws_x509_cert_cryptodev(PROV_DEVICE_TRANSPORT_HANDLE handle, const char* certificate, const TLSIO_CRYPTODEV_PKEY* private_key)
{
    /* TODO: Codes_PROV_TRANSPORT_AMQP_WS_CLIENT_07_009: [ prov_transport_amqp_ws_x509_cert shall invoke the prov_transport_common_amqp_x509_cert method ] */
    return prov_transport_common_amqp_x509_cert_cryptodev(handle, certificate, private_key);
}
...
static PROV_DEVICE_TRANSPORT_PROVIDER prov_amqp_ws_func =
{
    ...
    prov_transport_amqp_ws_x509_cert_cryptodev,
