...
static int prov_transport_mqtt_ws_x509_cert_cryptodev(PROV_DEVICE_TRANSPORT_HANDLE handle, const char* certificate, const TLSIO_CRYPTODEV_PKEY* private_key)
{
    /* TODO: Codes_PROV_TRANSPORT_MQTT_WS_CLIENT_07_009: [ prov_transport_mqtt_ws_x509_cert shall invoke the prov_trans_common_mqtt_x509_cert method ] */
...
static PROV_DEVICE_TRANSPORT_PROVIDER prov_mqtt_func =
{
    ...
    prov_transport_mqtt_ws_x509_cert_cryptodev,
