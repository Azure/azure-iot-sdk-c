...
MOCKABLE_FUNCTION(, int, prov_transport_common_amqp_x509_cert_cryptodev, PROV_DEVICE_TRANSPORT_HANDLE, handle, const char*, certificate, const TLSIO_CRYPTODEV_PKEY*, private_key);
