...
typedef enum TRANSPORT_HSM_TYPE_VALUES_TAG
{
    TRANSPORT_HSM_TYPE_TPM = 0,
    TRANSPORT_HSM_TYPE_X509 = 1,
    TRANSPORT_HSM_TYPE_SYMM_KEY = 2
} TRANSPORT_HSM_TYPE_VALUES;

typedef enum PROV_DEVICE_TRANSPORT_RESULT_VALUES_TAG
{
    PROV_DEVICE_TRANSPORT_RESULT_OK = 0,
    PROV_DEVICE_TRANSPORT_RESULT_UNAUTHORIZED = 1,
    PROV_DEVICE_TRANSPORT_RESULT_ERROR = 2
