...
typedef enum REGISTRATION_STATUS_VALUES_TAG
{
    REGISTRATION_STATUS_ERROR = 0,
    REGISTRATION_STATUS_UNASSIGNED = 1,
    REGISTRATION_STATUS_ASSIGNING = 2,
    REGISTRATION_STATUS_ASSIGNED = 3,
    REGISTRATION_STATUS_FAILED = 4,
    REGISTRATION_STATUS_DISABLED = 5
