...
typedef enum PROVISIONING_BULK_OPERATION_MODE_VALUES_TAG
{
    BULK_OP_CREATE = 0,
    BULK_OP_UPDATE = 1,
    BULK_OP_UPDATE_IF_MATCH_ETAG = 2,
    BULK_OP_DELETE = 3
} PROVISIONING_BULK_OPERATION_MODE_VALUES;


typedef enum PROVISIONING_BULK_OPERATION_TYPE_VALUES_TAG
{
    BULK_OP_INDIVIDUAL_ENROLLMENT = 0
