...
static int IoTHubTransportAMQP_Subscribe_CertificateSigningResponse(IOTHUB_DEVICE_HANDLE handle)
{
    (void)handle;
    LogError("AMQP does not support certificate signing request.");
    return MU_FAILURE;
}
