...
static int IoTHubTransportAMQP_WS_Subscribe_CertificateSigningResponse(IOTHUB_DEVICE_HANDLE handle)
{
    (void)handle;
    LogError("AMQP WS does not support certificate signing request.");
    return MU_FAILURE;
}
