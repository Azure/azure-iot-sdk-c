...
static IOTHUB_CLIENT_RESULT IoTHubTransportAMQP_WS_SendMessageDisposition(IOTHUB_DEVICE_HANDLE handle, MESSAGE_CALLBACK_INFO* message_data, IOTHUBMESSAGE_DISPOSITION_RESULT disposition)
{
    ...
    return IoTHubTransport_AMQP_Common_SendMessageDisposition(handle, message_data, disposition);
}
