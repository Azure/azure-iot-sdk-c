...
IOTHUB_CLIENT_RESULT IoTHubDeviceClient_SendTelemetryAsync(
...
IOTHUB_CLIENT_RESULT IoTHubDeviceClient_SendPropertiesAsync(
                            IOTHUB_DEVICE_CLIENT_HANDLE iotHubClientHandle, 
...
IOTHUB_CLIENT_RESULT IoTHubDeviceClient_GetPropertiesAndSubscribeToUpdatesAsync(
    IOTHUB_DEVICE_CLIENT_HANDLE iotHubClientHandle,
