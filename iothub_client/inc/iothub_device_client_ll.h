...
* @param    commandName                 Name of the command associated with this request.
* @param    payload                     Raw payload of the request.  This is NOT guaranteed to be a \0 terminated string.
* @param    size                        Number of bytes of @p payload.
...
* @param    userContextCallback                Optional specified context that will be provided to the callback.
*
* @return   IOTHUB_CLIENT_OK upon success or an error code upon failure.
*/
