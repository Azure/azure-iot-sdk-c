...
#define IOTHUB_PROPERTY_VERSION_1 1

/** @brief    This struct represents a property from the service.  
              It is generated by IoTHub_Deserialize_Properties while deserializing a property payload from the twin and is not filled out by the application. */
typedef struct {
    /** @brief   Version of the structure.  Currently must be IOTHUB_PROPERTY_VERSION_1. */
    int version;
...
/** @brief    This struct represents the response to a writeable property that the device will return.  
              This structure is filled out by the application (typically in its IOTHUB_CLIENT_PROPERTIES_CALLBACK callback) and can
              be serialized into a payload for the network via IoTHub_Serialize_ResponseProperties. */
typedef struct {
