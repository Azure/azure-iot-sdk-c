...
typedef enum IOTHUB_MESSAGE_RESULT_VALUES_TAG
{
    IOTHUB_MESSAGE_OK = 0,
    IOTHUB_MESSAGE_INVALID_ARG = 1,
    IOTHUB_MESSAGE_INVALID_TYPE = 2,
    IOTHUB_MESSAGE_ERROR = 3
} IOTHUB_MESSAGE_RESULT_VALUES;


typedef enum IOTHUBMESSAGE_CONTENT_TYPE_VALUES_TAG
{
    IOTHUBMESSAGE_BYTEARRAY = 0,
    IOTHUBMESSAGE_STRING = 1,
    IOTHUBMESSAGE_UNKNOWN = 2
