...
#include <stddef.h>
    ...
    MOCKABLE_FUNCTION(, IOTHUB_CLIENT_LL_UPLOADTOBLOB_HANDLE, IoTHubClient_LL_UploadToBlob_Create, const char*, hostname, IOTHUB_AUTHORIZATION_HANDLE, auth_handle);
