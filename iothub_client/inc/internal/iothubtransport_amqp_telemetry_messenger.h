...
#define TELEMETRY_MESSENGER_OPTION_EVENT_SEND_TIMEOUT_SECS "telemetry_event_send_timeout_secs"
#define TELEMETRY_MESSENGER_OPTION_SAVED_OPTIONS "saved_telemetry_messenger_options"
