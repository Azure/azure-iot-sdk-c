...
MOCKABLE_FUNCTION(, DEVICE_MESSAGE_DISPOSITION_INFO*, clone_device_message_disposition_info, DEVICE_MESSAGE_DISPOSITION_INFO*, disposition_info);
MOCKABLE_FUNCTION(, void, destroy_device_message_disposition_info, DEVICE_MESSAGE_DISPOSITION_INFO*, disposition_info);
