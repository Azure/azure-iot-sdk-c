...
#define IOTHUB_CLIENT_FILE_UPLOAD_GET_DATA_RESULT_VALUES \
    ...
    * @param    userContextCallback   Optional user specified context set in call that initiated the message send (for example, 
    ...
    *
    * @param[in]    statusCode            Status code IoT Hub returns when receiving a property or writeable property response from the device.  
    ...
    *                                     IoTHubDeviceClient_LL_SendPropertiesAsync or IoTHubDeviceClient_LL_RespondToWriteableProperties).
    * 
    */
