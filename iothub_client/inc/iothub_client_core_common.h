...
typedef enum IOTHUB_CLIENT_RESULT_VALUES_TAG
{
    IOTHUB_CLIENT_OK = 0,
...
typedef enum IOTHUB_CLIENT_RETRY_POLICY_VALUES_TAG
{
...
typedef enum IOTHUB_CLIENT_RETRY_POLICY_VALUES_TAG
{
    IOTHUB_CLIENT_RETRY_NONE = 0,
    IOTHUB_CLIENT_RETRY_IMMEDIATE = 1,
    IOTHUB_CLIENT_RETRY_INTERVA1 = 2,
    IOTHUB_CLIENT_RETRY_LINEAR_BACKOFF = 3,
    IOTHUB_CLIENT_RETRY_EXPONENTIAL_BACKOFF = 4,
    IOTHUB_CLIENT_RETRY_EXPONENTIAL_BACKOFF_WITH_JITTER = 5,
    IOTHUB_CLIENT_RETRY_RANDOM = 6
...
typedef enum IOTHUB_CLIENT_STATUS_VALUES_TAG
{
...
typedef enum IOTHUB_IDENTITY_TYPE_VALUE_TAG
{
...
typedef enum IOTHUB_PROCESS_ITEM_RESULT_VALUE_TAG
{
    IOTHUB_PROCESS_OK = 0,
...
typedef enum IOTHUBMESSAGE_DISPOSITION_RESULT_VALUES_TAG
{
...
typedef enum IOTHUB_CLIENT_IOTHUB_METHOD_STATUS_VALUES_TAG
{
...
typedef enum IOTHUB_CLIENT_CONFIRMATION_RESULT_VALUES_TAG
{
...
typedef enum IOTHUB_CLIENT_CONNECTION_STATUS_VALUES_TAG
{
...
typedef enum IOTHUB_CLIENT_CONNECTION_STATUS_REASON_VALUES_TAG
{
...
typedef enum TRANSPORT_TYPE_VALUES_TAG
{
    TRANSPORT_LL = 0,
...
typedef enum DEVICE_TWIN_UPDATE_STATE_VALUES_TAG
{
...
typedef enum IOTHUB_CLIENT_FILE_UPLOAD_GET_DATA_RESULT_VALUES_TAG
{
