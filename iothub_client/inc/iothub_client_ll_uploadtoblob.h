...
typedef struct LARGE_FILE_TAG* LARGE_FILE_HANDLE;
    ...
    MOCKABLE_FUNCTION(, LARGE_FILE_HANDLE, IoTHubClient_LL_LARGE_FILE_open_Impl, IOTHUB_CLIENT_LL_UPLOADTOBLOB_HANDLE, blobHandle, const char*, destinationFileName);
    MOCKABLE_FUNCTION(, IOTHUB_CLIENT_RESULT, IoTHubClient_LL_LARGE_FILE_write_Impl, LARGE_FILE_HANDLE, fileHandle, const unsigned char*, source, size_t, size);
    MOCKABLE_FUNCTION(, IOTHUB_CLIENT_RESULT, IoTHubClient_LL_LARGE_FILE_close_Impl, LARGE_FILE_HANDLE, fileHandle);
