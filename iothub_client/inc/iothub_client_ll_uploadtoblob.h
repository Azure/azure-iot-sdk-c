...
typedef struct IOTHUB_CLIENT_LL_UPLOADTOBLOB_HANDLE_DATA* IOTHUB_CLIENT_LL_UPLOADTOBLOB_HANDLE;
    ...
    MOCKABLE_FUNCTION(, IOTHUB_CLIENT_RESULT, IoTHubClient_LL_UploadToBlob_WithCallback_Impl, IOTHUB_CLIENT_LL_UPLOADTOBLOB_HANDLE, handle, const char*, destinationFileName, IOTHUB_CLIENT_FILE_UPLOAD_GET_DATA_CALLBACK, getDataCallback, void*, context);
...
typedef struct IOTHUB_CLIENT_LARGE_FILE_HANDLE_DATA* IOTHUB_CLIENT_LARGE_FILE_HANDLE;
    ...
    MOCKABLE_FUNCTION(, IOTHUB_CLIENT_LARGE_FILE_HANDLE, IoTHubClient_LL_LargeFileOpen_Impl, IOTHUB_CLIENT_LL_UPLOADTOBLOB_HANDLE, blobHandle, const char*, destinationFileName);
    MOCKABLE_FUNCTION(, IOTHUB_CLIENT_RESULT, IoTHubClient_LL_LargeFileWrite_Impl, IOTHUB_CLIENT_LARGE_FILE_HANDLE, fileHandle, const unsigned char*, source, size_t, size);
    MOCKABLE_FUNCTION(, IOTHUB_CLIENT_RESULT, IoTHubClient_LL_LargeFileClose_Impl, IOTHUB_CLIENT_LARGE_FILE_HANDLE, fileHandle);
