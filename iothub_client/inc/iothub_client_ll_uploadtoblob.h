...
typedef struct IOTHUB_CLIENT_LARGE_FILE_HANDLE_DATA* IOTHUB_CLIENT_LARGE_FILE_HANDLE;
    ...
    MOCKABLE_FUNCTION(, IOTHUB_CLIENT_LARGE_FILE_HANDLE, IoTHubClient_LL_LARGE_FILE_open_Impl, IOTHUB_CLIENT_LL_UPLOADTOBLOB_HANDLE, blobHandle, const char*, destinationFileName);
    MOCKABLE_FUNCTION(, IOTHUB_CLIENT_RESULT, IoTHubClient_LL_LARGE_FILE_write_Impl, IOTHUB_CLIENT_LARGE_FILE_HANDLE, fileHandle, const unsigned char*, source, size_t, size);
    MOCKABLE_FUNCTION(, IOTHUB_CLIENT_RESULT, IoTHubClient_LL_LARGE_FILE_close_Impl, IOTHUB_CLIENT_LARGE_FILE_HANDLE, fileHandle);
