...
typedef struct IOTHUB_CLIENT_DESERIALIZED_PROPERTY_TAG {
    /** @brief   Version of the structure.  Currently will be set to IOTHUB_CLIENT_DESERIALIZED_PROPERTY_VERSION by @c IoTHubClient_Serialize_ReportedProperties. */
    int version;
...
/** @brief Handle that contains results of serializing properties */
typedef struct IOTHUB_CLIENT_PROPERTIES_SERIALIZED_HANDLE_TAG* IOTHUB_CLIENT_PROPERTIES_SERIALIZED_HANDLE;
...
* @param   propertiesSerializedHandle  IOTHUB_CLIENT_PROPERTIES_SERIALIZED_HANDLE containing serialized output.
*
