...
extern "C"
{
    ...
    */
     ...
     * @return    IOTHUB_CLIENT_OK upon success or an error code upon failure.
     */
    MOCKABLE_FUNCTION(, IOTHUB_CLIENT_RESULT, IoTHubDeviceClient_EnableFeatureConfigurationViaTwin, IOTHUB_DEVICE_CLIENT_HANDLE, iotHubClientHandle, bool, enableTwinConfiguration);
