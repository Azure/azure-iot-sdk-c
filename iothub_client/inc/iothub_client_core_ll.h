...
extern "C"
{
     ...
     MOCKABLE_FUNCTION(, IOTHUB_CLIENT_RESULT, IoTHubClientCore_LL_SendCertificateSigningRequestAsync, IOTHUB_CLIENT_CORE_LL_HANDLE, iotHubClientHandle, const char*, certificateSigningRequest, const char*, requestId, const char*, replace, IOTHUB_CLIENT_CERTIFICATE_SIGNING_RESPONSE_CALLBACK, certificateSigningResponseCallback, void*, userContextCallback);
     ...
     MOCKABLE_FUNCTION(, IOTHUB_CLIENT_RESULT, IoTHubClientCore_LL_SubscribeToCommands, IOTHUB_CLIENT_CORE_LL_HANDLE, iotHubClientHandle, IOTHUB_CLIENT_COMMAND_CALLBACK_ASYNC, commandCallback, void*, userContextCallback);
