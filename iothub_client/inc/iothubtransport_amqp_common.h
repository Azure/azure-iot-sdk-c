...
MOCKABLE_FUNCTION(, IOTHUB_CLIENT_RESULT, IoTHubTransport_AMQP_Common_GetDeviceTwin, IOTHUB_DEVICE_HANDLE, handle, IOTHUB_TRANSPORT_GET_DEVICE_TWIN_CALLBACK, completionCallback, void*, callbackContext)
