...
extern "C"
{
    ...
    MOCKABLE_FUNCTION(, IOTHUB_CLIENT_RESULT, IoTHubClientCore_SendCertificateSigningRequestAsync, IOTHUB_CLIENT_CORE_HANDLE, iotHubClientHandle, const char*, certificateSigningRequest, const char*, requestId, const char*, replace, IOTHUB_CLIENT_CERTIFICATE_SIGNING_RESPONSE_CALLBACK, certificateSigningResponseCallback, void*, userContextCallback);
