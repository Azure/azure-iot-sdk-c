...
extern "C"
{
    ...
    MOCKABLE_FUNCTION(, IOTHUB_CLIENT_RESULT, IoTHubClientCore_EnableFeatureConfigurationViaDeviceTwin, IOTHUB_CLIENT_CORE_HANDLE, iotHubClientHandle, bool, enableTwinConfiguration);
