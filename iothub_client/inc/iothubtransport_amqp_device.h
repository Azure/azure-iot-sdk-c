...
typedef void(*DEVICE_SEND_TWIN_UPDATE_COMPLETE_CALLBACK)(DEVICE_TWIN_UPDATE_RESULT result, int status_code, const char* new_version, void* context);
...
MOCKABLE_FUNCTION(, int, device_send_twin_update_async, DEVICE_HANDLE, handle, CONSTBUFFER_HANDLE, data, const char*, version, DEVICE_SEND_TWIN_UPDATE_COMPLETE_CALLBACK, on_send_twin_update_complete_callback, void*, context);
