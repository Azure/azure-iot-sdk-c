...
BEGIN_TEST_SUITE(iothubclient_amqp_dt_e2e_sfc)
...
{
    dt_e2e_get_complete_desired_test_svc_fault_ctrl_kill_Tcp(AMQP_Protocol, IOTHUB_ACCOUNT_AUTH_CONNSTRING);
}

END_TEST_SUITE(iothubclient_amqp_dt_e2e_sfc)
