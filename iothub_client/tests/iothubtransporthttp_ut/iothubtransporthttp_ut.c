...
static pfIoTHubTransport_GetDeviceTwinAsync             IoTHubTransportHttp_GetDeviceTwinAsync;
...
TEST_SUITE_INITIALIZE(suite_init)
{
    ...
    IoTHubTransportHttp_GetDeviceTwinAsync = ((TRANSPORT_PROVIDER*)HTTP_Protocol())->IoTHubTransport_GetDeviceTwinAsync;
...
// Tests_SRS_TRANSPORTMULTITHTTP_09_005: [ `IoTHubTransportHttp_GetDeviceTwinAsync` shall return IOTHUB_CLIENT_ERROR]
TEST_FUNCTION(IoTHubTransportHttp_GetDeviceTwinAsync_returns)
{
    //arrange
    TRANSPORT_LL_HANDLE handle = IoTHubTransportHttp_Create(&TEST_CONFIG, &transport_cb_info, transport_cb_ctx);
    ...
    //act
    IOTHUB_CLIENT_RESULT res = IoTHubTransportHttp_GetDeviceTwinAsync(handle, (IOTHUB_CLIENT_DEVICE_TWIN_CALLBACK)0x4444, (void*)0x4445);
