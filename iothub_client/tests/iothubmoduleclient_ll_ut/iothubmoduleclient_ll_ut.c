...
TEST_FUNCTION(IoTHubModuleClient_LL_GetDeviceTwinAsync_Test)
{
    //arrange
    STRICT_EXPECTED_CALL(IoTHubClientCore_LL_GetDeviceTwinAsync(TEST_IOTHUB_CLIENT_CORE_LL_HANDLE, TEST_TWIN_CALLBACK, NULL));

    //act
    IOTHUB_CLIENT_RESULT result = IoTHubModuleClient_LL_GetDeviceTwinAsync(TEST_IOTHUB_MODULE_CLIENT_LL_HANDLE, TEST_TWIN_CALLBACK, NULL);
