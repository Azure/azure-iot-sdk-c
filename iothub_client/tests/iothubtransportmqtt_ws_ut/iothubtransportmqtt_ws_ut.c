...
static pfIoTHubTransport_GetDeviceTwinAsync         IoTHubTransportMqtt_WS_GetDeviceTwinAsync;
...
TEST_SUITE_INITIALIZE(suite_init)
{
    ...
    IoTHubTransportMqtt_WS_GetDeviceTwinAsync = ((TRANSPORT_PROVIDER*)MQTT_WebSocket_Protocol())->IoTHubTransport_GetDeviceTwinAsync;
...
// Tests_SRS_IOTHUB_MQTT_WEBSOCKET_TRANSPORT_09_001: [ IoTHubTransportMqtt_WS_GetDeviceTwinAsync shall call into the IoTHubTransport_MQTT_Common_GetDeviceTwinAsync ]
TEST_FUNCTION(IoTHubTransportMqtt_WS_GetDeviceTwinAsync_success)
{
    // arrange
    IOTHUBTRANSPORT_CONFIG config = { 0 };
    SetupIothubTransportConfig(&config, TEST_DEVICE_ID, TEST_DEVICE_KEY, TEST_IOTHUB_NAME, TEST_IOTHUB_SUFFIX, TEST_PROTOCOL_GATEWAY_HOSTNAME);
    ...
    // act
    IOTHUB_CLIENT_RESULT result = IoTHubTransportMqtt_WS_GetDeviceTwinAsync(handle, (IOTHUB_CLIENT_DEVICE_TWIN_CALLBACK)0x4444, (void*)0x4445);
