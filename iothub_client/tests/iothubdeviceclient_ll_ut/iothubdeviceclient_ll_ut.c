...
TEST_FUNCTION(IoTHubDeviceClient_LL_SendMessageDisposition_Test)
{
    //arrange
    umock_c_reset_all_calls();
...
TEST_FUNCTION(IoTHubDeviceClient_LL_SetStreamRequestCallback_Test)
{
    //arrange
    ...
    //act
    IOTHUB_CLIENT_RESULT result = IoTHubDeviceClient_LL_SetStreamRequestCallback(TEST_IOTHUB_DEVICE_CLIENT_LL_HANDLE, callback, context);
...
TEST_FUNCTION(IoTHubDeviceClient_LL_SetStreamRequestCallback_Negative_Test)
{
    //arrange
    DEVICE_STREAM_C2D_REQUEST_CALLBACK callback = (DEVICE_STREAM_C2D_REQUEST_CALLBACK)0x4445;
    void* context = (void*)0x4446;
...
TEST_FUNCTION(IoTHubDeviceClient_LL_SendTelemetryAsync_Test)
{
    //arrange
    STRICT_EXPECTED_CALL(IoTHubClientCore_LL_SendEventAsync(TEST_IOTHUB_CLIENT_CORE_LL_HANDLE, TEST_MESSAGE_HANDLE, TEST_EVENT_CONFIRMATION_CALLBACK, NULL));

    //act
    IOTHUB_CLIENT_RESULT result = IoTHubDeviceClient_LL_SendTelemetryAsync(TEST_IOTHUB_DEVICE_CLIENT_LL_HANDLE, TEST_MESSAGE_HANDLE, TEST_EVENT_CONFIRMATION_CALLBACK, NULL);
...
TEST_FUNCTION(IoTHubDeviceClient_LL_SendPropertiesAsync_Test)
{
    //arrange
    ...
    //act
    IOTHUB_CLIENT_RESULT result = IoTHubDeviceClient_LL_SendPropertiesAsync(TEST_IOTHUB_DEVICE_CLIENT_LL_HANDLE, TEST_UNSIGNED_CHAR, TEST_SIZE_T, TEST_PROPERTY_ACKNOWLEDGED_CALLBACK, NULL);
...
TEST_FUNCTION(IoTHubDeviceClient_LL_SubscribeToCommands_Test)
{
    //arrange
    ...
    //act
    IOTHUB_CLIENT_RESULT result = IoTHubDeviceClient_LL_SubscribeToCommands(TEST_IOTHUB_DEVICE_CLIENT_LL_HANDLE, TEST_COMMAND_CALLBACK, NULL);
...
TEST_FUNCTION(IoTHubDeviceClient_LL_GetPropertiesAsync_Test)
{
    //arrange
    ...
    //act
    IOTHUB_CLIENT_RESULT result = IoTHubDeviceClient_LL_GetPropertiesAsync(TEST_IOTHUB_DEVICE_CLIENT_LL_HANDLE, TEST_PROPERTIES_RECEIVED_CALLBACK, NULL);
...
TEST_FUNCTION(IoTHubDeviceClient_LL_GetPropertiesAndSubscribeToUpdatesAsync_Test)
{
    //arrange
    ...
    //act
    IOTHUB_CLIENT_RESULT result = IoTHubDeviceClient_LL_GetPropertiesAndSubscribeToUpdatesAsync(TEST_IOTHUB_DEVICE_CLIENT_LL_HANDLE, TEST_PROPERTIES_RECEIVED_CALLBACK, NULL);
