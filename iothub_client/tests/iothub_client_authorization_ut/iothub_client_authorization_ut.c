...
static void setup_IoTHubClient_Auth_Create_mocks()
{
...
TEST_FUNCTION(IoTHubClient_Auth_Create_key_NULL_succeed)
{
    //arrange
    umock_c_reset_all_calls();
...
TEST_FUNCTION(IoTHubClient_Auth_Create_succeed)
{
    ...
    setup_IoTHubClient_Auth_Create_mocks();
...
TEST_FUNCTION(IoTHubClient_Auth_Create_with_sas_succeed)
{
    ...
    //act
    IOTHUB_AUTHORIZATION_HANDLE handle = IoTHubClient_Auth_Create(DEVICE_KEY, DEVICE_ID, TEST_SAS_TOKEN);
...
TEST_FUNCTION(IoTHubClient_Auth_Is_SasToken_Valid_handle_NULL_fail)
{
    ...
    //act
    bool is_valid = IoTHubClient_Auth_Is_SasToken_Valid(NULL);

    //assert
    ASSERT_IS_FALSE(is_valid);
    ASSERT_ARE_EQUAL(char_ptr, umock_c_get_expected_calls(), umock_c_get_actual_calls());
...
TEST_FUNCTION(IoTHubClient_Auth_Is_SasToken_Valid_succeed)
{
    ...
    //act
    bool is_valid = IoTHubClient_Auth_Is_SasToken_Valid(handle);

    //assert
    ASSERT_IS_TRUE(is_valid);
    ASSERT_ARE_EQUAL(char_ptr, umock_c_get_expected_calls(), umock_c_get_actual_calls());
