...
MOCKABLE_FUNCTION(, void, commandCallback, const IOTHUB_CLIENT_COMMAND_REQUEST*, commandRequest, IOTHUB_CLIENT_COMMAND_RESPONSE*, commandResponse, void*, userContextCallback);
...
#define TEST_COMPONENT_NAME "Test_Component"
static const char TEST_METHOD_NAME_WITH_COMPONENT[] = TEST_COMPONENT_NAME "*" TEST_METHOD_NAME;
...
static const void* TEST_COMMAND_CALLBACK_CONTEXT = (const void*)0x4277;
...
TEST_SUITE_INITIALIZE(suite_init)
{
    ...
    REGISTER_GLOBAL_MOCK_HOOK(commandCallback, test_commandCallback);
...
static void setup_IoTHubClientCore_LL_create_mocks(bool use_device_config, bool is_edge_module)
{
    ...
    {
        STRICT_EXPECTED_CALL(IoTHubClient_Auth_CreateFromDeviceAuth(IGNORED_ARG, IGNORED_ARG));
        //STRICT_EXPECTED_CALL(gballoc_free(IGNORED_ARG));
        //STRICT_EXPECTED_CALL(STRING_delete(IGNORED_ARG));
    }
    else
    {
        STRICT_EXPECTED_CALL(IoTHubClient_Auth_Create(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
    }
    STRICT_EXPECTED_CALL(FAKE_IoTHubTransport_Create(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
#ifndef DONT_USE_UPLOADTOBLOB
    STRICT_EXPECTED_CALL(IoTHubClient_LL_UploadToBlob_Create(IGNORED_ARG, IGNORED_ARG));
    ...
    if (use_device_config)
    {
        ...
        STRICT_EXPECTED_CALL(IoTHubClient_Auth_Get_x509_info(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
        STRICT_EXPECTED_CALL(IoTHubClient_LL_UploadToBlob_SetOption(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
        STRICT_EXPECTED_CALL(IoTHubClient_LL_UploadToBlob_SetOption(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
        STRICT_EXPECTED_CALL(gballoc_free(IGNORED_ARG));
        STRICT_EXPECTED_CALL(gballoc_free(IGNORED_ARG));
    }
    ...
    if (is_edge_module)
    {
        STRICT_EXPECTED_CALL(IoTHubClient_EdgeHandle_Create(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
    }
#else
        (void)is_edge_module;
#endif /*USE_EDGE_MODULES*/
    ...
    STRICT_EXPECTED_CALL(FAKE_IoTHubTransport_GetSupportedPlatformInfo(IGNORED_ARG, IGNORED_ARG))
        .SetReturn(0)
    ...
    STRICT_EXPECTED_CALL(DList_InitializeListHead(IGNORED_ARG));
    STRICT_EXPECTED_CALL(DList_InitializeListHead(IGNORED_ARG));
    STRICT_EXPECTED_CALL(FAKE_IoTHubTransport_Register(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
    STRICT_EXPECTED_CALL(FAKE_IoTHubTransport_SetRetryPolicy(IGNORED_ARG, TEST_RETRY_POLICY, 0));
}
...
static void setup_IoTHubClientCore_LL_sendreportedstate_mocks()
{
    ...
    STRICT_EXPECTED_CALL(FAKE_IoTHubTransport_Subscribe_DeviceTwin(IGNORED_ARG));
...
static void setup_IoTHubClientCore_LL_sendeventasync_mocks(bool invoke_tickcounter)
{
    ...
    STRICT_EXPECTED_CALL(IoTHubClient_Diagnostic_AddIfNecessary(IGNORED_ARG, IGNORED_ARG))
        .IgnoreArgument(1)
        .IgnoreArgument(2);
...
{
    STRICT_EXPECTED_CALL(gballoc_malloc(IGNORED_ARG)).IgnoreArgument_size();

    STRICT_EXPECTED_CALL(STRING_construct(IGNORED_ARG)).IgnoreArgument_psz();
    STRICT_EXPECTED_CALL(STRING_TOKENIZER_create(IGNORED_ARG)).IgnoreArgument_handle();
    ...
    /* loop 1 */
    EXPECTED_CALL(STRING_TOKENIZER_get_next_token(TEST_STRING_TOKENIZER_HANDLE, TEST_STRING_HANDLE, IGNORED_ARG));
    EXPECTED_CALL(STRING_TOKENIZER_get_next_token(TEST_STRING_TOKENIZER_HANDLE, TEST_STRING_HANDLE, IGNORED_ARG));
    STRICT_EXPECTED_CALL(STRING_c_str(IGNORED_ARG)).SetReturn(TEST_HOSTNAME_TOKEN).CallCannotFail();
    EXPECTED_CALL(STRING_TOKENIZER_create(IGNORED_ARG));
    EXPECTED_CALL(STRING_TOKENIZER_get_next_token(TEST_STRING_TOKENIZER_HANDLE, IGNORED_ARG, IGNORED_ARG));
    EXPECTED_CALL(STRING_c_str(IGNORED_ARG)).SetReturn(TEST_HOSTNAME_TOKEN).CallCannotFail();;
    EXPECTED_CALL(STRING_TOKENIZER_get_next_token(TEST_STRING_TOKENIZER_HANDLE, IGNORED_ARG, IGNORED_ARG));
    STRICT_EXPECTED_CALL(STRING_c_str(IGNORED_ARG))
        .IgnoreArgument_handle().CallCannotFail();;
    EXPECTED_CALL(STRING_TOKENIZER_destroy(IGNORED_ARG));

    /* loop 2 */
    EXPECTED_CALL(STRING_TOKENIZER_get_next_token(TEST_STRING_TOKENIZER_HANDLE, TEST_STRING_HANDLE, IGNORED_ARG));
    EXPECTED_CALL(STRING_TOKENIZER_get_next_token(TEST_STRING_TOKENIZER_HANDLE, TEST_STRING_HANDLE, IGNORED_ARG));
    STRICT_EXPECTED_CALL(STRING_c_str(IGNORED_ARG)).IgnoreArgument_handle().SetReturn(TEST_DEVICEID_TOKEN).CallCannotFail();
    STRICT_EXPECTED_CALL(STRING_clone(IGNORED_ARG)).IgnoreArgument(1);  // 20
    STRICT_EXPECTED_CALL(STRING_c_str(IGNORED_ARG)).IgnoreArgument_handle().CallCannotFail();;

    /* loop 3*/
    EXPECTED_CALL(STRING_TOKENIZER_get_next_token(TEST_STRING_TOKENIZER_HANDLE, TEST_STRING_HANDLE, IGNORED_ARG));
    EXPECTED_CALL(STRING_TOKENIZER_get_next_token(TEST_STRING_TOKENIZER_HANDLE, TEST_STRING_HANDLE, IGNORED_ARG));
    STRICT_EXPECTED_CALL(STRING_c_str(IGNORED_ARG)).IgnoreArgument_handle().SetReturn(device_token).CallCannotFail();;
    STRICT_EXPECTED_CALL(STRING_c_str(IGNORED_ARG)).IgnoreArgument_handle().SetReturn("true").CallCannotFail();;
    ...
    STRICT_EXPECTED_CALL(STRING_c_str(IGNORED_ARG)).IgnoreArgument_handle().SetReturn(NULL).CallCannotFail();
    ...
    STRICT_EXPECTED_CALL(gballoc_free(IGNORED_ARG)).IgnoreArgument_ptr();
}
...
static void setup_IoTHubClientCore_LL_createfromconnectionstring_mocks(const char* device_token, const char* token_value, bool include_invalid_tokens)
{
    ...
    STRICT_EXPECTED_CALL(STRING_TOKENIZER_create(IGNORED_ARG));
    STRICT_EXPECTED_CALL(STRING_new());
    STRICT_EXPECTED_CALL(STRING_new());
    STRICT_EXPECTED_CALL(STRING_new());
    STRICT_EXPECTED_CALL(STRING_new());
    ...
    /* loop 1 */
    EXPECTED_CALL(STRING_TOKENIZER_get_next_token(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
    EXPECTED_CALL(STRING_TOKENIZER_get_next_token(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
    STRICT_EXPECTED_CALL(STRING_c_str(IGNORED_ARG)).SetReturn(TEST_HOSTNAME_TOKEN).CallCannotFail();
    EXPECTED_CALL(STRING_TOKENIZER_create(IGNORED_ARG));
    EXPECTED_CALL(STRING_TOKENIZER_get_next_token(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
    ...
    EXPECTED_CALL(STRING_TOKENIZER_get_next_token(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
    STRICT_EXPECTED_CALL(STRING_c_str(IGNORED_ARG)).CallCannotFail(); // 14
    EXPECTED_CALL(STRING_TOKENIZER_destroy(IGNORED_ARG));

    /* loop 2 */
    EXPECTED_CALL(STRING_TOKENIZER_get_next_token(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
    EXPECTED_CALL(STRING_TOKENIZER_get_next_token(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
    STRICT_EXPECTED_CALL(STRING_c_str(IGNORED_ARG)).SetReturn(TEST_DEVICEID_TOKEN).CallCannotFail();
    STRICT_EXPECTED_CALL(STRING_clone(IGNORED_ARG));  // 19
    STRICT_EXPECTED_CALL(STRING_c_str(IGNORED_ARG)).CallCannotFail();

    /* loop 3*/
    EXPECTED_CALL(STRING_TOKENIZER_get_next_token(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
    EXPECTED_CALL(STRING_TOKENIZER_get_next_token(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
    STRICT_EXPECTED_CALL(STRING_c_str(IGNORED_ARG)).SetReturn(device_token).CallCannotFail();
    STRICT_EXPECTED_CALL(STRING_clone(IGNORED_ARG));
    STRICT_EXPECTED_CALL(STRING_c_str(IGNORED_ARG)).SetReturn(token_value).CallCannotFail(); // 25

    if (include_invalid_tokens)
    {
        EXPECTED_CALL(STRING_TOKENIZER_get_next_token(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
        EXPECTED_CALL(STRING_TOKENIZER_get_next_token(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
        STRICT_EXPECTED_CALL(STRING_c_str(IGNORED_ARG)).SetReturn(TEST_INVALID_TOKEN1).CallCannotFail();

        EXPECTED_CALL(STRING_TOKENIZER_get_next_token(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
        EXPECTED_CALL(STRING_TOKENIZER_get_next_token(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
        STRICT_EXPECTED_CALL(STRING_c_str(IGNORED_ARG)).SetReturn(TEST_INVALID_TOKEN2).CallCannotFail();
    }

    /* loop exit */
    // Mark CallCannotFail because this is final pass through loop, expected to bail out, so shouldn't failure test it.
    EXPECTED_CALL(STRING_TOKENIZER_get_next_token(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG)).SetReturn(__LINE__).CallCannotFail(); // 26

    STRICT_EXPECTED_CALL(STRING_c_str(IGNORED_ARG)).SetReturn(NULL).CallCannotFail(); // 27

    setup_IoTHubClientCore_LL_create_mocks(false, false);

    EXPECTED_CALL(STRING_delete(IGNORED_ARG)); // 38
    EXPECTED_CALL(STRING_delete(IGNORED_ARG));
    EXPECTED_CALL(STRING_delete(IGNORED_ARG));
    EXPECTED_CALL(STRING_delete(IGNORED_ARG));
    EXPECTED_CALL(STRING_delete(IGNORED_ARG));
...
TEST_FUNCTION(IoTHubClientCore_LL_CreateFromConnectionString_withGatewayHostName_succeeds)
{
    ...
    EXPECTED_CALL(STRING_TOKENIZER_get_next_token(TEST_STRING_TOKENIZER_HANDLE, TEST_STRING_HANDLE, IGNORED_ARG));
    EXPECTED_CALL(STRING_TOKENIZER_get_next_token(TEST_STRING_TOKENIZER_HANDLE, TEST_STRING_HANDLE, IGNORED_ARG));
    STRICT_EXPECTED_CALL(STRING_c_str(IGNORED_ARG)).IgnoreArgument_handle().SetReturn(TEST_HOSTNAME_TOKEN);
    EXPECTED_CALL(STRING_TOKENIZER_create(IGNORED_ARG));
    EXPECTED_CALL(STRING_TOKENIZER_get_next_token(TEST_STRING_TOKENIZER_HANDLE, IGNORED_ARG, IGNORED_ARG));
    ...
    EXPECTED_CALL(STRING_TOKENIZER_get_next_token(TEST_STRING_TOKENIZER_HANDLE, TEST_STRING_HANDLE, IGNORED_ARG));
    EXPECTED_CALL(STRING_TOKENIZER_get_next_token(TEST_STRING_TOKENIZER_HANDLE, TEST_STRING_HANDLE, IGNORED_ARG));
    STRICT_EXPECTED_CALL(STRING_c_str(IGNORED_ARG)).IgnoreArgument_handle().SetReturn(TEST_DEVICEID_TOKEN);
    STRICT_EXPECTED_CALL(STRING_clone(IGNORED_ARG)).IgnoreArgument(1);  // 20
    STRICT_EXPECTED_CALL(STRING_c_str(IGNORED_ARG)).IgnoreArgument_handle();

    /* loop 3*/
    EXPECTED_CALL(STRING_TOKENIZER_get_next_token(TEST_STRING_TOKENIZER_HANDLE, TEST_STRING_HANDLE, IGNORED_ARG));
    EXPECTED_CALL(STRING_TOKENIZER_get_next_token(TEST_STRING_TOKENIZER_HANDLE, TEST_STRING_HANDLE, IGNORED_ARG));
    STRICT_EXPECTED_CALL(STRING_c_str(IGNORED_ARG)).IgnoreArgument_handle().SetReturn(TEST_DEVICEKEY_TOKEN);
    STRICT_EXPECTED_CALL(STRING_clone(IGNORED_ARG)).IgnoreArgument(1);
    STRICT_EXPECTED_CALL(STRING_c_str(IGNORED_ARG)).IgnoreArgument_handle();
    ...
    EXPECTED_CALL(STRING_TOKENIZER_get_next_token(TEST_STRING_TOKENIZER_HANDLE, TEST_STRING_HANDLE, IGNORED_ARG))
        .SetReturn(0);
    STRICT_EXPECTED_CALL(STRING_c_str(IGNORED_ARG)).IgnoreArgument_handle().SetReturn(TEST_PROTOCOL_GATEWAY_HOST_NAME_TOKEN);
    STRICT_EXPECTED_CALL(STRING_clone(IGNORED_ARG)).IgnoreArgument(1);
    STRICT_EXPECTED_CALL(STRING_c_str(IGNORED_ARG)).IgnoreArgument_handle();
    ...
    STRICT_EXPECTED_CALL(STRING_c_str(IGNORED_ARG)).IgnoreArgument_handle().SetReturn(NULL);

    setup_IoTHubClientCore_LL_create_mocks(false, false);

    EXPECTED_CALL(STRING_delete(IGNORED_ARG)); // 36
    EXPECTED_CALL(STRING_delete(IGNORED_ARG));
    EXPECTED_CALL(STRING_delete(IGNORED_ARG));
    EXPECTED_CALL(STRING_delete(IGNORED_ARG));
    EXPECTED_CALL(STRING_delete(IGNORED_ARG));
...
TEST_FUNCTION(IoTHubClientCore_LL_CreateFromConnectionString_with_x509_test_string_fails)
{
    ...
    EXPECTED_CALL(STRING_TOKENIZER_get_next_token(TEST_STRING_TOKENIZER_HANDLE, TEST_STRING_HANDLE, IGNORED_ARG));
    EXPECTED_CALL(STRING_TOKENIZER_get_next_token(TEST_STRING_TOKENIZER_HANDLE, TEST_STRING_HANDLE, IGNORED_ARG));
    STRICT_EXPECTED_CALL(STRING_c_str(IGNORED_ARG)).IgnoreArgument_handle().SetReturn(TEST_X509);
    /* loop exit */
    STRICT_EXPECTED_CALL(STRING_c_str(IGNORED_ARG)).IgnoreArgument_handle().SetReturn(TEST_STRING_VALUE);
...
TEST_FUNCTION(IoTHubClientCore_LL_CreateFromConnectionString_with_ModuleId_succeeds)
{
    ...
    EXPECTED_CALL(STRING_TOKENIZER_get_next_token(TEST_STRING_TOKENIZER_HANDLE, TEST_STRING_HANDLE, IGNORED_ARG))
        .SetReturn(0);
    STRICT_EXPECTED_CALL(STRING_c_str(IGNORED_ARG)).IgnoreArgument_handle().SetReturn(TEST_MODULE_ID_TOKEN);
    STRICT_EXPECTED_CALL(STRING_clone(IGNORED_ARG)).IgnoreArgument(1);
...
TEST_FUNCTION(IoTHubClientCore_LL_CreateWithTransport_Succeeds)
{
    ...
    STRICT_EXPECTED_CALL(gballoc_malloc(IGNORED_ARG));
    STRICT_EXPECTED_CALL(IoTHubClient_Auth_Create(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
    STRICT_EXPECTED_CALL(FAKE_IoTHubTransport_SetCallbackContext(IGNORED_ARG, IGNORED_ARG));
    STRICT_EXPECTED_CALL(FAKE_IoTHubTransport_GetHostname(IGNORED_ARG)); /*this is getting the hostname as STRING_HANDLE*/
    STRICT_EXPECTED_CALL(STRING_c_str(IGNORED_ARG)) /*this is getting the hostname as const char* */
...
#ifndef DONT_USE_UPLOADTOBLOB
    STRICT_EXPECTED_CALL(IoTHubClient_LL_UploadToBlob_Destroy(IGNORED_ARG));
#endif /*DONT_USE_UPLOADTOBLOB*/
#ifdef USE_EDGE_MODULES
    STRICT_EXPECTED_CALL(IoTHubClient_EdgeHandle_Destroy(IGNORED_ARG));
#endif /*USE_EDGE_MODULES*/
    STRICT_EXPECTED_CALL(IoTHubClient_Auth_Destroy(IGNORED_ARG));
    STRICT_EXPECTED_CALL(gballoc_free(IGNORED_ARG));
...
TEST_FUNCTION(IoTHubClientCore_LL_CreateWithTransport_set_retry_policy_fails_shared_transport_is_not_destroyed)
{
    ...
    // Failure cleanup calls
    STRICT_EXPECTED_CALL(FAKE_IoTHubTransport_Unregister(IGNORED_ARG));
    STRICT_EXPECTED_CALL(IoTHubClient_Auth_Destroy(IGNORED_ARG));
    // Note: not destroying the shared transport!
#ifndef DONT_USE_UPLOADTOBLOB
    STRICT_EXPECTED_CALL(IoTHubClient_LL_UploadToBlob_Destroy(IGNORED_ARG));
...
TEST_FUNCTION(IoTHubClientCore_LL_Destroys_the_underlying_transport_succeeds)
{
    ...
    STRICT_EXPECTED_CALL(FAKE_IoTHubTransport_Unregister(IGNORED_ARG));
    STRICT_EXPECTED_CALL(FAKE_IoTHubTransport_Destroy(IGNORED_ARG));
...
TEST_FUNCTION(IoTHubClientCore_LL_Destroy_after_sendEvent_succeeds)
{
    ...
    STRICT_EXPECTED_CALL(DList_RemoveHeadList(IGNORED_ARG)); /*because there is one item in the list*/
    ...
    STRICT_EXPECTED_CALL(gballoc_free(IGNORED_ARG)); /*IOTHUBMESSAGE*/
...
TEST_FUNCTION(IoTHubClientCore_LL_SetMessageCallback_with_NULL_calls_Unsubscribe_and_succeeds)
{
    ...
    STRICT_EXPECTED_CALL(FAKE_IoTHubTransport_Unsubscribe(IGNORED_ARG))
        .IgnoreArgument(1);
...
TEST_FUNCTION(IoTHubClientCore_LL_SetMessageCallback_Ex_Subscribe_fails)
{
    ...
    STRICT_EXPECTED_CALL(FAKE_IoTHubTransport_Subscribe(IGNORED_ARG))
        .IgnoreArgument_handle()
        .SetReturn(__LINE__);
...
TEST_FUNCTION(IoTHubClientCore_LL_SendMessageDisposition_Succeeds)
{
    ...
    STRICT_EXPECTED_CALL(FAKE_IoTHubTransport_SendMessageDisposition(IGNORED_ARG, TEST_MESSAGE_HANDLE, IOTHUBMESSAGE_ACCEPTED));
...
TEST_FUNCTION(IoTHubClientCore_LL_SetRetryPolicy_Retrytimeout_0_pass)
{
    ...
    {
        STRICT_EXPECTED_CALL(FAKE_IoTHubTransport_SetRetryPolicy(IGNORED_ARG, (IOTHUB_CLIENT_RETRY_POLICY)policy, 0))
                .IgnoreArgument(1);
...
TEST_FUNCTION(IoTHubClientCore_LL_SetRetryPolicy_success)
{
    ...
    STRICT_EXPECTED_CALL(FAKE_IoTHubTransport_SetRetryPolicy(IGNORED_ARG, TEST_RETRY_POLICY, TEST_RETRY_TIMEOUT_SECS));
...
TEST_FUNCTION(IoTHubClientCore_LL_ConnectionStatusCallBack_calls_upper_layer_succeeds)
{
    ...
    STRICT_EXPECTED_CALL(connectionStatusCallback((IOTHUB_CLIENT_CONNECTION_STATUS)IGNORED_ARG, (IOTHUB_CLIENT_CONNECTION_STATUS_REASON)IGNORED_ARG, (void*)11))
        .IgnoreArgument_result3()
        .IgnoreArgument_reason();
...
TEST_FUNCTION(IoTHubClientCore_LL_DoWork_calls_underlying_succeeds)
{
    ...
    STRICT_EXPECTED_CALL(tickcounter_get_current_ms(IGNORED_ARG, IGNORED_ARG)); /*_DoWork will ask "what's the time"*/

    STRICT_EXPECTED_CALL(FAKE_IoTHubTransport_DoWork(IGNORED_ARG));
...
TEST_FUNCTION(IoTHubClientCore_LL_GetSendStatus_NoEventToSend_Succeeds)
{
    ...
    STRICT_EXPECTED_CALL(FAKE_IoTHubTransport_GetSendStatus(IGNORED_ARG, IGNORED_ARG))
        .IgnoreArgument_handle()
...
TEST_FUNCTION(IoTHubClientCore_LL_SetOption_sas_token_lifetime_succeeds)
{
    ...
    STRICT_EXPECTED_CALL(IoTHubClient_Auth_Set_SasToken_Expiry(IGNORED_ARG, IGNORED_ARG));
...
TEST_FUNCTION(IoTHubClientCore_LL_SetOption_sas_token_lifetime_fail)
{
    ...
    STRICT_EXPECTED_CALL(IoTHubClient_Auth_Set_SasToken_Expiry(IGNORED_ARG, IGNORED_ARG)).SetReturn(__LINE__);
...
TEST_FUNCTION(IoTHubClientCore_LL_SetOption_fails_when_IoTHubTransport_SetOption_fails)
{
    ...
    STRICT_EXPECTED_CALL(FAKE_IoTHubTransport_SetOption(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG))
    .IgnoreArgument_handle()
    .IgnoreArgument_optionName()
    .IgnoreArgument_value()
    .SetReturn(IOTHUB_CLIENT_INDEFINITE_TIME);
...
TEST_FUNCTION(IoTHubClientCore_LL_SetOption_fails_when_underlying_transport_fails)
{
    ...
    EXPECTED_CALL(FAKE_IoTHubTransport_SetOption(IGNORED_ARG, "a", "b"))
        .SetReturn(IOTHUB_CLIENT_INDEFINITE_TIME);
...
TEST_FUNCTION(IoTHubClientCore_LL_SetOption_messageTimeout_calls_timeout_callback)
{
    ...
    STRICT_EXPECTED_CALL(DList_RemoveEntryList(IGNORED_ARG)) /*this is removing the item from waitingToSend*/
        .IgnoreArgument(1);
    ...
    STRICT_EXPECTED_CALL(IoTHubMessage_Destroy(IGNORED_ARG)) /*destroying the message clone*/
        .IgnoreArgument(1);
    STRICT_EXPECTED_CALL(gballoc_free(IGNORED_ARG)) /*destroying the IOTHUB_MESSAGE_LIST*/
        .IgnoreArgument(1);
    EXPECTED_CALL(FAKE_IoTHubTransport_DoWork(IGNORED_ARG));
...
TEST_FUNCTION(IoTHubClientCore_LL_UploadToBlob_OK)
{
    ...
    STRICT_EXPECTED_CALL(IoTHubClient_LL_UploadToBlob_InitializeUpload(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG, IGNORED_ARG))
    ...
    STRICT_EXPECTED_CALL(IoTHubClient_LL_UploadToBlob_CreateContext(IGNORED_ARG, IGNORED_ARG));
    STRICT_EXPECTED_CALL(IoTHubClient_LL_UploadToBlob_PutBlock(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
    STRICT_EXPECTED_CALL(IoTHubClient_LL_UploadToBlob_PutBlockList(IGNORED_ARG));
    STRICT_EXPECTED_CALL(IoTHubClient_LL_UploadToBlob_DestroyContext(IGNORED_ARG));
    STRICT_EXPECTED_CALL(IoTHubClient_LL_UploadToBlob_NotifyCompletion(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
    STRICT_EXPECTED_CALL(gballoc_free(IGNORED_ARG));
    STRICT_EXPECTED_CALL(gballoc_free(IGNORED_ARG));
...
TEST_FUNCTION(IoTHubClientCore_LL_UploadMultipleBlocksToBlobEx_succeeds)
{
    ...
    STRICT_EXPECTED_CALL(IoTHubClient_LL_UploadToBlob_InitializeUpload(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG, IGNORED_ARG))
        ...
        .CopyOutArgumentBuffer_azureBlobSasUri(&azureBlobSasUri, sizeof(char*));
    STRICT_EXPECTED_CALL(IoTHubClient_LL_UploadToBlob_CreateContext(IGNORED_ARG, IGNORED_ARG));
    STRICT_EXPECTED_CALL(IoTHubClient_LL_UploadToBlob_UploadMultipleBlocks(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
    STRICT_EXPECTED_CALL(IoTHubClient_LL_UploadToBlob_DestroyContext(IGNORED_ARG));
    STRICT_EXPECTED_CALL(IoTHubClient_LL_UploadToBlob_NotifyCompletion(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
    STRICT_EXPECTED_CALL(gballoc_free(IGNORED_ARG));
    STRICT_EXPECTED_CALL(gballoc_free(IGNORED_ARG));
...
TEST_FUNCTION(IoTHubClientCore_LL_Destroy_with_pending_reported_state_succeeds)
{
    ...
    STRICT_EXPECTED_CALL(iothub_reported_state_callback(IGNORED_ARG, IGNORED_ARG));
...
TEST_FUNCTION(IoTHubClientCore_LL_DoWork_SendReportedState_succeed)
{
    ...
    STRICT_EXPECTED_CALL(tickcounter_get_current_ms(IGNORED_ARG, IGNORED_ARG)); /*_DoWork will ask "what's the time"*/
    STRICT_EXPECTED_CALL(FAKE_IoTHubTransport_ProcessItem(IGNORED_ARG, IOTHUB_TYPE_DEVICE_TWIN, IGNORED_ARG))
...
TEST_FUNCTION(IoTHubClientCore_LL_SetDeviceMethodCallback_with_NULL_callback_Unsubscribe_and_succeeds)
{
    ...
    STRICT_EXPECTED_CALL(FAKE_IoTHubTransport_Unsubscribe_DeviceMethod(IGNORED_ARG))
        .IgnoreArgument(1);
...
TEST_FUNCTION(IoTHubClientCore_LL_SetDeviceMethodCallback_with_non_NULL_succeeds)
{
    ...
    STRICT_EXPECTED_CALL(FAKE_IoTHubTransport_Subscribe_DeviceMethod(IGNORED_ARG))
        .IgnoreArgument(1);
...
TEST_FUNCTION(IoTHubClientCore_LL_DeviceMethodComplete_succeed)
{
    ...
    STRICT_EXPECTED_CALL(deviceMethodCallback(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG, IGNORED_ARG, IGNORED_ARG, IGNORED_ARG))
        .CopyOutArgumentBuffer_response(&resp, sizeof(unsigned char**))
        .CopyOutArgumentBuffer_resp_size(&len, sizeof(size_t));

    EXPECTED_CALL(FAKE_IoTHubTransport_DeviceMethod_Response(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
    STRICT_EXPECTED_CALL(gballoc_free(IGNORED_ARG));
...
TEST_FUNCTION(IoTHubClientCore_LL_DeviceMethodComplete_Async_succeed)
{
    ...
    STRICT_EXPECTED_CALL(iothub_client_inbound_device_method_callback(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
...
TEST_FUNCTION(IoTHubClientCore_LL_RetrievePropertyComplete_succeed)
{
    ...
    STRICT_EXPECTED_CALL(iothub_device_twin_callback(DEVICE_TWIN_UPDATE_COMPLETE, IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
...
TEST_FUNCTION(IoTHubClientCore_LL_RetrievePropertyComplete_update_partial_before_complete_succeed)
{
    ...
    STRICT_EXPECTED_CALL(iothub_device_twin_callback(DEVICE_TWIN_UPDATE_PARTIAL, IGNORED_ARG, IGNORED_ARG, IGNORED_ARG))
...
TEST_FUNCTION(IoTHubClientCore_LL_SetDeviceTwinCallback_unsubscribe_succeed)
{
    ...
    STRICT_EXPECTED_CALL(FAKE_IoTHubTransport_Unsubscribe_DeviceTwin(IGNORED_ARG))
        .IgnoreArgument_handle();
...
TEST_FUNCTION(IoTHubClientCore_LL_GetTwinAsync_succeed)
{
    ...
    STRICT_EXPECTED_CALL(FAKE_IoTHubTransport_GetTwinAsync(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
...
TEST_FUNCTION(IoTHubClientCore_LL_DeviceMethodResponse_IoTHubTransport_DeviceMethod_Response_FAILS_fail)
{
    ...
    STRICT_EXPECTED_CALL(FAKE_IoTHubTransport_DeviceMethod_Response(IGNORED_ARG, TEST_METHOD_ID, (const unsigned char*)TEST_DEVICE_METHOD_RESPONSE, strlen(TEST_DEVICE_METHOD_RESPONSE), TEST_DEVICE_STATUS_CODE)).SetReturn(MU_FAILURE);
...
TEST_FUNCTION(IoTHubClientCore_LL_DeviceMethodResponse_succeed)
{
    ...
    STRICT_EXPECTED_CALL(FAKE_IoTHubTransport_DeviceMethod_Response(IGNORED_ARG, TEST_METHOD_ID, (const unsigned char*)TEST_DEVICE_METHOD_RESPONSE, strlen(TEST_DEVICE_METHOD_RESPONSE), TEST_DEVICE_STATUS_CODE))
        .IgnoreArgument(1);
...
TEST_FUNCTION(IoTHubClientCore_LL_SendEventToOutputAsync_succeeds)
{
    ...
    STRICT_EXPECTED_CALL(IoTHubMessage_SetOutputName(IGNORED_ARG, IGNORED_ARG));
    setup_IoTHubClientCore_LL_sendeventasync_mocks(false);
...
static void setup_IoTHubClientCore_LL_SetInputMessageCallback_after_first_invocation_mocks(bool alreadyInList, int depthInList, const char *lastItemInputName)
{
    ...
    while (depthInList > 0)
    {
        ...
        STRICT_EXPECTED_CALL(STRING_c_str(IGNORED_ARG)).SetReturn((depthInList == 1) ? lastItemInputName : TEST_STRING_VALUE);
        depthInList--;
    }
...
static void setup_IoTHubClientCore_LL_SetInputMessageCallback_callback_null(bool unsubscribeExpected, const char* input_name)
{
    ...
    {
        STRICT_EXPECTED_CALL(FAKE_IotHubTransport_Unsubscribe_InputQueue(IGNORED_ARG));
    }
}
...
TEST_FUNCTION(IoTHubClientCore_LL_SetInputMessageCallback_unregister_not_found_fails)
{
    ...
    STRICT_EXPECTED_CALL(STRING_c_str(IGNORED_ARG)).SetReturn(TEST_INPUT_NAME2);
    STRICT_EXPECTED_CALL(singlylinkedlist_item_get_value(IGNORED_ARG));
    STRICT_EXPECTED_CALL(STRING_c_str(IGNORED_ARG)).SetReturn(TEST_INPUT_NAME3);
...
TEST_FUNCTION(IoTHubClientCore_LL_SetInputMessageCallback_one_item_fail)
{
    ...
    STRICT_EXPECTED_CALL(singlylinkedlist_create());
    STRICT_EXPECTED_CALL(singlylinkedlist_find(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG)).CallCannotFail();
    STRICT_EXPECTED_CALL(gballoc_malloc(IGNORED_ARG));
...
TEST_FUNCTION(IoTHubClientCore_LL_MessageCallbackFromInput_match_succeeds)
{
    ...
    STRICT_EXPECTED_CALL(IoTHubMessage_GetInputName(IGNORED_ARG));
    STRICT_EXPECTED_CALL(singlylinkedlist_find(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
    STRICT_EXPECTED_CALL(singlylinkedlist_item_get_value(IGNORED_ARG));
    STRICT_EXPECTED_CALL(STRING_c_str(IGNORED_ARG)).SetReturn(TEST_INPUT_NAME);
...
TEST_FUNCTION(IoTHubClientCore_LL_MessageCallbackFromInput_no_match_one_item_in_list_fails)
{
    ...
    STRICT_EXPECTED_CALL(IoTHubMessage_GetInputName(IGNORED_ARG)).SetReturn(TEST_INPUT_NAME_NOTFOUND);
...
TEST_FUNCTION(IoTHubClientCore_LL_MessageCallbackFromInput_match_with_multiple_item_in_list_succeeds)
{
    ...
    STRICT_EXPECTED_CALL(IoTHubMessage_GetInputName(IGNORED_ARG)).SetReturn(TEST_INPUT_NAME3);
...
TEST_FUNCTION(IoTHubClientCore_LL_MessageCallbackFromInput_default_handler_no_match_on_registered_inputs_succeeds)
{
    ...
    STRICT_EXPECTED_CALL(singlylinkedlist_find(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
    STRICT_EXPECTED_CALL(singlylinkedlist_item_get_value(IGNORED_ARG));
    STRICT_EXPECTED_CALL(STRING_c_str(IGNORED_ARG)).SetReturn(TEST_INPUT_NAME_NOTFOUND);
    STRICT_EXPECTED_CALL(singlylinkedlist_item_get_value(IGNORED_ARG));
    STRICT_EXPECTED_CALL(STRING_c_str(IGNORED_ARG)).SetReturn(NULL);
...
TEST_FUNCTION(IoTHubClientCore_LL_MessageCallbackFromInput_default_handler_ex_no_match_on_registered_inputs_succeeds)
{
    ...
    STRICT_EXPECTED_CALL(singlylinkedlist_item_get_value(IGNORED_ARG));
    STRICT_EXPECTED_CALL(get_time(NULL));
    STRICT_EXPECTED_CALL(messageInputCallbackEx(TEST_MESSAGE_HANDLE, IGNORED_ARG));
...
TEST_FUNCTION(IoTHubClientCore_LL_MessageCallbackFromInput_match_fail)
{
    ...
    STRICT_EXPECTED_CALL(FAKE_IoTHubTransport_SendMessageDisposition(IGNORED_ARG, TEST_MESSAGE_HANDLE, IOTHUBMESSAGE_ACCEPTED)).CallCannotFail();
...
TEST_FUNCTION(IoTHubClientCore_LL_ParseMethodToCommand_NULL_method_name)
{
    //arrange
    ...
    ASSERT_ARE_EQUAL(IOTHUB_CLIENT_RESULT, IOTHUB_CLIENT_INVALID_ARG, result);
    ASSERT_ARE_EQUAL(char_ptr, umock_c_get_expected_calls(), umock_c_get_actual_calls());
    ASSERT_IS_NULL(componentName);
    ASSERT_IS_NULL(commandName);
}

static void set_expected_calls_for_IoTHubClientCore_LL_ParseMethodToCommand_when_component_set()
{
    STRICT_EXPECTED_CALL(gballoc_malloc(IGNORED_ARG));
}
...
TEST_FUNCTION(IoTHubClientCore_LL_ParseMethodToCommand_NULL_command_name)
{
    //arrange
    char* componentName = NULL;

    //act
    IOTHUB_CLIENT_RESULT result = IoTHubClientCore_LL_ParseMethodToCommand(TEST_METHOD_NAME, &componentName, NULL);
...
TEST_FUNCTION(IoTHubClientCore_LL_ParseMethodToCommand_no_component_specified)
{
    ...
    //act
    IOTHUB_CLIENT_RESULT result = IoTHubClientCore_LL_ParseMethodToCommand(TEST_METHOD_NAME, &componentName, &commandName);

    //assert
    ASSERT_ARE_EQUAL(IOTHUB_CLIENT_RESULT, IOTHUB_CLIENT_OK, result);
    ASSERT_ARE_EQUAL(char_ptr, umock_c_get_expected_calls(), umock_c_get_actual_calls());
    ASSERT_IS_NULL(componentName);
    ASSERT_ARE_EQUAL(char_ptr, TEST_METHOD_NAME, commandName);  
}
...
TEST_FUNCTION(IoTHubClientCore_LL_ParseMethodToCommand_component_specified)
{
    ...
    //act
    IOTHUB_CLIENT_RESULT result = IoTHubClientCore_LL_ParseMethodToCommand(TEST_METHOD_NAME_WITH_COMPONENT, &componentName, &commandName);

    //assert
    ASSERT_ARE_EQUAL(IOTHUB_CLIENT_RESULT, IOTHUB_CLIENT_OK, result);
    ASSERT_ARE_EQUAL(char_ptr, umock_c_get_expected_calls(), umock_c_get_actual_calls());
    ASSERT_ARE_EQUAL(char_ptr, TEST_COMPONENT_NAME, componentName);
    ASSERT_ARE_EQUAL(char_ptr, TEST_METHOD_NAME, commandName);
...
TEST_FUNCTION(IoTHubClientCore_LL_SubscribeToCommands_with_NULL_iotHubClientHandle_fails)
{
    ...
    ///act
    IOTHUB_CLIENT_RESULT result = IoTHubClientCore_LL_SubscribeToCommands(NULL, commandCallback, (void*)1);
...
TEST_FUNCTION(IoTHubClientCore_LL_SubscribeToCommands_with_NULL_callback_Unsubscribe_and_succeeds)
{
    ///arrange
    IOTHUB_CLIENT_CORE_LL_HANDLE handle = IoTHubClientCore_LL_Create(&TEST_CONFIG);
    (void)IoTHubClientCore_LL_SubscribeToCommands(handle, commandCallback, (void*)1);
    umock_c_reset_all_calls();
    ...
    ///act
    IOTHUB_CLIENT_RESULT result = IoTHubClientCore_LL_SubscribeToCommands(handle, NULL, (void*)1);
...
TEST_FUNCTION(IoTHubClientCore_LL_SubscribeToCommands_with_NULL_callback_Unsubscribe_After_SetDeviceMethodCallback_Ex_fail)
{
    ///arrange
    IOTHUB_CLIENT_CORE_LL_HANDLE handle = IoTHubClientCore_LL_Create(&TEST_CONFIG);
    (void)IoTHubClientCore_LL_SetDeviceMethodCallback_Ex(handle, iothub_client_inbound_device_method_callback, (void*)1);
...
TEST_FUNCTION(IoTHubClientCore_LL_SubscribeToCommands_unitialized_with_NULL_callback_fails)
{
    ///arrange
    IOTHUB_CLIENT_CORE_LL_HANDLE handle = IoTHubClientCore_LL_Create(&TEST_CONFIG);
    (void)IoTHubClientCore_LL_SubscribeToCommands(NULL, commandCallback, (void*)1);
    umock_c_reset_all_calls();
...
TEST_FUNCTION(IoTHubClientCore_LL_SubscribeToCommands_with_non_NULL_succeeds)
{
    ///arrange
    IOTHUB_CLIENT_CORE_LL_HANDLE handle = IoTHubClientCore_LL_Create(&TEST_CONFIG);
    umock_c_reset_all_calls();
    ...
    ///act
    IOTHUB_CLIENT_RESULT result = IoTHubClientCore_LL_SubscribeToCommands(handle, commandCallback, (void*)1);
...
TEST_FUNCTION(IoTHubClientCore_LL_SubscribeToCommands_After_SetDeviceMethodCallback_Ex_fail)
{
    ///arrange
    IOTHUB_CLIENT_CORE_LL_HANDLE handle = IoTHubClientCore_LL_Create(&TEST_CONFIG);
    (void)IoTHubClientCore_LL_SetDeviceMethodCallback_Ex(handle, iothub_client_inbound_device_method_callback, (void*)1);
...
TEST_FUNCTION(IoTHubClientCore_LL_SubscribeToCommands_fails_when_underlying_transport_fails)
{
    ///arrange
    IOTHUB_CLIENT_CORE_LL_HANDLE handle = IoTHubClientCore_LL_Create(&TEST_CONFIG);
    umock_c_reset_all_calls();
...
TEST_FUNCTION(IoTHubClientCore_LL_CommandComplete_no_component_succeed)
{
    //arrange
    IOTHUB_CLIENT_CORE_LL_HANDLE h = IoTHubClientCore_LL_Create(&TEST_CONFIG);
    IOTHUB_CLIENT_RESULT result = IoTHubClientCore_LL_SubscribeToCommands(h, commandCallback, (void*)TEST_COMMAND_CALLBACK_CONTEXT);
    ASSERT_ARE_EQUAL(IOTHUB_CLIENT_RESULT, IOTHUB_CLIENT_OK, result);
    ...
    STRICT_EXPECTED_CALL(commandCallback(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG))
...
TEST_FUNCTION(IoTHubClientCore_LL_CommandComplete_with_component_succeed)
{
    ...
    //act
    int status = g_transport_cb_info.method_complete_cb(TEST_METHOD_NAME_WITH_COMPONENT, (const unsigned char*)TEST_STRING_VALUE, strlen(TEST_STRING_VALUE), TEST_METHOD_ID, h);
...
TEST_FUNCTION(IoTHubClientCore_LL_CommandComplete_payload_NULL_succeed)
{
    //arrange
    IOTHUB_CLIENT_CORE_LL_HANDLE h = IoTHubClientCore_LL_Create(&TEST_CONFIG);
    IOTHUB_CLIENT_RESULT result = IoTHubClientCore_LL_SubscribeToCommands(h, commandCallback, (void*)TEST_COMMAND_CALLBACK_CONTEXT);
...
{
    STRICT_EXPECTED_CALL(environment_get_variable(IGNORED_ARG)).SetReturn(NULL).CallCannotFail(); // don't failure test this path for HSM specifically.
    STRICT_EXPECTED_CALL(environment_get_variable(IGNORED_ARG)).SetReturn(TEST_SAS_TOKEN_AUTH);
    STRICT_EXPECTED_CALL(environment_get_variable(IGNORED_ARG)).SetReturn(TEST_VAR_DEVICEID);
    STRICT_EXPECTED_CALL(environment_get_variable(IGNORED_ARG)).SetReturn(TEST_VAR_EDGEHOSTNAME);
    STRICT_EXPECTED_CALL(environment_get_variable(IGNORED_ARG)).SetReturn(TEST_VAR_EDGEGATEWAYHOST);
    STRICT_EXPECTED_CALL(environment_get_variable(IGNORED_ARG)).SetReturn(TEST_VAR_MODULEID);
    ...
    STRICT_EXPECTED_CALL(FAKE_IoTHubTransport_SetOption(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
#ifndef DONT_USE_UPLOADTOBLOB
    STRICT_EXPECTED_CALL(IoTHubClient_LL_UploadToBlob_SetOption(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG)).CallCannotFail();
#endif
...
{
    STRICT_EXPECTED_CALL(environment_get_variable(IGNORED_ARG)).SetReturn(TEST_EDGEHUB_CONNECTIONSTRING);
    STRICT_EXPECTED_CALL(environment_get_variable(IGNORED_ARG)).SetReturn(TEST_EDGEHUB_CACERTIFICATEFILE);
...
{
    //arrange
    STRICT_EXPECTED_CALL(environment_get_variable(IGNORED_ARG)).SetReturn(NULL);
    STRICT_EXPECTED_CALL(environment_get_variable(IGNORED_ARG)).SetReturn(NULL);
    STRICT_EXPECTED_CALL(gballoc_free(IGNORED_ARG));
