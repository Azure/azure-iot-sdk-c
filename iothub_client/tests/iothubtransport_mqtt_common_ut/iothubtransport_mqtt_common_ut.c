...
char* my_IoTHubClient_Auth_Get_SasToken(IOTHUB_AUTHORIZATION_HANDLE handle, const char* scope, size_t expire_time)
{
    (void)handle;
    (void)scope;
    (void)expire_time;
...
static void setup_message_recv_with_properties_mocks(bool has_content_type, bool has_content_encoding)
{
    ...
    if (has_content_type)
    {
        ...
        STRICT_EXPECTED_CALL(malloc(IGNORED_NUM_ARG));
        STRICT_EXPECTED_CALL(IoTHubMessage_SetCustomContentType(IGNORED_PTR_ARG, IGNORED_PTR_ARG));
    ...
    if (has_content_encoding)
    {
        ...
        STRICT_EXPECTED_CALL(malloc(IGNORED_NUM_ARG));
        STRICT_EXPECTED_CALL(malloc(IGNORED_NUM_ARG));
        STRICT_EXPECTED_CALL(IoTHubMessage_SetContentEncoding(IGNORED_PTR_ARG, IGNORED_PTR_ARG));
        STRICT_EXPECTED_CALL(free(IGNORED_NUM_ARG));
        STRICT_EXPECTED_CALL(free(IGNORED_NUM_ARG));
    }
    ...
    const char* content_encoding)
{
    ...
    STRICT_EXPECTED_CALL(IoTHubMessage_GetCustomContentType(IGNORED_PTR_ARG)).SetReturn(content_type);
    STRICT_EXPECTED_CALL(IoTHubMessage_GetContentEncoding(IGNORED_PTR_ARG)).SetReturn(content_encoding);
    EXPECTED_CALL(STRING_c_str(IGNORED_PTR_ARG));
...
TEST_FUNCTION(IoTHubTransport_MQTT_Common_DoWork_with_1_event_item_succeeds)
{
    ...
    setup_IoTHubTransport_MQTT_Common_DoWork_events_mocks(NULL, NULL, 0, TEST_IOTHUB_MSG_BYTEARRAY, false, NULL, NULL, NULL, NULL);
...
TEST_FUNCTION(IoTHubTransport_MQTT_Common_DoWork_with_1_event_item_with_properties_succeeds)
{
    ...
    setup_IoTHubTransport_MQTT_Common_DoWork_events_mocks((const char* const**)&keys, (const char* const**)&values, propCount, TEST_IOTHUB_MSG_BYTEARRAY, false, NULL, NULL, NULL, NULL);
...
TEST_FUNCTION(IoTHubTransport_MQTT_Common_DoWork_resend_message_succeeds)
{
    ...
    setup_IoTHubTransport_MQTT_Common_DoWork_events_mocks(NULL, NULL, 0, TEST_IOTHUB_MSG_STRING, true, NULL, NULL, NULL, NULL);
...
TEST_FUNCTION(IoTHubTransport_MQTT_Common_DoWork_2_message_timeout_succeeds)
{
    ...
    STRICT_EXPECTED_CALL(IoTHubMessage_GetCustomContentType(IGNORED_PTR_ARG));
    STRICT_EXPECTED_CALL(IoTHubMessage_GetContentEncoding(IGNORED_PTR_ARG));
    STRICT_EXPECTED_CALL(STRING_c_str(IGNORED_PTR_ARG));
...
TEST_FUNCTION(IoTHubTransport_MQTT_Common_DoWork_with_1_event_item_STRING_type_succeeds)
{
    ...
    setup_IoTHubTransport_MQTT_Common_DoWork_events_mocks(NULL, NULL, 0, TEST_IOTHUB_MSG_STRING, false, NULL, NULL, NULL, NULL);
...
TEST_FUNCTION(IoTHubTransport_MQTT_Common_DoWork_with_message_system_properties_succeeds)
{
    ...
    setup_IoTHubTransport_MQTT_Common_DoWork_events_mocks(NULL, NULL, 0, TEST_IOTHUB_MSG_STRING, false, "msg_id", "core_id", TEST_CONTENT_TYPE, TEST_CONTENT_ENCODING);
...
TEST_FUNCTION(IoTHubTransport_MQTT_Common_DoWork_mqtt_client_connect_times_out)
{
    ...
    g_current_ms += 4 * 60 * 1000 + 1; // 4+ minutes have passed.
