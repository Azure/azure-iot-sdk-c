...
static IOTHUB_CLIENT_RESULT my_IoTHubClientCore_LL_GetDeviceTwinAsync(IOTHUB_CLIENT_CORE_LL_HANDLE iotHubClientHandle, IOTHUB_CLIENT_DEVICE_TWIN_CALLBACK deviceTwinCallback, void* userContextCallback)
{
    (void)iotHubClientHandle;
    g_deviceTwinCallback = deviceTwinCallback;
    g_userContextCallback = userContextCallback;
...
TEST_SUITE_INITIALIZE(suite_init)
{
    ...
    REGISTER_GLOBAL_MOCK_HOOK(IoTHubClientCore_LL_GetDeviceTwinAsync, my_IoTHubClientCore_LL_GetDeviceTwinAsync);
    REGISTER_GLOBAL_MOCK_FAIL_RETURN(IoTHubClientCore_LL_GetDeviceTwinAsync, IOTHUB_CLIENT_ERROR);
...
// Tests_SRS_IOTHUBCLIENT_09_012: [ `IoTHubClientCore_GetDeviceTwinAsync` shall be made thread-safe by using the lock created in IoTHubClient_Create. ]
// Tests_SRS_IOTHUBCLIENT_09_014: [ `IoTHubClientCore_GetDeviceTwinAsync` shall call `IoTHubClientCore_LL_GetDeviceTwinAsync`, passing the `IoTHubClient_LL handle`, `deviceTwinCallback` and `userContextCallback` as arguments ]
// Tests_SRS_IOTHUBCLIENT_09_015: [ When `IoTHubClientCore_LL_GetDeviceTwinAsync` is called, `IoTHubClientCore_GetDeviceTwinAsync` shall return the result of `IoTHubClientCore_LL_GetDeviceTwinAsync`. ]
TEST_FUNCTION(IoTHubClientCore_GetDeviceTwinAsync_succeed)
{
    // arrange
    IOTHUB_CLIENT_CORE_HANDLE iothub_handle = IoTHubClientCore_Create(TEST_CLIENT_CONFIG);
    ...
    STRICT_EXPECTED_CALL(gballoc_malloc(IGNORED_NUM_ARG));
    STRICT_EXPECTED_CALL(Lock(IGNORED_PTR_ARG));
    STRICT_EXPECTED_CALL(IoTHubClientCore_LL_GetDeviceTwinAsync(TEST_IOTHUB_CLIENT_CORE_LL_HANDLE, IGNORED_PTR_ARG, IGNORED_PTR_ARG));
    STRICT_EXPECTED_CALL(Unlock(IGNORED_PTR_ARG))
        .CallCannotFail();

    // act
    IOTHUB_CLIENT_RESULT result = IoTHubClientCore_GetDeviceTwinAsync(iothub_handle, test_device_twin_callback, NULL);
...
// Tests_SRS_IOTHUBCLIENT_09_009: [ If `iotHubClientHandle` or `deviceTwinCallback` are `NULL`, `IoTHubClientCore_GetDeviceTwinAsync` shall return `IOTHUB_CLIENT_INVALID_ARG`. ]
TEST_FUNCTION(IoTHubClientCore_GetDeviceTwinAsync_NULL_handle_fail)
{
    // arrange
    umock_c_reset_all_calls();

    // act
    IOTHUB_CLIENT_RESULT result = IoTHubClientCore_GetDeviceTwinAsync(NULL, test_device_twin_callback, NULL);
...
// Tests_SRS_IOTHUBCLIENT_09_009: [ If `iotHubClientHandle` or `deviceTwinCallback` are `NULL`, `IoTHubClientCore_GetDeviceTwinAsync` shall return `IOTHUB_CLIENT_INVALID_ARG`. ]
TEST_FUNCTION(IoTHubClientCore_GetDeviceTwinAsync_NULL_callback_fail)
{
    // arrange
    IOTHUB_CLIENT_CORE_HANDLE iothub_handle = IoTHubClientCore_Create(TEST_CLIENT_CONFIG);
    ...
    // act
    IOTHUB_CLIENT_RESULT result = IoTHubClientCore_GetDeviceTwinAsync(iothub_handle, NULL, NULL);
...
// Tests_SRS_IOTHUBCLIENT_09_013: [ If acquiring the lock fails, `IoTHubClientCore_GetDeviceTwinAsync` shall return `IOTHUB_CLIENT_ERROR`. ]
TEST_FUNCTION(IoTHubClientCore_GetDeviceTwinAsync_fail)
{
    // arrange
...
// Tests_SRS_IOTHUBCLIENT_09_011: [ If starting the thread fails, `IoTHubClientCore_GetDeviceTwinAsync` shall return `IOTHUB_CLIENT_ERROR`. ]
TEST_FUNCTION(IoTHubClientCore_GetDeviceTwinAsync_startWorkerThread_fail)
{
    // arrange
    ASSERT_ARE_EQUAL(int, 0, umock_c_negative_tests_init());
