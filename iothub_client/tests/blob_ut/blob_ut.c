...
TEST_FUNCTION(Blob_PutBlock_happy_path_succeeds)
{
    ...
    umock_c_reset_all_calls();
    STRICT_EXPECTED_CALL(Azure_Base64_Encode_Bytes(IGNORED_ARG, 6));
    ...
    STRICT_EXPECTED_CALL(HTTPAPIEX_ExecuteRequest(
        TEST_HTTPAPIEX_HANDLE, HTTPAPI_REQUEST_PUT, IGNORED_ARG, IGNORED_ARG, blockData, IGNORED_ARG, IGNORED_ARG, responseContent))
...
TEST_FUNCTION(Blob_PutBlock_NULL_response_status_succeeds)
{
    ...
    STRICT_EXPECTED_CALL(STRING_c_str(IGNORED_ARG))
        .CallCannotFail();
    STRICT_EXPECTED_CALL(HTTPAPIEX_ExecuteRequest(
        TEST_HTTPAPIEX_HANDLE, HTTPAPI_REQUEST_PUT, IGNORED_ARG, IGNORED_ARG, blockData, NULL, IGNORED_ARG, responseContent))
        .CopyOutArgumentBuffer_statusCode(&HTTP_STATUS_200, sizeof(unsigned int));
    STRICT_EXPECTED_CALL(STRING_delete(IGNORED_ARG));
...
TEST_FUNCTION(Blob_PutBlock_failure_checks)
{
    ...
    STRICT_EXPECTED_CALL(STRING_c_str(IGNORED_ARG))
        .CallCannotFail();
    STRICT_EXPECTED_CALL(HTTPAPIEX_ExecuteRequest(
        TEST_HTTPAPIEX_HANDLE, HTTPAPI_REQUEST_PUT, IGNORED_ARG, IGNORED_ARG, blockData, &responseHttpStatus, IGNORED_ARG, responseContent));
    STRICT_EXPECTED_CALL(STRING_delete(IGNORED_ARG));
    umock_c_negative_tests_snapshot();
...
TEST_FUNCTION(Blob_PutBlockList_happy_path_succeeds)
{
    ...
    STRICT_EXPECTED_CALL(STRING_c_str(IGNORED_ARG));
    STRICT_EXPECTED_CALL(HTTPAPIEX_ExecuteRequest(
        TEST_HTTPAPIEX_HANDLE, HTTPAPI_REQUEST_PUT, IGNORED_ARG, IGNORED_ARG, IGNORED_ARG, IGNORED_ARG, IGNORED_ARG, responseContent))
        .CopyOutArgumentBuffer_statusCode(&HTTP_STATUS_200, sizeof(unsigned int));
    STRICT_EXPECTED_CALL(singlylinkedlist_remove_if(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
...
TEST_FUNCTION(Blob_PutBlockList_failure_checks)
{
    ...
    STRICT_EXPECTED_CALL(STRING_c_str(IGNORED_ARG))
        .CallCannotFail();
    STRICT_EXPECTED_CALL(HTTPAPIEX_ExecuteRequest(
        TEST_HTTPAPIEX_HANDLE, HTTPAPI_REQUEST_PUT, IGNORED_ARG, IGNORED_ARG, IGNORED_ARG, &responseHttpStatus, IGNORED_ARG, responseContent));
    STRICT_EXPECTED_CALL(singlylinkedlist_remove_if(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG))
        .CallCannotFail();
    STRICT_EXPECTED_CALL(BUFFER_delete(IGNORED_ARG));
    STRICT_EXPECTED_CALL(STRING_delete(IGNORED_ARG));
...
TEST_FUNCTION(Blob_PutBlockList_no_response_content_succeeds)
{
    ...
    STRICT_EXPECTED_CALL(STRING_c_str(IGNORED_ARG));
    STRICT_EXPECTED_CALL(HTTPAPIEX_ExecuteRequest(
        TEST_HTTPAPIEX_HANDLE, HTTPAPI_REQUEST_PUT, IGNORED_ARG, IGNORED_ARG, IGNORED_ARG, IGNORED_ARG, IGNORED_ARG, NULL))
        .CopyOutArgumentBuffer_statusCode(&HTTP_STATUS_200, sizeof(unsigned int));
    STRICT_EXPECTED_CALL(singlylinkedlist_remove_if(IGNORED_ARG, IGNORED_ARG, IGNORED_ARG));
    STRICT_EXPECTED_CALL(BUFFER_delete(IGNORED_ARG));
    STRICT_EXPECTED_CALL(STRING_delete(IGNORED_ARG));
