...
#define TEST_IOTHUB_SDK_VERSION "1.1.30"
...
/*Tests_SRS_IOTHUBCLIENT_LL_99_009: [ If step 2 is aborted by the client and if step 3 succeeds, then `IoTHubClient_LL_UploadMultipleBlocksToBlob` shall return `IOTHUB_CLIENT_OK`. ]*/
