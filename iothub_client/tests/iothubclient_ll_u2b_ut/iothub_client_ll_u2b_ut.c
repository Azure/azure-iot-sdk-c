...
#define TEST_IOTHUB_SDK_VERSION "1.1.24"
...
/****************************************************************************/
/*   tests LARGE FILE interface                                             */
/****************************************************************************/

TEST_FUNCTION(IoTHubClient_LL_LargeFileOpen_Impl_fails_with_NULL_blobHandle)
{
    ///arrange
    const char* destinationFileName = "filename.txt";
    IOTHUB_CLIENT_LL_UPLOADTOBLOB_HANDLE h = NULL;
    umock_c_reset_all_calls();

    ///act
    IOTHUB_CLIENT_LARGE_FILE_HANDLE largeFileHandle = IoTHubClient_LL_LargeFileOpen_Impl(h, destinationFileName);

    ///assert
    ASSERT_ARE_EQUAL(char_ptr, umock_c_get_expected_calls(), umock_c_get_actual_calls());
    ASSERT_IS_NULL(largeFileHandle);

    ///cleanup
}

TEST_FUNCTION(IoTHubClient_LL_LargeFileOpen_Impl_fails_with_NULL_filename)
{
    ///arrange
    const char* destinationFileName = NULL;
    IOTHUB_CLIENT_LL_UPLOADTOBLOB_HANDLE h = IoTHubClient_LL_UploadToBlob_Create(&TEST_CONFIG_SAS);
    umock_c_reset_all_calls();
...
TEST_FUNCTION(IoTHubClient_LL_LargeFileOpen_Impl_SAS_token_happypath)
{
    ///arrange
    IOTHUB_CLIENT_LL_UPLOADTOBLOB_HANDLE h = IoTHubClient_LL_UploadToBlob_Create(&TEST_CONFIG_SAS);
    umock_c_reset_all_calls();
    ...
    ///assert
    ASSERT_ARE_EQUAL(char_ptr, umock_c_get_expected_calls(), umock_c_get_actual_calls());
    ASSERT_IS_NOT_NULL(largeFileHandle);
...
TEST_FUNCTION(IoTHubClient_LL_LargeFileOpen_Impl_SAS_token_with_certificates_happypath)
{
    ///arrange
    IOTHUB_CLIENT_LL_UPLOADTOBLOB_HANDLE h = IoTHubClient_LL_UploadToBlob_Create(&TEST_CONFIG_SAS);
    (void)IoTHubClient_LL_UploadToBlob_SetOption(h, "TrustedCerts", "some certificates");
...
TEST_FUNCTION(IoTHubClient_LL_LargeFileOpen_Impl_SAS_token_unhappypaths)
{
    size_t calls_that_cannot_fail[] =
    {
        13  ,/*STRING_length*/
    ...
    HTTP_HEADERS_HANDLE iotHubHttpRequestHeaders1;
    STRICT_EXPECTED_CALL(HTTPHeaders_Alloc()) /* 5*/
        .CaptureReturn(&iotHubHttpRequestHeaders1);

    {
        ...
        STRING_HANDLE blobJson;
        STRICT_EXPECTED_CALL(STRING_construct("{ \"blobName\": \"")) /* 10 */
            .CaptureReturn(&blobJson);
        STRICT_EXPECTED_CALL(STRING_concat(blobJson, IGNORED_PTR_ARG))
            .IgnoreArgument(1)
            .IgnoreArgument(2);
        STRICT_EXPECTED_CALL(STRING_concat(blobJson, "\" }"))
            .IgnoreArgument(1);
        STRICT_EXPECTED_CALL(STRING_length(blobJson)) /* 13 */
            .IgnoreArgument(1);
        STRICT_EXPECTED_CALL(STRING_c_str(blobJson)) /* 14 */
            .IgnoreArgument(1);

        BUFFER_HANDLE jsonBuffer;
        STRICT_EXPECTED_CALL(BUFFER_create(IGNORED_PTR_ARG, IGNORED_NUM_ARG)) /* 15 */
            .IgnoreArgument_source()
            .IgnoreArgument_size()
            .CaptureReturn(&jsonBuffer);
        ...
        STRICT_EXPECTED_CALL(HTTPHeaders_AddHeaderNameValuePair(iotHubHttpRequestHeaders1, "User-Agent", "iothubclient/" TEST_IOTHUB_SDK_VERSION))
            .IgnoreArgument(1);
        STRICT_EXPECTED_CALL(HTTPHeaders_AddHeaderNameValuePair(iotHubHttpRequestHeaders1, "Authorization", "")) /* 20 */
            .IgnoreArgument(1);
        ...
        const char* iotHubHttpRelativePath1_as_const_char = TEST_DEFAULT_STRING_VALUE;
        STRICT_EXPECTED_CALL(STRING_c_str(iotHubHttpRelativePath1)) /* 23 */
            .CaptureReturn(&iotHubHttpRelativePath1_as_const_char)
            .IgnoreArgument(1);
        ...
        unsigned char* iotHubHttpMessageBodyResponse1_unsigned_char = (unsigned char*)TEST_DEFAULT_STRING_VALUE;
        size_t iotHubHttpMessageBodyResponse1_size;
        STRICT_EXPECTED_CALL(BUFFER_u_char(iotHubHttpMessageBodyResponse1)) /* 25 */
            .CaptureReturn(&iotHubHttpMessageBodyResponse1_unsigned_char)
            .IgnoreArgument(1);
        STRICT_EXPECTED_CALL(BUFFER_length(iotHubHttpMessageBodyResponse1)) /* 26 */
            .CaptureReturn(&iotHubHttpMessageBodyResponse1_size)
            .IgnoreArgument(1);
        ...
        const char* iotHubHttpMessageBodyResponse1_as_const_char = TEST_DEFAULT_STRING_VALUE;
        STRICT_EXPECTED_CALL(STRING_c_str(iotHubHttpMessageBodyResponse1_as_STRING_HANDLE)) /* 28 */
            .CaptureReturn(&iotHubHttpMessageBodyResponse1_as_const_char)
            .IgnoreArgument(1);
        ...
        JSON_Object* jsonObject;
        STRICT_EXPECTED_CALL(json_value_get_object(allJson)) /* 30 */
            .CaptureReturn(&jsonObject)
            .IgnoreArgument(1);
        ...
        const char* json_blobName = TEST_DEFAULT_STRING_VALUE;
        STRICT_EXPECTED_CALL(json_object_get_string(jsonObject, "blobName")) /* 35 */
            .CaptureReturn(&json_blobName)
            .IgnoreArgument(1);
    ...
    for (size_t i = 0; i < umock_c_negative_tests_call_count(); i++)
    {
        ...
        if (j == sizeof(calls_that_cannot_fail) / sizeof(calls_that_cannot_fail[0]))
        {
            ...
            ///assert
            ASSERT_IS_NULL_WITH_MSG(largeFileHandle, temp_str);
        }
    }
...
TEST_FUNCTION(IoTHubClient_LL_LargeFileOpen_Impl_device_key_happypath)
{
    ///arrange
    IOTHUB_CLIENT_LL_UPLOADTOBLOB_HANDLE h = IoTHubClient_LL_UploadToBlob_Create(&TEST_CONFIG_DEVICE_KEY);
    umock_c_reset_all_calls();
...
TEST_FUNCTION(IoTHubClient_LL_LargeFileOpen_Impl_device_key_unhappypaths)
{
    size_t calls_that_cannot_fail[] =
    {
        13  ,/*STRING_length*/
...

    {
        ...
        STRICT_EXPECTED_CALL(HTTPAPIEX_SAS_Create(IGNORED_PTR_ARG, IGNORED_PTR_ARG, IGNORED_PTR_ARG))
            .IgnoreAllArguments();
        STRICT_EXPECTED_CALL(STRING_c_str(IGNORED_PTR_ARG)) /* 26 */
            .IgnoreArgument_handle();
        STRICT_EXPECTED_CALL(HTTPAPIEX_SAS_ExecuteRequest(
            IGNORED_PTR_ARG,
            IGNORED_PTR_ARG,
            ...
            .IgnoreArgument(6)
            ;
        STRICT_EXPECTED_CALL(HTTPAPIEX_SAS_Destroy(IGNORED_PTR_ARG)) /* 28 */
            .IgnoreArgument_handle();
        STRICT_EXPECTED_CALL(STRING_delete(IGNORED_PTR_ARG)) /*the empty STRING_new*/ /* 29 */
            .IgnoreArgument_handle();
        STRICT_EXPECTED_CALL(STRING_delete(IGNORED_PTR_ARG)) /*the build the path that the SAS token authenticates*/ /* 30 */
            .IgnoreArgument_handle();

        unsigned char* iotHubHttpMessageBodyResponse1_unsigned_char = (unsigned char*)TEST_DEFAULT_STRING_VALUE;
        size_t iotHubHttpMessageBodyResponse1_size;
        STRICT_EXPECTED_CALL(BUFFER_u_char(iotHubHttpMessageBodyResponse1)) /* 31 */
            .CaptureReturn(&iotHubHttpMessageBodyResponse1_unsigned_char)
            .IgnoreArgument(1);
        STRICT_EXPECTED_CALL(BUFFER_length(iotHubHttpMessageBodyResponse1)) /* 32 */
            .CaptureReturn(&iotHubHttpMessageBodyResponse1_size)
            .IgnoreArgument(1);
        ...
        const char* iotHubHttpMessageBodyResponse1_as_const_char = TEST_DEFAULT_STRING_VALUE;
        STRICT_EXPECTED_CALL(STRING_c_str(iotHubHttpMessageBodyResponse1_as_STRING_HANDLE)) /* 34 */
            .CaptureReturn(&iotHubHttpMessageBodyResponse1_as_const_char)
            .IgnoreArgument(1);
        ...
        const char* json_containerName = TEST_DEFAULT_STRING_VALUE;
        STRICT_EXPECTED_CALL(json_object_get_string(jsonObject, "containerName")) /* 40 */
            .CaptureReturn(&json_containerName)
            .IgnoreArgument(1);
...
TEST_FUNCTION(IoTHubClient_LL_LargeFileOpen_Impl_X509_happypath)
{
    ///arrange
    IOTHUB_CLIENT_LL_UPLOADTOBLOB_HANDLE h = IoTHubClient_LL_UploadToBlob_Create(&TEST_CONFIG_X509);
    umock_c_reset_all_calls();
...
TEST_FUNCTION(IoTHubClient_LL_LargeFileOpen_Impl_X509_unhappypaths)
{
    size_t calls_that_cannot_fail[] =
    {
        15  ,/*STRING_length*/
    ...
    STRING_HANDLE correlationId;
    STRICT_EXPECTED_CALL(STRING_new()) /* 5 */
        .CaptureReturn(&correlationId);
...

    {
        ...
        STRICT_EXPECTED_CALL(STRING_concat(iotHubHttpRelativePath1, "/files")) /* 10 */
            .IgnoreArgument(1);
        STRICT_EXPECTED_CALL(STRING_concat(iotHubHttpRelativePath1, TEST_API_VERSION))
            .IgnoreArgument(1);
        ...
        STRICT_EXPECTED_CALL(STRING_concat(blobJson, "\" }"))
            .IgnoreArgument(1);
        STRICT_EXPECTED_CALL(STRING_length(blobJson)) /* 15 */
            .IgnoreArgument(1);
        STRICT_EXPECTED_CALL(STRING_c_str(blobJson)) /* 16 */
            .IgnoreArgument(1);
        ...
        STRICT_EXPECTED_CALL(HTTPHeaders_AddHeaderNameValuePair(iotHubHttpRequestHeaders1, "Content-Type", "application/json"))
            .IgnoreArgument(1);
        STRICT_EXPECTED_CALL(HTTPHeaders_AddHeaderNameValuePair(iotHubHttpRequestHeaders1, "Accept", "application/json")) /* 20 */
            .IgnoreArgument(1);
        STRICT_EXPECTED_CALL(HTTPHeaders_AddHeaderNameValuePair(iotHubHttpRequestHeaders1, "User-Agent", "iothubclient/" TEST_IOTHUB_SDK_VERSION))
            .IgnoreArgument(1);

        const char* iotHubHttpRelativePath1_as_const_char = TEST_DEFAULT_STRING_VALUE;
        STRICT_EXPECTED_CALL(STRING_c_str(iotHubHttpRelativePath1)) /* 22 */
            .CaptureReturn(&iotHubHttpRelativePath1_as_const_char)
            .IgnoreArgument(1);
        ...
        unsigned char* iotHubHttpMessageBodyResponse1_unsigned_char = (unsigned char*)TEST_DEFAULT_STRING_VALUE;
        size_t iotHubHttpMessageBodyResponse1_size;
        STRICT_EXPECTED_CALL(BUFFER_u_char(iotHubHttpMessageBodyResponse1)) /* 24 */
            .CaptureReturn(&iotHubHttpMessageBodyResponse1_unsigned_char)
            .IgnoreArgument(1);
        STRICT_EXPECTED_CALL(BUFFER_length(iotHubHttpMessageBodyResponse1)) /* 25 */
            .CaptureReturn(&iotHubHttpMessageBodyResponse1_size)
            .IgnoreArgument(1);
        ...
        const char* iotHubHttpMessageBodyResponse1_as_const_char = TEST_DEFAULT_STRING_VALUE;
        STRICT_EXPECTED_CALL(STRING_c_str(iotHubHttpMessageBodyResponse1_as_STRING_HANDLE)) /* 27 */
            .CaptureReturn(&iotHubHttpMessageBodyResponse1_as_const_char)
            .IgnoreArgument(1);
        ...
        const char* json_sasToken = TEST_DEFAULT_STRING_VALUE;
        STRICT_EXPECTED_CALL(json_object_get_string(jsonObject, "sasToken")) /* 35 */
            .CaptureReturn(&json_sasToken)
            .IgnoreArgument(1);
...
static IOTHUB_CLIENT_LARGE_FILE_HANDLE BuildLargeFileHandle(IOTHUB_CLIENT_LL_UPLOADTOBLOB_HANDLE h)
{
    umock_c_reset_all_calls();
    ...
    return largeFileHandle;
}

TEST_FUNCTION(IoTHubClient_LL_LargeFileWrite_Impl_invalid_source_size_fails)
{
    ///arrange
    IOTHUB_CLIENT_LL_UPLOADTOBLOB_HANDLE h = IoTHubClient_LL_UploadToBlob_Create(&TEST_CONFIG_SAS);
...
TEST_FUNCTION(IoTHubClient_LL_LargeFileWrite_Impl_invalid_handle_fails)
{
    ///arrange
    IOTHUB_CLIENT_LL_UPLOADTOBLOB_HANDLE h = IoTHubClient_LL_UploadToBlob_Create(&TEST_CONFIG_SAS);
    IOTHUB_CLIENT_LARGE_FILE_HANDLE largeFileHandle = BuildLargeFileHandle(h);
...
TEST_FUNCTION(IoTHubClient_LL_LargeFileClose_Impl_unhappypaths)
{
    size_t calls_that_cannot_fail[] =
    {
        3, /*STRING_c_str*/
        ...
        28,/*gballoc_free*/
        29,/*gballoc_free*/
        30,/*HTTPAPIEX_Destroy*/
        31,/*STRING_delete*/
        32,/*BUFFER_delete*/
        33,/*HTTPHeaders_Free*/
        34,/*STRING_delete*/
        35,/*HTTPAPIEX_Destroy*/
        36,/*Lock_Deinit*/
        37,/*STRING_delete*/
        38,/*gballoc_free*/
    };
    ...
    { /* Blob_UploadFromSasUri_stop */
        ...
        STRICT_EXPECTED_CALL(STRING_c_str(IGNORED_PTR_ARG)) /* 3 */ /*this is getting the XML as const char* so it can be passed to _ExecuteRequest*/
            .IgnoreArgument_handle();

        STRICT_EXPECTED_CALL(BUFFER_create(IGNORED_PTR_ARG, IGNORED_NUM_ARG)) /*this is creating the XML body as BUFFER_HANDLE*/
            .IgnoreAllArguments();

        STRICT_EXPECTED_CALL(STRING_c_str(IGNORED_PTR_ARG)) /* 5 */ /*this is getting the relative path*/
            .IgnoreArgument_handle();
        ...
        STRICT_EXPECTED_CALL(BUFFER_delete(IGNORED_PTR_ARG)) /* 7 */ /*This is the XML as BUFFER_HANDLE*/
            .IgnoreArgument_handle();
        STRICT_EXPECTED_CALL(STRING_delete(IGNORED_PTR_ARG)) /* 8 */ /*this is destroying the relative path for Put Block List*/
            .IgnoreArgument_handle();
    }

    { /*LARGE_FILE_upload_blob_stop*/
        STRICT_EXPECTED_CALL(BUFFER_u_char(IGNORED_PTR_ARG)) /* 9 */
            .IgnoreArgument_handle();

        STRICT_EXPECTED_CALL(gballoc_malloc(IGNORED_NUM_ARG))
            .IgnoreArgument_size();

        STRICT_EXPECTED_CALL(BUFFER_u_char(IGNORED_PTR_ARG)) /* 11 */
            .IgnoreArgument_handle();
        ...
        {/*step3*/
            ...
            const char* correlationId_as_char = TEST_DEFAULT_STRING_VALUE;
            STRICT_EXPECTED_CALL(STRING_c_str(IGNORED_PTR_ARG)) /* 20 */
                .CaptureReturn(&correlationId_as_char)
                .IgnoreArgument(1);
            STRICT_EXPECTED_CALL(STRING_concat(relativePathNotification, correlationId_as_char))
                .IgnoreArgument(1)
            ...
            const char* relativePathNotification_as_char = TEST_DEFAULT_STRING_VALUE;
            STRICT_EXPECTED_CALL(STRING_c_str(relativePathNotification)) /* 23 */
                .CaptureReturn(&relativePathNotification_as_char)
                .IgnoreArgument(1);

            STRICT_EXPECTED_CALL(HTTPAPIEX_ExecuteRequest(
                IGNORED_PTR_ARG, /*iotHubHttpApiExHandle */
                HTTPAPI_REQUEST_POST,
                relativePathNotification_as_char,
                IGNORED_PTR_ARG, /*iotHubHttpRequestHeaders1*/
                IGNORED_PTR_ARG,
                IGNORED_PTR_ARG,
                NULL,
                NULL
            ...
            STRICT_EXPECTED_CALL(STRING_delete(relativePathNotification)) /* 25 */
                .IgnoreArgument(1);
            STRICT_EXPECTED_CALL(STRING_delete(uriResource)) /* 26 */
                .IgnoreArgument(1);
        }
    ...
    /* Destroy_LargeFileHandle */
    STRICT_EXPECTED_CALL(gballoc_free(IGNORED_PTR_ARG)); /* 29 */
    ...
    STRICT_EXPECTED_CALL(STRING_delete(IGNORED_PTR_ARG));
    STRICT_EXPECTED_CALL(gballoc_free(IGNORED_PTR_ARG)); /* 38 */
