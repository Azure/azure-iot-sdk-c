...
static IOTHUB_CLIENT_PROPERTY_ACKNOWLEDGED_CALLBACK TEST_PROPERTY_ACKNOWLEDGED_CALLBACK = (IOTHUB_CLIENT_PROPERTY_ACKNOWLEDGED_CALLBACK)0x000A;
static IOTHUB_CLIENT_COMMAND_CALLBACK_ASYNC TEST_COMMAND_CALLBACK = (IOTHUB_CLIENT_COMMAND_CALLBACK_ASYNC)0x000B;
static IOTHUB_CLIENT_PROPERTIES_RECEIVED_CALLBACK TEST_PROPERTIES_RECEIVED_CALLBACK = (IOTHUB_CLIENT_PROPERTIES_RECEIVED_CALLBACK)0x000C;
...
TEST_FUNCTION(IoTHubModuleClient_SendTelemetryAsync_Test)
{
    ...
    //act
    IOTHUB_CLIENT_RESULT result = IoTHubModuleClient_SendTelemetryAsync(TEST_IOTHUB_MODULE_CLIENT_HANDLE, TEST_MESSAGE_HANDLE, TEST_EVENT_CONFIRMATION_CALLBACK, NULL);
...
TEST_FUNCTION(IoTHubModuleClient_SendPropertiesAsync_Test)
{
    ...
    //act
    IOTHUB_CLIENT_RESULT result = IoTHubModuleClient_SendPropertiesAsync(TEST_IOTHUB_MODULE_CLIENT_HANDLE, TEST_UNSIGNED_CHAR, TEST_SIZE_T, TEST_PROPERTY_ACKNOWLEDGED_CALLBACK, NULL);
...
TEST_FUNCTION(IoTHubModuleClient_SubscribeToCommands_Test)
{
    //arrange
    STRICT_EXPECTED_CALL(IoTHubClientCore_SubscribeToCommands(TEST_IOTHUB_CLIENT_CORE_HANDLE, TEST_COMMAND_CALLBACK, NULL));

    //act
    IOTHUB_CLIENT_RESULT result = IoTHubModuleClient_SubscribeToCommands(TEST_IOTHUB_MODULE_CLIENT_HANDLE, TEST_COMMAND_CALLBACK, NULL);
...
TEST_FUNCTION(IoTHubModuleClient_GetPropertiesAsync_Test)
{
    //arrange
    ...
    //act
    IOTHUB_CLIENT_RESULT result = IoTHubModuleClient_GetPropertiesAsync(TEST_IOTHUB_MODULE_CLIENT_HANDLE, TEST_PROPERTIES_RECEIVED_CALLBACK, NULL);
...
TEST_FUNCTION(IoTHubModuleClient_GetPropertiesAndSubscribeToUpdatesAsync_Test)
{
    //arrange
    ...
    //act
    IOTHUB_CLIENT_RESULT result = IoTHubModuleClient_GetPropertiesAndSubscribeToUpdatesAsync(TEST_IOTHUB_MODULE_CLIENT_HANDLE, TEST_PROPERTIES_RECEIVED_CALLBACK, NULL);
