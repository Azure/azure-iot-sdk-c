...
static IOTHUB_CLIENT_PROPERTY_ACKNOWLEDGED_CALLBACK TEST_PROPERTY_ACKNOWLEDGED_CALLBACK = (IOTHUB_CLIENT_PROPERTY_ACKNOWLEDGED_CALLBACK)0x000C;
static IOTHUB_CLIENT_COMMAND_CALLBACK_ASYNC TEST_COMMAND_CALLBACK = (IOTHUB_CLIENT_COMMAND_CALLBACK_ASYNC)0x000D;
static IOTHUB_CLIENT_PROPERTIES_RECEIVED_CALLBACK TEST_PROPERTIES_RECEIVED_CALLBACK = (IOTHUB_CLIENT_PROPERTIES_RECEIVED_CALLBACK)0x000E;
...
TEST_SUITE_INITIALIZE(suite_init)
{
    ...
    REGISTER_GLOBAL_MOCK_RETURN(IoTHubClientCore_SubscribeToCommands, IOTHUB_CLIENT_OK);
...
TEST_FUNCTION(IoTHubDeviceClient_SetStreamRequestCallback_Test)
{
    //arrange
    ...
    //act
    IOTHUB_CLIENT_RESULT result = IoTHubDeviceClient_SetStreamRequestCallback(TEST_IOTHUB_DEVICE_CLIENT_HANDLE, callback, context);
...
TEST_FUNCTION(IoTHubDeviceClient_SetStreamRequestCallback_Negative_Test)
{
    //arrange
    DEVICE_STREAM_C2D_REQUEST_CALLBACK callback = (DEVICE_STREAM_C2D_REQUEST_CALLBACK)0x4445;
    void* context = (void*)0x4446;
    ...
    //assert
    ASSERT_ARE_EQUAL(char_ptr, umock_c_get_expected_calls(), umock_c_get_actual_calls());
    ASSERT_IS_TRUE(result == IOTHUB_CLIENT_ERROR);
}

TEST_FUNCTION(IoTHubDeviceClient_SendTelemetryAsync_Test)
{
    //arrange
    STRICT_EXPECTED_CALL(IoTHubClientCore_SendEventAsync(TEST_IOTHUB_CLIENT_CORE_HANDLE, TEST_MESSAGE_HANDLE, TEST_EVENT_CONFIRMATION_CALLBACK, NULL));

    //act
    IOTHUB_CLIENT_RESULT result = IoTHubDeviceClient_SendTelemetryAsync(TEST_IOTHUB_DEVICE_CLIENT_HANDLE, TEST_MESSAGE_HANDLE, TEST_EVENT_CONFIRMATION_CALLBACK, NULL);
...
TEST_FUNCTION(IoTHubDeviceClient_SendPropertiesAsync_Test)
{
    //arrange
    STRICT_EXPECTED_CALL(IoTHubClientCore_SendReportedState(TEST_IOTHUB_CLIENT_CORE_HANDLE, TEST_UNSIGNED_CHAR, TEST_SIZE_T, TEST_PROPERTY_ACKNOWLEDGED_CALLBACK, NULL));

    //act
    IOTHUB_CLIENT_RESULT result = IoTHubDeviceClient_SendPropertiesAsync(TEST_IOTHUB_DEVICE_CLIENT_HANDLE, TEST_UNSIGNED_CHAR, TEST_SIZE_T, TEST_PROPERTY_ACKNOWLEDGED_CALLBACK, NULL);
...
TEST_FUNCTION(IoTHubDeviceClient_SubscribeToCommands_Test)
{
    //arrange
    STRICT_EXPECTED_CALL(IoTHubClientCore_SubscribeToCommands(TEST_IOTHUB_CLIENT_CORE_HANDLE, TEST_COMMAND_CALLBACK, NULL));

    //act
    IOTHUB_CLIENT_RESULT result = IoTHubDeviceClient_SubscribeToCommands(TEST_IOTHUB_DEVICE_CLIENT_HANDLE, TEST_COMMAND_CALLBACK, NULL);
...
TEST_FUNCTION(IoTHubDeviceClient_GetPropertiesAsync_Test)
{
    //arrange
    STRICT_EXPECTED_CALL(IoTHubClientCore_GetTwinAsync(TEST_IOTHUB_CLIENT_CORE_HANDLE, (IOTHUB_CLIENT_DEVICE_TWIN_CALLBACK)TEST_PROPERTIES_RECEIVED_CALLBACK, NULL));

    //act
    IOTHUB_CLIENT_RESULT result = IoTHubDeviceClient_GetPropertiesAsync(TEST_IOTHUB_DEVICE_CLIENT_HANDLE, TEST_PROPERTIES_RECEIVED_CALLBACK, NULL);
...
TEST_FUNCTION(IoTHubDeviceClient_GetPropertiesAndSubscribeToUpdatesAsync_Test)
{
    //arrange
    STRICT_EXPECTED_CALL(IoTHubClientCore_SetDeviceTwinCallback(TEST_IOTHUB_CLIENT_CORE_HANDLE, (IOTHUB_CLIENT_DEVICE_TWIN_CALLBACK)TEST_PROPERTIES_RECEIVED_CALLBACK, NULL));

    //act
    IOTHUB_CLIENT_RESULT result = IoTHubDeviceClient_GetPropertiesAndSubscribeToUpdatesAsync(TEST_IOTHUB_DEVICE_CLIENT_HANDLE, TEST_PROPERTIES_RECEIVED_CALLBACK, NULL);
