...
TEST_FUNCTION(IoTHubDeviceClient_GetDeviceTwinAsync_Test)
{
    //arrange
    STRICT_EXPECTED_CALL(IoTHubClientCore_GetDeviceTwinAsync(TEST_IOTHUB_CLIENT_CORE_HANDLE, TEST_TWIN_CALLBACK, NULL));

    //act
    IOTHUB_CLIENT_RESULT result = IoTHubDeviceClient_GetDeviceTwinAsync(TEST_IOTHUB_DEVICE_CLIENT_HANDLE, TEST_TWIN_CALLBACK, NULL);
