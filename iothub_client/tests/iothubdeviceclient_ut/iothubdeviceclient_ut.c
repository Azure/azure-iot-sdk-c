...
{
    //arrange
    STRICT_EXPECTED_CALL(IoTHubClientCore_GetTwinAsync(TEST_IOTHUB_CLIENT_CORE_HANDLE, TEST_PROPERTIES_RECEIVED_CALLBACK, NULL));
...
{
    //arrange
    STRICT_EXPECTED_CALL(IoTHubClientCore_SetDeviceTwinCallback(TEST_IOTHUB_CLIENT_CORE_HANDLE, TEST_PROPERTIES_RECEIVED_CALLBACK, NULL));
