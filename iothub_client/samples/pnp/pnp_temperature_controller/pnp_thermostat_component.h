...
//
int PnP_ThermostatComponent_ProcessCommand(PNP_THERMOSTAT_COMPONENT_HANDLE pnpThermostatComponentHandle, const char *componentName, JSON_Object* commandJsonRootObject, unsigned char** response, size_t* responseSize);

//
// PnP_ThermostatComponent_ProcessPropertyUpdate processes an incoming property update and sends reported update.
//
...
//
// PnP_ThermostatComponent_SendTelemetry sends telemetry from the thermostat.
//
