...
static const char* connectionString = "HostName=jebrando-iothub.azure-devices.net;DeviceId=desktop_device;SharedAccessKey=w+jaghWMRDKMtHCmidGf8BV/gDzEX9SuTYcl4nfiupo=";
