...
* Get OpenSSL for Windows.  
  * See [the official documentation] or https://www.openssl.org/docs/faq.html#MISC4 for places to download it or or https://www.openssl.org/source/ to build from source.
